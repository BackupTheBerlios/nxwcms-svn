...
-- 
-- Host: localhost
-- Erstellungszeit: 07. Januar 2007 um 12:44
...
INSERT INTO `internal_resources` VALUES ('SEARCH_EXPIRED_ARTICLES', 'DE', 'ZurÃ¼ckgezogene Artikel', '');
...
INSERT INTO `internal_resources` VALUES ('PREV_AVAIL', 'DE', 'Sie haben einen Inhalt ausgewÃ¤hlt. Die Vorschau wird nach dem Speichern verfÃ¼gbar sein.', '');
INSERT INTO `internal_resources` VALUES ('OBJLAUNCH_SUCCESS', 'DE', 'Das Objekt wurde erfolgreich verÃ¶ffentlicht', '');
INSERT INTO `internal_resources` VALUES ('NOT_SPECIFIED', 'DE', 'Alle Typen', '');
INSERT INTO `internal_resources` VALUES ('NO_OBJ', 'DE', 'Kein Inhalt ausgewÃ¤hlt.', '');
INSERT INTO `internal_resources` VALUES ('NOT_SELECTED', 'DE', 'Kein Element ausgewÃ¤hlt.', '');
...
INSERT INTO `internal_resources` VALUES ('HIDE', 'DE', 'SchlieÃŸen', '');
INSERT INTO `internal_resources` VALUES ('HELP_VARIATION', 'DE', 'Inhalte kÃ¶nnen in verschiedenen Variationen vorliegen. Variationen kÃ¶nnen z.B. verschiedene Sprachen oder unterschiedliche Inhaltsprofile darstellen.', '');
INSERT INTO `internal_resources` VALUES ('HELP_SYNCCL', 'DE', 'Eine Einrichtung zur Synchronisation von Clustern, nachdem eine Cluster-Vorlage verÃ¤ndert wurde.', '');
INSERT INTO `internal_resources` VALUES ('HELP_PURGE', 'DE', 'LÃ¶scht Ã¼berflÃ¼ssige Daten aus der Datenbank', '');
INSERT INTO `internal_resources` VALUES ('HELP_DW', 'DE', 'Erzeugt eine Konfigurations-Datei fÃ¼r das N/X Dreamweaver-PlugIn. Mit Hilfe dieses Plug-Ins kÃ¶nnen N/X-Vorlagen benutzerfreundlich mit Dreamweaver entwickelt werden.', '');
INSERT INTO `internal_resources` VALUES ('HELP_BACKUP', 'DE', 'Die untenstehende Liste zeigt eine Liste von Sicherungen an. Sie kÃ¶nnen hier einzelne Sicherungen lÃ¶schen. Um eine Sicherung zurÃ¼ckzuspielen, mÃ¼ssen Sie sich manuell auf Ihrem Server anmelden und die Dateien selbst wiederherstellen', '');
INSERT INTO `internal_resources` VALUES ('CONFIRM_UNSAVED_CHANGES', 'DE', 'Achtung: Ungesicherte Ã„nderungen gehen verloren, wenn Sie fortfahren. MÃ¶chten Sie dies tun?', '');
...
INSERT INTO `internal_resources` VALUES ('EXPL_SEL_SPM', 'DE', 'Bitte wÃ¤hlen Sie eine Seiten-Vorlage aus.', '');
INSERT INTO `internal_resources` VALUES ('ENDTIME', 'DE', 'Endzeit', '');
INSERT INTO `internal_resources` VALUES ('EXPL_SEL_CH', 'DE', 'Bitte wÃ¤hlen Sie einen Kanal.', '');
INSERT INTO `internal_resources` VALUES ('ENDATE', 'DE', 'Enddatum', '');
INSERT INTO `internal_resources` VALUES ('DELETE_PAGE', 'DE', 'LÃ¶schen', '');
...
INSERT INTO `internal_resources` VALUES ('DWEXT_CONTENTFIELDINFO_MES', 'DE', 'erzeugt Inhalts-Feld-Informationen fÃ¼r Dreamweaver MX', '');
...
INSERT INTO `internal_resources` VALUES ('CLEAR', 'DE', 'LÃ¶schen', '');
INSERT INTO `internal_resources` VALUES ('CHANNEL_IMPORTARTICLES', 'DE', 'Artikel importieren', '');
INSERT INTO `internal_resources` VALUES ('CAL_BTO', 'DE', 'ZurÃ¼ck zur Ãœbersicht', '');
...
INSERT INTO `internal_resources` VALUES ('ARTICLE_IS_LIVE', 'DE', 'Artikel ist verÃ¶ffentlicht', '');
INSERT INTO `internal_resources` VALUES ('ARTICLE_IS_EXPIRED', 'DE', 'Artikel ist nicht verÃ¶ffentlicht', '');
INSERT INTO `internal_resources` VALUES ('ADD_LINK', 'DE', 'Link hinzufÃ¼gen', '');
INSERT INTO `internal_resources` VALUES ('ADDITIONAL_LINK', 'DE', 'ZusÃ¤tzlicher Link', '');
INSERT INTO `internal_resources` VALUES ('ADDITIONAL_IMAGE', 'DE', 'ZusÃ¤tzliches Bild', '');
...
INSERT INTO `internal_resources` VALUES ('SEL_CHANNEL_CAT', 'DE', 'Kanal und Kategorie auswÃ¤hlen', '');
...
INSERT INTO `internal_resources` VALUES ('CL_EXPIRE', 'DE', 'Objekt zurÃ¼ckziehen', '');
INSERT INTO `internal_resources` VALUES ('BACK_TO_CV', 'DE', 'ZurÃ¼ck zur ObjektÃ¼bersicht', '');
INSERT INTO `internal_resources` VALUES ('CL_LAUNCH', 'DE', 'Objekt verÃ¶ffentlichen', '');
INSERT INTO `internal_resources` VALUES ('CHANNEL_GRABMP', 'DE', 'grab from Multipage', '');
INSERT INTO `internal_resources` VALUES ('AR_EXPIRE', 'DE', 'Artikel zurÃ¼ckziehen', '');
INSERT INTO `internal_resources` VALUES ('HELP_PGN', 'DE', 'Plug-Ins erlauben Ihnen, N/X Ã¼her seine Standard-FunktionalitÃ¤ten hinaus zu erweitern. Ãœblicherweise werden Plug-Ins dazu verwendet, neue Objekttypen zu den Standard-Typen Text und Bild hinzuzufÃ¼gen.', '');
INSERT INTO `internal_resources` VALUES ('O_TEXT_NOBREAK', 'DE', 'Ignore New-Lines', '');
INSERT INTO `internal_resources` VALUES ('DEL_ARTICLE', 'DE', 'MÃ¶chten Sie diesen Artikel wirklich in allen Sprachen lÃ¶schen?', '');
INSERT INTO `internal_resources` VALUES ('AR_LAUNCH', 'DE', 'Artikel verÃ¶ffentlichen', '');
...
INSERT INTO `internal_resources` VALUES ('NODE_ACCESS', 'DE', 'Zugriffsrechte fÃ¼r Root-Seite setzen', '');
INSERT INTO `internal_resources` VALUES ('BACK_TO_OVERVIEW', 'DE', 'ZurÃ¼ck zur Ãœbersicht', '');
INSERT INTO `internal_resources` VALUES ('NEW_ARTICLE', 'DE', 'Neuer Artikel', '');
INSERT INTO `internal_resources` VALUES ('DESTROY_EXCLUSIVE_CONTENT', 'DE', 'Exklusive Inhalte lÃ¶schen', '');
INSERT INTO `internal_resources` VALUES ('EDIT_ARTICLE', 'DE', 'Artikel bearbeiten', '');
INSERT INTO `internal_resources` VALUES ('DESTROY_TREE', 'DE', 'Baum lÃ¶schen', '');
INSERT INTO `internal_resources` VALUES ('CONFIRM_DELETE', 'DE', 'MÃ¶chten Sie dieses Element wirklich lÃ¶schen?', '');
INSERT INTO `internal_resources` VALUES ('HELP_ROLLOUT', 'DE', 'Rollout ist eine Einrichtung in N/X, mit der Sie Kopien eines Teils Ihrer Website erstellen und diese an anderer Stelle mit oder ohne alte Inhalte weiderverwenden kÃ¶nnen.', '');
INSERT INTO `internal_resources` VALUES ('CHANNEL', 'DE', 'Kanal', '');
INSERT INTO `internal_resources` VALUES ('CLT_SELECT', 'DE', 'Klasse auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('HELP_CHANNEL', 'DE', 'Themen-Kategorien fÃ¼r die Inhalte der von N/X erzeugten Artikel, z.B. Neuigkeiten, Personen', '');
INSERT INTO `internal_resources` VALUES ('CHANNELS', 'DE', 'KanÃ¤le', '');
INSERT INTO `internal_resources` VALUES ('SEL_FILE', 'DE', 'Datei auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('WZT_IMPORTING', 'DE', 'Daten werden importiert', '');
INSERT INTO `internal_resources` VALUES ('WZE_IMPORTING', 'DE', 'Das System hat versucht, die Daten zu importieren. Bitten Ã¼berprÃ¼fen Sie den Status auf der rechten Seite.', '');
INSERT INTO `internal_resources` VALUES ('WZE_IMPORT_VAL', 'DE', 'Das System hat die Korrektheit der hochgeladenen XML-Datei Ã¼berprÃ¼ft. Im Bericht rechts finden Sie nÃ¤here Informationen.', '');
INSERT INTO `internal_resources` VALUES ('WZT_IMPORT_VAL', 'DE', 'Zusammenfassung des hochgeladenen XML', '');
INSERT INTO `internal_resources` VALUES ('WZE_IMPORT_FILE', 'DE', 'Bitte wÃ¤hlen Sie eine XML-Datei auf Ihrer Festplatte aus, die ins System geladen werden soll<br/><br/>Das System wird eine ÃœberprÃ¼fung durchfÃ¼hren und den Status auf der rechten Seite ausgeben.', '');
INSERT INTO `internal_resources` VALUES ('WZT_IMPORT_FILE', 'DE', 'N/X-XML-Datei auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('IMPORT_DATA', 'DE', 'N/X-XML-Daten importieren', '');
INSERT INTO `internal_resources` VALUES ('WZ_IMPORT_TITLE', 'DE', 'Dieser Assisten dient zum Import von Daten in N/X, die zuvor von einer anderen N/X-Installation exportiert wurden. Um eine Ressource erneut importieren zu kÃ¶nnen, mÃ¼ssen Sie sie zunÃ¤chst lÃ¶schen.', '');
INSERT INTO `internal_resources` VALUES ('EXPL_SEL_CLUSTER', 'DE', 'Nachdem Sie eine Klasse gewÃ¤hlt haben, erscheint eine Liste von Objekten, aus der Sie eins auswÃ¤hlen kÃ¶nnen.', '');
...
INSERT INTO `internal_resources` VALUES ('EXPL_EXEC_EXPORT', 'DE', 'Das System erzeugt gerade eine XML-Datei fÃ¼r den Export..<br/><br/>In ein paar Sekunden wird ein PopUp erscheinen. Klicken Sie "Speichern", um die Daten auf Ihre Festplatte zu sichern.', '');
...
INSERT INTO `internal_resources` VALUES ('WZT_SEL_EXP_RES', 'DE', 'Ressource fÃ¼r den Export auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('WZT_DESCR', 'DE', 'Beschreibung hinzufÃ¼gen', '');
INSERT INTO `internal_resources` VALUES ('WZT_DESCR_EXPL', 'DE', 'Sie sollten eine kurze Beschreibung zu den exportierten Daten hinzufÃ¼gen.<br><br>Jeder, der die Daten importiert, wird leichter verstehen, was er importiert.', '');
INSERT INTO `internal_resources` VALUES ('CLUSTER', 'DE', 'Objekt', '');
INSERT INTO `internal_resources` VALUES ('CLUSTER_TEMPLATE', 'DE', 'Klasse', '');
INSERT INTO `internal_resources` VALUES ('WZE_EXPORT_TYPE', 'DE', 'Bitte wÃ¤hlen Sie rechts den Typ von Daten aus, den Sie exportieren mÃ¶chten. Cluster speichern Inhalte. Wenn Sie Cluser exportieren, werden automatisch auch die zugehÃ¶rigen Vorlagen exportiert. Cluster-Vorlagen sind Schemata, um Cluster zu erstellen. seiten-Vorlagen werden benutzt, um Seiten zu erstellen.', '');
INSERT INTO `internal_resources` VALUES ('WZT_EXPORT_TYPE', 'DE', 'WÃ¤hlen Sie den Typ fÃ¼r den Export aus.', '');
INSERT INTO `internal_resources` VALUES ('WZ_EXPORT_TITLE', 'DE', 'Der Assistent dient zum Austausch von Objekten, Klassen und Seiten-Vorlagen zwischen Ihrer und anderen N/X-Installationen. Der Assistent erzeugt eine XML-Datei, die Sie auf Ihre lokale Festplatte speichern und mit anderen N/X-Nutzern austauschen kÃ¶nnen.', '');
INSERT INTO `internal_resources` VALUES ('EXPORT_DATA', 'DE', 'Inhalte- und Vorlagen-Export-Assistent', '');
INSERT INTO `internal_resources` VALUES ('LAST_LAUNCHED_AT', 'DE', 'Zuletzt verÃ¶ffentlicht am', '');
INSERT INTO `internal_resources` VALUES ('BY', 'DE', 'von', '');
INSERT INTO `internal_resources` VALUES ('LAST_MOD_AT', 'DE', 'Zuletzt geÃ¤ndert am', '');
INSERT INTO `internal_resources` VALUES ('CREATED_AT', 'DE', 'Erstellt am', '');
INSERT INTO `internal_resources` VALUES ('CLUSTER_INFORMATION', 'DE', 'Informationen Ã¼ber diesen Datensatz', '');
INSERT INTO `internal_resources` VALUES ('TT_RSTCI', 'DE', 'Jede Seite in N/X besitzt ein Objekt. Duch Klicken auf "Objekt zurÃ¼cksetzen" kÃ¶nnen Sie der Seite eine neues Objekt zuweisen.', '');
...
INSERT INTO `internal_resources` VALUES ('HELP_CLB', 'DE', 'Ein Cluster ist eine Ansammlung von statischen und dynamischen Inhalts-Platzhaltern, die entweder von einem Entwickler oder einem Editor einer Website gefÃ¼llt werden. Die Grundstruktur in N/X besteht aus Daten-Clustern', '');
INSERT INTO `internal_resources` VALUES ('PROMPTDELETE', 'DE', 'MÃ¶chten Sie diesen Datensatz wirklich lÃ¶schen?', '');
INSERT INTO `internal_resources` VALUES ('CREATENEW', 'DE', 'Es wurde ein neuer Datensatz erzeugt.', '');
INSERT INTO `internal_resources` VALUES ('SELECTONE', 'DE', 'Sie mÃ¼ssen hier eine Auswahl treffen!', '');
INSERT INTO `internal_resources` VALUES ('SAVESUCCESS', 'DE', 'Die Daten wurden erfolgreich in die Datenbank geschrieben.', '');
INSERT INTO `internal_resources` VALUES ('DELETESUCCESS', 'DE', 'Die unten aufgefÃ¼hrten Daten wurden erfolgreich gelÃ¶scht.', '');
INSERT INTO `internal_resources` VALUES ('SAVEERROR', 'DE', 'WÃ¤hrend des Speicherns der Daten in die Datenbank ist ein Fehler aufgetreten. Bitte stellen Sie sicher, dass die Datenbank verbunden ist, oder benachrichtigen Sie Ihren Administrator.', '');
INSERT INTO `internal_resources` VALUES ('PROCERROR', 'DE', 'WÃ¤hrend der Verarbeitung des Formulars ist ein Fehler aufgetreten. Bitte Ã¼berprÃ¼fen Sie die markierten Felder und lesen Sie die dortigen Anweisungen fÃ¼r weitergehende Informationen.', '');
INSERT INTO `internal_resources` VALUES ('PWDTOOSHORT', 'DE', 'Das Passwort muss mindestens 6 Zeichen lang sein!', '');
INSERT INTO `internal_resources` VALUES ('PWDNOTMATCH', 'DE', 'Die von Ihnen eingegebene PasswÃ¶rter stimmen nicht Ã¼berein!', '');
...
INSERT INTO `internal_resources` VALUES ('NOTNUMBER', 'DE', 'Sie kÃ¶nnen in dieses Feld nur Zahlenwerte eingeben!', '');
...
INSERT INTO `internal_resources` VALUES ('SELECT_CL', 'DE', 'WÃ¤hlen Sie ein Objekt aus', '');
INSERT INTO `internal_resources` VALUES ('SELECT_CI', 'DE', 'WÃ¤hlen Sie ein Inhalts-Element aus', '');
...
INSERT INTO `internal_resources` VALUES ('CHOOSEFILE', 'DE', 'WÃ¤hlen Sie eine Datei aus', '');
...
INSERT INTO `internal_resources` VALUES ('ED_DISPATCHER', 'DE', 'Benutzen Sie diese SchaltflÃ¤che, um zwischen der Bearbeitung der META-Daten und der Bearbeitung der Inhalte umherzuschlaten.', '');
INSERT INTO `internal_resources` VALUES ('ACTIVE_VARIATION', 'DE', 'AusgewÃ¤hlte Sprache:', '');
INSERT INTO `internal_resources` VALUES ('NO_VARIATIONS', 'DE', 'Es wurden noch keine Sprachversionen fÃ¼r dieses Objekt erzeugt.<br>Bitten Sie einen Entwickler, die Konfiguration des gewÃ¤hlten Elements zu Ã¼berprÃ¼fen!', '');
INSERT INTO `internal_resources` VALUES ('SELECT_VARIATION', 'DE', 'Sprache auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('METATEMPLATE', 'DE', 'ZusÃ¤tzliche META-Vorlage', '');
INSERT INTO `internal_resources` VALUES ('POSITION', 'DE', 'Position', '');
INSERT INTO `internal_resources` VALUES ('DELETE', 'DE', 'LÃ¶schen', '');
INSERT INTO `internal_resources` VALUES ('TYPE', 'DE', 'Typ', '');
INSERT INTO `internal_resources` VALUES ('KEYWORDS', 'DE', 'SchlÃ¼sselwÃ¶rter', '');
INSERT INTO `internal_resources` VALUES ('SELECTOBJECT', 'DE', 'Bitte wÃ¤hlen Sie eine Klasse aus und geben Sie eine Position und einen Namen an, um das Objekt zu erzeugen.<br>Geben Sie als Position 0 an, um das neue Objekt am Anfang einzufÃ¼gen, 999, um es am Ende anzufÃ¼gen und jede beliebige andere Numm', '');
...
INSERT INTO `internal_resources` VALUES ('DOSOMETHING', 'DE', 'Bitte wÃ¤hlen Sie aus, was Sie tun mÃ¶chten. Sie kÃ¶nnen neue Elemente einfÃ¼gen, bestehende Elemente bearbeiten oder lÃ¶schen und die Reihenfolge bestehender Elemente verÃ¤ndern.', '');
...
INSERT INTO `internal_resources` VALUES ('COMMIT', 'DE', 'Ãœbernehmen', '');
INSERT INTO `internal_resources` VALUES ('USER_PROFILE', 'DE', 'Mein Profil', '');
INSERT INTO `internal_resources` VALUES ('ERROR_SEL_ROLE', 'DE', 'Sie mÃ¼ssen mindestens eine Rolle auswÃ¤hlen!', '');
INSERT INTO `internal_resources` VALUES ('ERROR_SEL_GROUP', 'DE', 'Sie mÃ¼ssen eine Gruppe auswÃ¤hlen!', '');
INSERT INTO `internal_resources` VALUES ('USER_TO_GROUP', 'DE', 'Bneutzer zur Gruppe hinzufÃ¼gen', '');
...
INSERT INTO `internal_resources` VALUES ('UP_INTRO', 'DE', 'Bitte wÃ¤hlen Sie die Gruppe und die Rollen in der Gruppe, die Sie diesem User zuweisen mÃ¶chten.', '');
...
INSERT INTO `internal_resources` VALUES ('VARIATIONS', 'DE', 'VerfÃ¼gbare Variationen', '');
INSERT INTO `internal_resources` VALUES ('V_NAME', 'DE', 'Name', '');
INSERT INTO `internal_resources` VALUES ('V_SHORT', 'DE', 'KÃ¼rzel', '');
INSERT INTO `internal_resources` VALUES ('MT_ADDITIONAL', 'DE', 'ZusÃ¤tzliche META-Daten', '');
INSERT INTO `internal_resources` VALUES ('MT_DELETE', 'DE', 'MÃ¶chten Sie diesen Teil der Meta-Vorlage wirklich lÃ¶schen? Alle Informationen, die im CMS in irgend ein mit diesem Teil verknÃ¼pften META-Eingabefeld eingegeben wurden, werden gelÃ¶scht. Die Daten kÃ¶nnen anschliessend nicht wiederhe', '');
...
INSERT INTO `internal_resources` VALUES ('R_PARENT', 'DE', 'Ãœbergeordneter Ordner', '');
INSERT INTO `internal_resources` VALUES ('R_DELFOLDER', 'DE', 'Ordner und alle untergeordneten Objekte lÃ¶schen', '');
INSERT INTO `internal_resources` VALUES ('R_MOVEOBJECTS', 'DE', 'Alle Objekte zur nÃ¤chst hÃ¶heren Ebene verschieben', '');
INSERT INTO `internal_resources` VALUES ('R_FOLDERNOTEMPTY', 'DE', 'Der Ordner ist nicht leer, Sie kÃ¶nnen ihn also nicht lÃ¶schen! Bitte Ã¼berprÃ¼fen Sie alle Objekte und Inhalte!', '');
INSERT INTO `internal_resources` VALUES ('R_DELFOLDERMES', 'DE', 'Sie sind im Begriff einen Ordner zu lÃ¶schen. Bitte wÃ¤hlen Sie eine Aktion aus.', '');
INSERT INTO `internal_resources` VALUES ('R_DELETEFOLDER', 'DE', 'Ordner lÃ¶schen', '');
...
INSERT INTO `internal_resources` VALUES ('O_DEL', 'DE', 'Objekt lÃ¶schen', '');
INSERT INTO `internal_resources` VALUES ('O_DELMES', 'DE', 'Sie sind im Begriff ein Objekt zu lÃ¶schen.<b>Beachten Sie dass hierbei alle  Sprachversionen und META-DATEN gelÃ¶scht werden!</b>', '');
...
INSERT INTO `internal_resources` VALUES ('PG_UNINSTALLDELE', 'DE', 'Plugin entfernen,<br> Alle zugehÃ¶rigen Inhalte lÃ¶schen.', '');
INSERT INTO `internal_resources` VALUES ('PG_UNINSTALLMES', 'DE', 'Sie sind im Begriff, ein Plugin zu entfernen. Das Entfernen eines Moduls lÃ¶scht nicht nur den Inhalts-Typ sondern lÃ¶scht auch jeden einzelnen Inhalt, der in der Datenbank gespeichert ist.', '');
...
INSERT INTO `internal_resources` VALUES ('PG_ERROR', 'DE', 'WÃ¤hrend der Installation des PlugIns ist ein Fehler aufgetreten!', '');
...
INSERT INTO `internal_resources` VALUES ('CLASS_WRONG', 'DE', 'Die von Ihnen angegebene Datei hat keine gÃ¼ltige Klassen-Signatur!', '');
...
INSERT INTO `internal_resources` VALUES ('PG_CHOOSE', 'DE', 'PlugIn: Â  /plugin/', '');
...
INSERT INTO `internal_resources` VALUES ('LINKED', 'DE', 'VerknÃ¼pft mit', '');
INSERT INTO `internal_resources` VALUES ('PG_INSTALLDESC', 'DE', 'Bitte stellen Sie sicher, dass Sie alle benÃ¶tigten Dateien ins Verzeichnis kopiert haben, bevor Sie fortfahren. Geben Sie in das untenstehende Eingabefeld den korrekten Pfad zum PlugIn ein. Das System wird das PlugIn dann automatisch installieren.', '');
INSERT INTO `internal_resources` VALUES ('CLT_SCHEME', 'DE', 'Klasse bearbeiten', '');
INSERT INTO `internal_resources` VALUES ('CLTI_DELETE', 'DE', 'MÃ¶chten Sie dieses Element wirklich lÃ¶schen? SÃ¤mtliche Instanzen dieses Elements werden ebenfalls gelÃ¶scht!', '');
INSERT INTO `internal_resources` VALUES ('CLT_DELMES', 'DE', 'Sie sind im Begriff eine Klasse zu lÃ¶schen. Dies wird den Verlust aller(!) Ihnhalte zur Folge haben, die mit dieser Klasse als Vorlage erstellt wurden. Sind Sie sicher, dass Sie forfahren mÃ¶chten?', '');
INSERT INTO `internal_resources` VALUES ('CLT_DELETE', 'DE', 'Klasse lÃ¶schen', '');
...
INSERT INTO `internal_resources` VALUES ('SELECTEDOBJECT', 'DE', 'Derzeit ausgewÃ¤hltes Inhalts-Element', '');
INSERT INTO `internal_resources` VALUES ('SELECTEDINSTANCE', 'DE', 'AusgewÃ¤hltes Objekt', '');
...
INSERT INTO `internal_resources` VALUES ('SR_SELECTCLI', 'DE', 'Bitte wÃ¤hlen Sie eine Klasse. AnschlieÃŸend kÃ¶nnen Sie ein Objekt auswÃ¤hlen.', '');
INSERT INTO `internal_resources` VALUES ('SR_SELECTCI', 'DE', 'Sie kÃ¶nnen hier nach einem beliebigen Inhalts-Element suchen. Wenn Sie ein Inhalts-Element selektieren mÃ¶chten, wÃ¤hlen Sie es aus und klicken Sie die Aktualisieren-SchaltflÃ¤che! Wenn sie neuen Inhalt mit diesem Feld verbinden mÃ¶chten, erstellen Sie es bitte zunÃ¤chst in der Bibliothek.', '');
INSERT INTO `internal_resources` VALUES ('CLI', 'DE', 'Objekt:', '');
INSERT INTO `internal_resources` VALUES ('CLI_NOTDELETED', 'DE', 'Dieses Objekt kann nicht gelÃ¶scht werden!', '');
INSERT INTO `internal_resources` VALUES ('CLI_DELETED', 'DE', 'Das Objekt wurde gelÃ¶scht.', '');
INSERT INTO `internal_resources` VALUES ('CLI_DELETEMES', 'DE', 'MÃ¶chten Sie dieses Objekt wirklich lÃ¶schen?', '');
INSERT INTO `internal_resources` VALUES ('CLI_DELETE', 'DE', 'Objekt lÃ¶schen', '');
...
INSERT INTO `internal_resources` VALUES ('PO_BROWSER', 'MND', 'ÃˆÃ«Â¿ÃšÃ¤Â¯Ã€Ã€Ã†Ã·', NULL);
INSERT INTO `internal_resources` VALUES ('PO_OWNER', 'MND', 'Ã’Â³ÃƒÃ¦Master', NULL);
INSERT INTO `internal_resources` VALUES ('PO_CRSUCCEEDED', 'MND', 'Â³Ã‰Â¹Â¦Â´Â´Â½Â¨ÃÃ‚ÃˆÃ«Â¿ÃšÃ’Â³ÃƒÃ¦!', NULL);
INSERT INTO `internal_resources` VALUES ('PO_MYPORTAL', 'MND', 'ÃŽÃ’ÂµÃ„ÃˆÃ«Â¿ÃšÃ’Â³ÃƒÃ¦', NULL);
INSERT INTO `internal_resources` VALUES ('PO_EDIT', 'MND', 'Â±Ã Â¼Â­ÃˆÃ«Â¿ÃšÃ’Â³ÃƒÃ¦', NULL);
INSERT INTO `internal_resources` VALUES ('SP_BROWSE', 'MND', 'Ã¤Â¯Ã€Ã€Ã•Â¾ÂµÃ£ÂµÃ˜ÃÂ¼', NULL);
INSERT INTO `internal_resources` VALUES ('SP_NEWPAGE', 'MND', 'Ã”Ã¶Â¼Ã“Ã•Â¾ÂµÃ£Ã’Â³ÃƒÃ¦', NULL);
INSERT INTO `internal_resources` VALUES ('SP_NEWINSTANCE', 'MND', 'Ã”Ã¶Â¼Ã“Ã’Â³ÃƒÃ¦', NULL);
INSERT INTO `internal_resources` VALUES ('SP_IPROPERTIES', 'MND', 'Ã’Â³ÃƒÃ¦ÃŠÃ´ÃÃ”', NULL);
INSERT INTO `internal_resources` VALUES ('SP_PROPERTIES', 'MND', 'Ã•Â¾ÂµÃ£Ã’Â³ÃƒÃ¦ÃŠÃ´ÃÃ”', NULL);
INSERT INTO `internal_resources` VALUES ('SP_DELMES', 'MND', 'Ã„ÃºÃ•Ã½Ã—Â¼Â±Â¸Ã‰Â¾Â³Ã½Ã•Â¾ÂµÃ£Ã’Â³ÃƒÃ¦Â¡Â£Ã‡Ã«Ã—Â¢Ã’Ã¢Â£Â¬Ã•Â¾ÂµÃ£Ã’Â³ÃƒÃ¦ÂµÃ„ÃŠÂµÃ€Ã½Ã’Â²Â»Ã¡Â±Â»Ã‰Â¾Â³Ã½!', NULL);
INSERT INTO `internal_resources` VALUES ('SP_DELETE', 'MND', 'Ã‰Â¾Â³Ã½Ã•Â¾ÂµÃ£Ã’Â³ÃƒÃ¦', NULL);
INSERT INTO `internal_resources` VALUES ('SP_PDELMES', 'MND', 'Ã„ÃºÃ•Ã½Ã—Â¼Â±Â¸Ã‰Â¾Â³Ã½Ã’Â³ÃƒÃ¦Â¡Â£Ã‡Ã«Ã—Â¢Ã’Ã¢Â£Â¬Ã’Â³ÃƒÃ¦ÂµÃ„ÃŠÂµÃ€Ã½Ã’Â²Â»Ã¡Â±Â»Ã‰Â¾Â³Ã½!', NULL);
INSERT INTO `internal_resources` VALUES ('SP_PDELETE', 'MND', 'Ã‰Â¾Â³Ã½Ã’Â³ÃƒÃ¦', NULL);
INSERT INTO `internal_resources` VALUES ('SP_CONFIGURE', 'MND', 'Ã…Ã¤Ã–ÃƒÃ’Â³ÃƒÃ¦', NULL);
INSERT INTO `internal_resources` VALUES ('SP_CONFDESC', 'MND', 'Ã„ÃºÂ¿Ã‰Ã’Ã”Â½Â«Â±Â¾Ã•Â¾ÂµÃ£Ã’Â³ÃƒÃ¦Â¹Ã˜ÃÂªÃ–ÃÃ’Â»Â¸Ã¶Ã’Ã‘Â´Ã¦Ã”ÃšÂµÃ„Â´Ã˜ÂµÃ„Ã€Ã½Â³ÃŒÂ£Â¬Â»Ã²Ã•ÃŸÃ„ÃºÃ’Â²Â¿Ã‰Ã’Ã”Â´Â´Â½Â¨Ã’Â»Â¸Ã¶ÃÃ‚ÂµÃ„Ã€Ã½Â³ÃŒÂ£Â¬Ã‡Ã«Â¾Ã¶Â¶Â¨Ã„ÃºÃÃ«Ã—Ã¶ÃŠÂ²ÃƒÂ´Â¡Â£', NULL);
INSERT INTO `internal_resources` VALUES ('SP_LINK', 'MND', 'Â¹Ã˜ÃÂªÃ–ÃÃ’Ã‘Â´Ã¦Ã”ÃšÂµÃ„Â´Ã˜ÂµÃ„Ã€Ã½Â³ÃŒ', NULL);
INSERT INTO `internal_resources` VALUES ('SP_CLNEW', 'MND', 'Â´Â´Â½Â¨ÃÃ‚ÂµÃ„Â´Ã˜ÂµÃ„Ã€Ã½Â³ÃŒ', NULL);
INSERT INTO `internal_resources` VALUES ('SP_EDIT', 'MND', 'Â±Ã Â¼Â­Ã•Â¾ÂµÃ£Ã’Â³ÃƒÃ¦', NULL);
INSERT INTO `internal_resources` VALUES ('SP_MENUPROPS', 'MND', 'Â²Ã‹ÂµÂ¥ÃƒÃ»Ã“Ã«Â°Ã¯Ã–ÃºÃŽÃ„Ã—Ã–', NULL);
INSERT INTO `internal_resources` VALUES ('SP_MENUNAME', 'MND', 'Â²Ã‹ÂµÂ¥Ã‰ÃÂµÃ„ÃƒÃ»Â³Ã†', NULL);
INSERT INTO `internal_resources` VALUES ('SP_MENUHELP', 'MND', 'Â²Ã‹ÂµÂ¥Ã‰ÃÂµÃ„Â°Ã¯Ã–ÃºÃŽÃ„Ã—Ã–', NULL);
INSERT INTO `internal_resources` VALUES ('SP_LAUNCHDATE', 'MND', 'Â´Ã“...Â¼Â¤Â»Ã®', NULL);
INSERT INTO `internal_resources` VALUES ('SP_EXPIREDATE', 'MND', 'Â´Ã“...ÃŠÂ§ÃÂ§', NULL);
INSERT INTO `internal_resources` VALUES ('SP_LAUNCHDATES', 'MND', 'ÃŠÂµÃŠÂ±Ã…Ã¤Ã–Ãƒ', NULL);
INSERT INTO `internal_resources` VALUES ('SP_PREVIEW', 'MND', 'Ã”Â¤Ã€Ã€Ã’Â³ÃƒÃ¦', NULL);
INSERT INTO `internal_resources` VALUES ('SP_LAUNCH', 'MND', 'Ã†Ã´Â¶Â¯Ã’Â³ÃƒÃ¦', NULL);
INSERT INTO `internal_resources` VALUES ('SP_EXPIRE', 'MND', 'ÃŠÂ§ÃÂ§Ã’Â³ÃƒÃ¦', NULL);
INSERT INTO `internal_resources` VALUES ('NOSPTITLE', 'MND', 'Ã†Ã´Â¶Â¯Ã’Â³ÃƒÃ¦Ã–Â®Ã‡Â°Ã„ÃºÂ±Ã˜ÃÃ«Â¶Â¨Ã’Ã¥Â²Ã‹ÂµÂ¥Ã‰ÃÂµÃ„ÃƒÃ»Â³Ã†!', NULL);
INSERT INTO `internal_resources` VALUES ('SPM', 'MND', 'Ã•Â¾ÂµÃ£Ã’Â³ÃƒÃ¦Master', NULL);
INSERT INTO `internal_resources` VALUES ('SPM_EDIT', 'MND', 'Â±Ã Â¼Â­Ã•Â¾ÂµÃ£Ã’Â³ÃƒÃ¦Master', NULL);
INSERT INTO `internal_resources` VALUES ('SPM_META', 'MND', 'META-KeyÃ„Â£Â°Ã¥', NULL);
INSERT INTO `internal_resources` VALUES ('SPM_VARIATIONS', 'MND', 'Â¿Ã‰ÃÃ”ÃŠÂ¾ÂµÃ„Â±Ã¤ÃÂ¿', NULL);
INSERT INTO `internal_resources` VALUES ('SPM_TYPE', 'MND', 'Ã’Â³ÃƒÃ¦Ã–Ã–Ã€Ã ', NULL);
INSERT INTO `internal_resources` VALUES ('SPM_CLUSTER', 'MND', 'Â´Ã˜Ã„Â£Â°Ã¥', NULL);
INSERT INTO `internal_resources` VALUES ('SPM_PATH', 'MND', 'Ã„Â£Â°Ã¥Ã‚Â·Â¾Â¶', NULL);
INSERT INTO `internal_resources` VALUES ('CL_BROWSE', 'MND', 'Ã¤Â¯Ã€Ã€Â´Ã˜', NULL);
INSERT INTO `internal_resources` VALUES ('CL_NEW', 'MND', 'ÃÃ‚Ã€Ã½Â³ÃŒ', NULL);
INSERT INTO `internal_resources` VALUES ('CL_PROPERTIES', 'MND', 'Ã€Ã½Â³ÃŒÃŠÃ´ÃÃ”', NULL);
INSERT INTO `internal_resources` VALUES ('CL_DEL', 'MND', 'Ã‰Â¾Â³Ã½Ã€Ã½Â³ÃŒ', NULL);
INSERT INTO `internal_resources` VALUES ('CL_DELMES', 'MND', 'Ã„ÃºÃˆÂ·ÃŠÂµÃÃ«Ã‰Â¾Â³Ã½Ã•Ã¢Â¸Ã¶Â´Ã˜Ã€Ã½Â³ÃŒÃ‚Ã°.Ã‹Ã¹Ã“ÃÃ„ÃšÃˆÃÃŠÃ½Â¾ÃÂ»Ã¡Â¶ÂªÃŠÂ§!', NULL);
INSERT INTO `internal_resources` VALUES ('CL_EDIT', 'MND', 'Â±Ã Â¼Â­Â´Ã˜Ã€Ã½Â³ÃŒ', NULL);
INSERT INTO `internal_resources` VALUES ('CL_CREATEINSTANC', 'MND', 'Â´Â´Â½Â¨ÃÃ‚Ã€Ã½Â³ÃŒ', NULL);
INSERT INTO `internal_resources` VALUES ('CL_CREATEINSMES', 'MND', 'ÃˆÃ”Ã“ÃÂ¿Ã•Â¼Ã¤Â¿Ã‰Â´Â´Â½Â¨Ã•Ã¢Â¸Ã¶Ã„ÃšÃˆÃÃ—Ã–Â¶ÃŽÂµÃ„Â¶Ã®ÃÃ¢Ã€Ã½Â³ÃŒ. ÃˆÃ§Â¹Ã»Ã„ÃºÃÃ«Â´Â´Â½Â¨ÃÃ­Ã’Â»Â¸Ã¶Ã€Ã½Â³ÃŒÂ£Â¬Ã‡Ã«Ã”ÃšÃÃ‚ÃƒÃ¦ÂµÃ„ÃŽÃ„Ã—Ã–Â¿Ã²Ã–ÃÃŠÃ¤ÃˆÃ«Â±ÃªÃŒÃ¢Â£Â¬Â²Â¢Â°Â´ÃÃ‚CreatÂ°Â´Ã…Â¥.', NULL);
INSERT INTO `internal_resources` VALUES ('CL_NOTITLE', 'MND', 'Â»Â¹ÃŽÂ´Â¶Â¨Ã’Ã¥Â±ÃªÃŒÃ¢', NULL);
INSERT INTO `internal_resources` VALUES ('TITLE', 'MND', 'Â±ÃªÃŒÃ¢', NULL);
INSERT INTO `internal_resources` VALUES ('CLI_EDIT', 'MND', 'Â±Ã Â¼Â­Â´Ã˜ÂºÃ…', NULL);
INSERT INTO `internal_resources` VALUES ('CLI_DELETE', 'MND', 'Ã‰Â¾Â³Ã½Â´Ã˜ÂºÃ…', NULL);
INSERT INTO `internal_resources` VALUES ('CLI_DELETEMES', 'MND', 'Ã„ÃºÃˆÂ·ÃŠÂµÃÃ«Ã‰Â¾Â³Ã½Ã•Ã¢Â¸Ã¶Ã€Ã½Â³ÃŒÃ‚Ã°. Ã‹Ã¼Â»Ã¡Ã“Ã€Ã”Â¶ÃŠÂ§ÃˆÂ¥!', NULL);
INSERT INTO `internal_resources` VALUES ('CLI_DELETED', 'MND', 'Ã•Ã¢Â¸Ã¶Ã€Ã½Â³ÃŒÃ’Ã‘Â±Â»Ã‰Â¾Â³Ã½!', NULL);
INSERT INTO `internal_resources` VALUES ('CLI_NOTDELETED', 'MND', 'Ã•Ã¢Â¸Ã¶Ã€Ã½Â³ÃŒÂ²Â»Ã„ÃœÂ±Â»Ã‰Â¾Â³Ã½!', NULL);
INSERT INTO `internal_resources` VALUES ('CLI', 'MND', 'Â´Ã˜Ã€Ã½Â³ÃŒ:', NULL);
INSERT INTO `internal_resources` VALUES ('SR_SELECTCI', 'MND', 'Ã„ÃºÂ¿Ã‰Ã‹Ã‘Ã‹Ã·ÃˆÃŽÂºÃŽÃ•Ã¢Ã€Ã¯ÂµÃ„Ã„ÃšÃˆÃÃŒÃµÃ„Â¿.ÃˆÃ§Â¹Ã»Ã„ÃºÃÃ«Ã‘Â¡Â¶Â¨Ã’Â»Â¸Ã¶Ã„ÃšÃˆÃÃŒÃµÃ„Â¿, Â¿Ã‰Ã‘Â¡Ã–ÃÃ‹Ã¼Â²Â¢Â°Â´ÃÃ‚Â²Â¢Â°Â´ÃÃ‚UpdateÂ°Â´Ã…Â¥! ÃˆÃ§Â¹Ã»Ã„ÃºÃÃ«Â¹Ã˜ÃÂªÃÃ‚Ã„ÃšÃˆÃÃ–ÃÃ•Ã¢Â¸Ã¶Ã—Ã–Â¶ÃŽ, create the content in the Object Browser first.', NULL);
INSERT INTO `internal_resources` VALUES ('SR_SELECTCLI', 'MND', 'Ã‡Ã«Ã‘Â¡Ã”Ã±Ã’Â»Â¸Ã¶Â´Ã˜Ã„Â£Â°Ã¥. ÃˆÂ»ÂºÃ³Ã„ÃºÂ¿Ã‰Ã‘Â¡Ã”Ã±Ã’Â»Â¸Ã¶Ã„Â£Â°Ã¥ÂµÃ„Ã€Ã½Â³ÃŒÃ€Â´ÃŠÂ¹Ã“Ãƒ.', NULL);
INSERT INTO `internal_resources` VALUES ('FOLDER', 'MND', 'ÃŽÃ„Â¼Ã¾Â¼Ã', NULL);
INSERT INTO `internal_resources` VALUES ('CONTENTTYPE', 'MND', 'Ã„ÃšÃˆÃÃ€Ã ÃÃ', NULL);
INSERT INTO `internal_resources` VALUES ('CONTENTITEM', 'MND', 'Ã„ÃšÃˆÃÃŒÃµÃ„Â¿', NULL);
INSERT INTO `internal_resources` VALUES ('SEARCH', 'MND', 'Â¿ÂªÃŠÂ¼Ã‹Ã‘Ã‹Ã·', NULL);
INSERT INTO `internal_resources` VALUES ('SEARCHIN', 'MND', 'Ã‹Ã‘Ã‹Ã·', NULL);
INSERT INTO `internal_resources` VALUES ('SEARCHRESULTS', 'MND', 'Ã‹Ã‘Ã‹Ã·Â½Ã¡Â¹Ã»Â£Â¬Ã‡Ã«Ã‘Â¡Ã”Ã±', NULL);
INSERT INTO `internal_resources` VALUES ('SELECTEDOBJECT', 'MND', 'ÂµÂ±Ã‡Â°Ã‘Â¡Ã”Ã±ÂµÃ„Ã„ÃšÃˆÃÃŒÃµÃ„Â¿', NULL);
INSERT INTO `internal_resources` VALUES ('SELECTEDINSTANCE', 'MND', 'Ã‘Â¡Ã”Ã±Â´Ã˜Ã€Ã½Â³ÃŒ', NULL);
INSERT INTO `internal_resources` VALUES ('M_META', 'MND', 'MetaÃ„Â£Â°Ã¥', NULL);
INSERT INTO `internal_resources` VALUES ('M_BROWSER', 'MND', 'Ã„Â¿Â±ÃªÃ¤Â¯Ã€Ã€Ã†Ã·', NULL);
INSERT INTO `internal_resources` VALUES ('M_INSTALLPLUGIN', 'MND', 'Â²Ã¥Â¼Ã¾', NULL);
INSERT INTO `internal_resources` VALUES ('M_ES', 'MND', 'ÃŒÂ½Ã‹Ã·Ã•Â¾ÂµÃ£', NULL);
INSERT INTO `internal_resources` VALUES ('M_SPM', 'MND', 'Ã•Â¾ÂµÃ£Ã’Â³ÃƒÃ¦Master', NULL);
INSERT INTO `internal_resources` VALUES ('M_PRTMAN', 'MND', 'ÃˆÃ«Â¿ÃšÂ¹ÃœÃ€Ã­Ã†Ã·', NULL);
INSERT INTO `internal_resources` VALUES ('M_MYPRT', 'MND', 'ÃŽÃ’ÂµÃ„ÃˆÃ«Â¿Ãš', NULL);
INSERT INTO `internal_resources` VALUES ('M_MYPROFILE', 'MND', 'ÃŽÃ’ÂµÃ„Â´Â«Ã‚Ã”', NULL);
INSERT INTO `internal_resources` VALUES ('M_LOGOUT', 'MND', 'ÂµÃ‡Â³Ã¶', NULL);
INSERT INTO `internal_resources` VALUES ('M_CLB', 'MND', 'Â´Ã˜Ã¤Â¯Ã€Ã€Ã†Ã·', NULL);
INSERT INTO `internal_resources` VALUES ('M_CLTB', 'MND', 'Â´Ã˜Ã„Â£Â°Ã¥Ã¤Â¯Ã€Ã€Ã†Ã·', NULL);
INSERT INTO `internal_resources` VALUES ('M_UMAN', 'MND', 'Ã“ÃƒÂ»Â§Â¹ÃœÃ€Ã­', NULL);
INSERT INTO `internal_resources` VALUES ('M_VAR', 'MND', 'Â±Ã¤ÃÂ¿', NULL);
INSERT INTO `internal_resources` VALUES ('M_PURGE', 'MND', 'Â¾Â»Â»Â¯ÃŠÃ½Â¾ÃÂ¿Ã¢', NULL);
INSERT INTO `internal_resources` VALUES ('M_PGN', 'MND', 'Â²Ã¥Â¼Ã¾Â¿Ã˜Ã–Ã†', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_NEW', 'MND', 'ÃÃ‚Â´Ã˜Ã„Â£Â°Ã¥', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_BROWSE', 'MND', 'Ã¤Â¯Ã€Ã€Â´Ã˜Ã„Â£Â°Ã¥', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_NAME', 'MND', 'Â´Ã˜Ã„Â£Â°Ã¥ÃƒÃ»Â³Ã†', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_PROPERTIES', 'MND', 'Â´Ã˜Ã„Â£Â°Ã¥ÃŠÃ´ÃÃ”', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_DELETE', 'MND', 'Ã‰Â¾Â³Ã½Â´Ã˜Ã„Â£Â°Ã¥', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_DELMES', 'MND', 'Ã„ÃºÃ•Ã½Ã—Â¼Â±Â¸Ã‰Â¾Â³Ã½Ã’Â»Â¸Ã¶Â´Ã˜Ã„Â£Â°Ã¥. Ã•Ã¢Â»Ã¡ÂµÂ¼Ã–Ã‚Ã”ÃšÃ„Ã‡Â¸Ã¶Â´Ã˜Ã„Â£Â°Ã¥Ã‰ÃÂ´Â´Â½Â¨ÂµÃ„Ã‹Ã¹Ã“Ã(!)Ã„ÃšÃˆÃÂ¶ÂªÃŠÂ§. Ã„ÃºÃˆÂ·Â¶Â¨Ã’ÂªÂ¼ÃŒÃÃ¸Ã‚Ã°?', NULL);
INSERT INTO `internal_resources` VALUES ('CLTI_DELETE', 'MND', 'Ã„ÃºÃŠÃ‡Â·Ã±Ã•Ã¦ÃÃ«Ã‰Â¾Â³Ã½Ã•Ã¢Â¸Ã¶ÃŒÃµÃ„Â¿. Ã•Ã¢Â¸Ã¶ÃŒÃµÃ„Â¿ÂµÃ„Ã‹Ã¹Ã“ÃÃ€Ã½Â³ÃŒÃ’Â²Â»Ã¡Â¶ÂªÃŠÂ§!', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_SCHEME', 'MND', 'Â±Ã Â¼Â­Â´Ã˜Ã„Â£Â°Ã¥Â·Â½Â°Â¸', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_MINCARD', 'MND', 'Ã—Ã®Ã‰Ã™Ã€Ã½Â³ÃŒÃŠÃ½', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_MAXCARD', 'MND', 'Ã—Ã®Â´Ã³Ã€Ã½Â³ÃŒÃŠÃ½', NULL);
INSERT INTO `internal_resources` VALUES ('LINKED', 'MND', 'Â¹Ã˜ÃÂªÃ–Ã', NULL);
INSERT INTO `internal_resources` VALUES ('PG_INSTALLDESC', 'MND', 'Ã‡Ã«ÃˆÂ·Â¶Â¨Ã„ÃºÃ’Ã‘Â½Â«Ã‹Ã¹Ã“ÃÂ±Ã˜ÃÃ¨ÂµÃ„ÃŽÃ„Â¼Ã¾Â¸Â´Ã–Ã†ÂµÂ½Ã•Ã¢Â¸Ã¶ÃŽÃ„Â¼Ã¾Â¼ÃÂ£Â¬Â·Ã±Ã”Ã²Â²Â»Ã„ÃœÂ³Ã‰Â¹Â¦. Ã”ÃšÃÃ‚ÃƒÃ¦ÂµÃ„ÃŠÃ¤ÃˆÃ«Â¿Ã²Ã–ÃÃŠÃ¤ÃˆÃ«Â²Ã¥Â¼Ã¾ÂµÃ„Ã•Ã½ÃˆÂ·Ã‚Â·Â¾Â¶. ÃÂµÃÂ³Â¼Â´Â»Ã¡Ã—Ã”Â¶Â¯Â°Â²Ã—Â°Â²Ã¥Â¼Ã¾.', NULL);
INSERT INTO `internal_resources` VALUES ('PG_CHOOSE', 'MND', 'Â²Ã¥Â¼Ã¾: &nbsp; /plugin/', NULL);
INSERT INTO `internal_resources` VALUES ('PG_FILEWRONG', 'MND', 'Ã”ÃšÂ·Ã¾ÃŽÃ±Ã†Ã·Ã‰ÃÃ•Ã’Â²Â»ÂµÂ½Ã„ÃºÃŠÃ¤ÃˆÃ«ÂµÃ„ÃŽÃ„Â¼Ã¾ÃƒÃ»!', NULL);
INSERT INTO `internal_resources` VALUES ('CLASS_WRONG', 'MND', 'Ã„ÃºÃ–Â¸Â¶Â¨ÂµÃ„ÃŽÃ„Â¼Ã¾ÃƒÂ»Ã“ÃÂºÃÂ·Â¨ÂµÃ„Ã€Ã ÃÃÃ‡Â©ÃƒÃ»!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_INSTALLED', 'MND', 'Â³Ã‰Â¹Â¦Â°Â²Ã—Â°Â²Ã¥Â¼Ã¾!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_UPGRADED', 'MND', 'Â³Ã‰Â¹Â¦Ã‰Ã½Â¼Â¶Â²Ã¥Â¼Ã¾!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_ERROR', 'MND', 'Â°Â²Ã—Â°Â²Ã¥Â¼Ã¾ÃŠÂ±Ã“ÃÂ´Ã­ÃŽÃ³!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_ALREADYINSTAL', 'MND', 'Â²Ã¥Â¼Ã¾Ã’Ã‘Â±Â»Â°Â²Ã—Â°!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_NEWERINSTALLE', 'MND', 'Ã’Ã‘Â¾Â­Â°Â²Ã—Â°Ã“ÃÃ•Ã¢Â¸Ã¶Â²Ã¥Â¼Ã¾ÂµÃ„ÃÃ‚Â°Ã¦Â±Â¾!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_TITLE', 'MND', 'Â²Ã¥Â¼Ã¾', NULL);
INSERT INTO `internal_resources` VALUES ('PG_INSTALL', 'MND', 'Â°Â²Ã—Â°Â²Ã¥Â¼Ã¾', NULL);
INSERT INTO `internal_resources` VALUES ('PG_UNINSTALL', 'MND', 'ÃÂ¶Ã”Ã˜Â²Ã¥Â¼Ã¾', NULL);
INSERT INTO `internal_resources` VALUES ('PG_UNINSTALLMES', 'MND', 'Ã„ÃºÃ•Ã½Ã—Â¼Â±Â¸ÃÂ¶Ã”Ã˜Ã’Â»Â¸Ã¶Ã„Â£Â¿Ã©. ÃÂ¶Ã”Ã˜Ã’Â»Â¸Ã¶Ã„Â£Â¿Ã©Â²Â»Ã–Â»Ã‰Â¾Â³Ã½Ã„ÃšÃˆÃÃ€Ã ÃÃÂ£Â¬ÃÂ¬ÃŠÂ±Ã’Â²Ã‰Â¾Â³Ã½Ã•Ã¢Â¸Ã¶Ã€Ã ÃÃÂ´Â¢Â´Ã¦Ã”ÃšÃŠÃ½Â¾ÃÂ¿Ã¢Ã–ÃÂµÃ„ÃƒÂ¿Â¸Ã¶ÂµÂ¥Â¸Ã¶Ã„Â¿Â±Ãª. ÃÂ¶Ã”Ã˜Â½Â«Â»Ã¡Â¿ÃÂ¶Â¨Ã‰Â¾Â³Ã½Ã•Ã¢Â¸Ã¶Ã„Â£Â¿Ã©ÂµÃ„Ã‹Ã¹Ã“Ã(!)ÃŠÃ½Â¾Ã!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_UNINSTALLDELE', 'MND', 'ÃÂ¶Ã”Ã˜Ã„Â£Â¿Ã©,<br> Ã‰Â¾Â³Ã½Ã‹Ã¹Ã“ÃÂ¶Ã”Ã“Â¦ÂµÃ„Ã„ÃšÃˆÃ.', NULL);
INSERT INTO `internal_resources` VALUES ('O_NEW', 'MND', 'ÃÃ‚Ã„Â¿Â±Ãª', NULL);
INSERT INTO `internal_resources` VALUES ('O_NAME', 'MND', 'Ã„Â¿Â±ÃªÃƒÃ»Â³Ã†', NULL);
INSERT INTO `internal_resources` VALUES ('O_PROPERTIES', 'MND', 'Ã„Â¿Â±ÃªÃŠÃ´ÃÃ”', NULL);
INSERT INTO `internal_resources` VALUES ('O_DELMES', 'MND', 'Ã„ÃºÃ•Ã½Ã—Â¼Â±Â¸Ã‰Â¾Â³Ã½Ã’Â»Â¸Ã¶Ã„Â¿Â±Ãª. <b>Ã—Â¢Ã’Ã¢Â»Ã¡Â¶ÂªÃŠÂ§Ã‹Ã¹Ã“ÃÂ±Ã¤ÃÂ¿Ã“Ã«META-DATA!</b>', NULL);
INSERT INTO `internal_resources` VALUES ('O_DEL', 'MND', 'Ã‰Â¾Â³Ã½Ã„Â¿Â±Ãª', NULL);
INSERT INTO `internal_resources` VALUES ('O_EDIT', 'MND', 'Â±Ã Â¼Â­Ã„Â¿Â±Ãª', NULL);
INSERT INTO `internal_resources` VALUES ('O_PREVIEW', 'MND', 'Ã”Â¤Ã€Ã€', NULL);
INSERT INTO `internal_resources` VALUES ('O_TEXT', 'MND', 'ÃŽÃ„Â±Â¾', NULL);
INSERT INTO `internal_resources` VALUES ('O_ALT', 'MND', 'ALT-Tag', NULL);
INSERT INTO `internal_resources` VALUES ('O_COPYRIGHT', 'MND', 'Â°Ã¦ÃˆÂ¨', NULL);
INSERT INTO `internal_resources` VALUES ('O_BROWSE', 'MND', 'Ã¤Â¯Ã€Ã€Ã„Â¿Â±Ãª', NULL);
INSERT INTO `internal_resources` VALUES ('R_HOME', 'MND', 'Â¿ÂªÃŠÂ¼', NULL);
INSERT INTO `internal_resources` VALUES ('R_NEWFOLDER', 'MND', 'ÃÃ‚ÃŽÃ„Â¼Ã¾Â¼Ã', NULL);
INSERT INTO `internal_resources` VALUES ('R_EDITFOLDER', 'MND', 'Â±Ã Â¼Â­ÃŽÃ„Â¼Ã¾Â¼ÃÃŠÃ´ÃÃ”', NULL);
INSERT INTO `internal_resources` VALUES ('R_FOLDERNAME', 'MND', 'ÃŽÃ„Â¼Ã¾Â¼ÃÃƒÃ»', NULL);
INSERT INTO `internal_resources` VALUES ('R_DELETEFOLDER', 'MND', 'Ã‰Â¾Â³Ã½ÃŽÃ„Â¼Ã¾Â¼Ã', NULL);
INSERT INTO `internal_resources` VALUES ('R_DELFOLDERMES', 'MND', 'Ã„ÃºÃ•Ã½Ã—Â¼Â±Â¸Ã‰Â¾Â³Ã½Ã’Â»Â¸Ã¶ÃŽÃ„Â¼Ã¾Â¼Ã.  Ã‡Ã«Ã‘Â¡Ã”Ã±Ã’Â»Â¸Ã¶Â¶Â¯Ã—Ã·.', NULL);
INSERT INTO `internal_resources` VALUES ('R_FOLDERNOTEMPTY', 'MND', 'ÃŽÃ„Â¼Ã¾Â¼ÃÂ²Â»Â¿Ã•. Ã’Ã²Â´Ã‹Ã„ÃºÂ²Â»Ã„ÃœÃ‰Â¾Â³Ã½Ã‹Ã¼! Ã‡Ã«Â¼Ã¬Â²Ã©Ã‹Ã¹Ã“ÃÃ„Â¿Â±ÃªÃ“Ã«Â´Ã˜!', NULL);
INSERT INTO `internal_resources` VALUES ('R_DELFOLDER', 'MND', 'Ã‰Â¾Â³Ã½ÃŽÃ„Â¼Ã¾Â¼ÃÃ“Ã«Ã‹Ã¹Ã“ÃÃ—Ã“Ã„Â¿Â±Ãª', NULL);
INSERT INTO `internal_resources` VALUES ('R_MOVEOBJECTS', 'MND', 'Â½Â«Ã‹Ã¹Ã“ÃÃ„Â¿Â±ÃªÃ’Ã†Ã–ÃÂ¸Â¸Â½Ã¡ÂµÃ£', NULL);
INSERT INTO `internal_resources` VALUES ('R_PARENT', 'MND', 'Â¸Â¸ÃŽÃ„Â¼Ã¾Â¼Ã', NULL);
INSERT INTO `internal_resources` VALUES ('METATEMPLATES', 'MND', 'MetaÃŠÃ½Â¾ÃÃ„Â£Â°Ã¥', NULL);
INSERT INTO `internal_resources` VALUES ('MT_PROPERTIES', 'MND', 'Â±Ã Â¼Â­MetaÃ„Â£Â°Ã¥ÃŠÃ´ÃÃ”', NULL);
INSERT INTO `internal_resources` VALUES ('MT_SCHEME', 'MND', 'Â±Ã Â¼Â­MetaÃ„Â£Â°Ã¥Â·Â½Â°Â¸', NULL);
INSERT INTO `internal_resources` VALUES ('MT_DELETE', 'MND', 'Ã„ÃºÃŠÃ‡Â·Ã±Ã•Ã¦ÃÃ«Ã‰Â¾Â³Ã½metaÃ„Â£Â°Ã¥ÂµÃ„Ã•Ã¢Â¸Ã¶Â²Â¿Â·Ã–? Ã‹Ã¹Ã“ÃÂ¹Ã˜ÃÂªÂµÂ½Ã•Ã¢Â¸Ã¶Â²Â¿Â·Ã–ÂµÃ„Ã”ÃšCMS METAÃŠÃ¤ÃˆÃ«Ã–ÃÃŠÃ¤ÃˆÃ«ÂµÃ„ÃÃ…ÃÂ¢Â½Â«Â»Ã¡Â±Â»Ã‰Â¾Â³Ã½. ÃŠÃ½Â¾ÃÂ»Ã¡Ã“Ã€Ã”Â¶Â¶ÂªÃŠÂ§!', NULL);
INSERT INTO `internal_resources` VALUES ('MT_ADDITIONAL', 'MND', 'Â¸Â½Â¼Ã“ÂµÃ„METAÃŠÃ½Â¾Ã', NULL);
INSERT INTO `internal_resources` VALUES ('MT_BASE', 'MND', 'Â»Ã¹Â±Â¾ÂµÃ„METAÃŠÃ½Â¾Ã', NULL);
INSERT INTO `internal_resources` VALUES ('MT_MODULE', 'MND', 'Ã„ÃšÃˆÃÃ€Ã ÃÃÃ–Â¸Â¶Â¨ÂµÃ„METAÃŠÃ½Â¾Ã', NULL);
INSERT INTO `internal_resources` VALUES ('VARIATIONS', 'MND', 'Â¿Ã‰Ã“ÃƒÂµÃ„Â±Ã¤ÃÂ¿', NULL);
INSERT INTO `internal_resources` VALUES ('V_NAME', 'MND', 'ÃƒÃ»Â³Ã†', NULL);
INSERT INTO `internal_resources` VALUES ('V_SHORT', 'MND', 'Short-Tag', NULL);
INSERT INTO `internal_resources` VALUES ('V_EDIT', 'MND', 'Â±Ã Â¼Â­Â±Ã¤ÃÂ¿', NULL);
INSERT INTO `internal_resources` VALUES ('LOGIN_FAILED', 'MND', 'Ã„ÃºÃŠÃ¤ÃˆÃ«ÂµÃ„ÂµÃ‡Ã‚Â¼ÃŠÃ½Â¾ÃÂ²Â»Ã„ÃœÂ±Â»Ã‘Ã©Ã–Â¤! Ã‡Ã«Ã”Ã™ÃŠÃ”Ã’Â»Â±Ã©.', NULL);
INSERT INTO `internal_resources` VALUES ('USER_HEAD', 'MND', 'Ã“ÃƒÂ»Â§Â´Â«Ã‚Ã”', NULL);
INSERT INTO `internal_resources` VALUES ('USER_LINK', 'MND', 'Ã“ÃƒÂ»Â§Â´Â«Ã‚Ã”', NULL);
INSERT INTO `internal_resources` VALUES ('USER_NAME', 'MND', 'Ã“ÃƒÂ»Â§ÃƒÃ»', NULL);
INSERT INTO `internal_resources` VALUES ('FULL_NAME', 'MND', 'ÃˆÂ«ÃƒÃ»', NULL);
INSERT INTO `internal_resources` VALUES ('PASSWORD', 'MND', 'ÃƒÃœÃ‚Ã«', NULL);
INSERT INTO `internal_resources` VALUES ('USER_EMAIL', 'MND', 'eMail', NULL);
INSERT INTO `internal_resources` VALUES ('USER_ACTIVE', 'MND', 'ÃŠÂ¹Ã•ÃŠÂºÃ…Â¿Ã‰Ã“Ãƒ', NULL);
INSERT INTO `internal_resources` VALUES ('USER_FILTERMENU', 'MND', 'Ã“ÃƒÂ»Â§Â¹ÃœÃ€Ã­', NULL);
INSERT INTO `internal_resources` VALUES ('USER_SETPERM', 'MND', 'Ã”ÃšÃÃ‚ÃƒÃ¦Ã‰Ã¨Ã–ÃƒÃ“ÃƒÂ»Â§ÃˆÂ¨ÃÃž. Ã’ÂªÂ´Ã“Ã—Ã©Ã–ÃÃ‰Â¾Â³Ã½Ã’Â»Â¸Ã¶Ã“ÃƒÂ»Â§, Â½Â«Ã‹Ã»Â´Ã“Ã‹Ã¹Ã“ÃÂµÃ„Ã—Ã©Ã–ÃÂ³Â·ÃÃ»Â¼Â´Â¿Ã‰.', NULL);
INSERT INTO `internal_resources` VALUES ('USER_PERMGRID', 'MND', 'ÃˆÂ¨ÃÃžÂ±Ã­', NULL);
INSERT INTO `internal_resources` VALUES ('GROUP_LINK', 'MND', 'Ã—Ã©Â´Â«Ã‚Ã”', NULL);
INSERT INTO `internal_resources` VALUES ('GROUP_HEAD', 'MND', 'Ã—Ã©Â´Â«Ã‚Ã”', NULL);
INSERT INTO `internal_resources` VALUES ('GROUP_NAME', 'MND', 'Ã—Ã©ÃƒÃ»', NULL);
INSERT INTO `internal_resources` VALUES ('GROUP_DESCRIPTIO', 'MND', 'ÃƒÃ¨ÃŠÃ¶', NULL);
INSERT INTO `internal_resources` VALUES ('GROUP_FILTERMENU', 'MND', 'Ã—Ã©Â¹ÃœÃ€Ã­', NULL);
INSERT INTO `internal_resources` VALUES ('ROLE_LINK', 'MND', 'Â½Ã‡Ã‰Â«Â´Â«Ã‚Ã”', NULL);
INSERT INTO `internal_resources` VALUES ('ROLE_HEAD', 'MND', 'Â½Ã‡Ã‰Â«Â´Â«Ã‚Ã”', NULL);
INSERT INTO `internal_resources` VALUES ('ROLE_NAME', 'MND', 'Â½Ã‡Ã‰Â«ÃƒÃ»e', NULL);
INSERT INTO `internal_resources` VALUES ('ROLE_DESCRIPTION', 'MND', 'ÃƒÃ¨ÃŠÃ¶', NULL);
INSERT INTO `internal_resources` VALUES ('ROLE_FILTERMENU', 'MND', 'Â½Ã‡Ã‰Â«Â¹ÃœÃ€Ã­', NULL);
INSERT INTO `internal_resources` VALUES ('USER_PERMISSIONS', 'MND', 'Ã“ÃƒÂ»Â§ÃˆÂ¨ÃÃž', NULL);
INSERT INTO `internal_resources` VALUES ('UP_INTRO', 'MND', 'Ã‡Ã«Ã‘Â¡Ã”Ã±Ã„ÃºÃÃ«Â¸Â³Ã“Ã¨Ã“ÃƒÂ»Â§ÂµÃ„Ã—Ã©Â¼Â°Ã”ÃšÃ—Ã©Ã–ÃÂµÃ„Â½Ã‡Ã‰Â«.', NULL);
INSERT INTO `internal_resources` VALUES ('USER_TO_GROUP', 'MND', 'ÃŒÃ­Â¼Ã“Ã“ÃƒÂ»Â§ÂµÂ½Ã—Ã©Ã–Ã', NULL);
INSERT INTO `internal_resources` VALUES ('ERROR_SEL_GROUP', 'MND', 'Ã„ÃºÂ±Ã˜ÃÃ«Ã‘Â¡Ã”Ã±Ã’Â»Â¸Ã¶Ã—Ã©!', NULL);
INSERT INTO `internal_resources` VALUES ('ERROR_SEL_ROLE', 'MND', 'Ã„ÃºÂ±Ã˜ÃÃ«Ã–ÃÃ‰Ã™Ã‘Â¡Ã”Ã±Ã’Â»Â¸Ã¶Â½Ã‡Ã‰Â«!', NULL);
INSERT INTO `internal_resources` VALUES ('USER_PROFILE', 'MND', 'ÃŽÃ’ÂµÃ„Â´Â«Ã‚Ã”', NULL);
INSERT INTO `internal_resources` VALUES ('COMMIT', 'MND', 'ÃŽÂ¯ÃÃ', NULL);
INSERT INTO `internal_resources` VALUES ('CANCEL', 'MND', 'ÃˆÂ¡ÃÃ»', NULL);
INSERT INTO `internal_resources` VALUES ('YES', 'MND', 'ÃŠÃ‡', NULL);
INSERT INTO `internal_resources` VALUES ('NO', 'MND', 'Â·Ã±', NULL);
INSERT INTO `internal_resources` VALUES ('NEW', 'MND', 'Â²Ã¥ÃˆÃ«ÃÃ‚ÂµÃ„', NULL);
INSERT INTO `internal_resources` VALUES ('NAME', 'MND', 'ÃƒÃ»Â³Ã†', NULL);
INSERT INTO `internal_resources` VALUES ('DESCRIPTION', 'MND', 'ÃƒÃ¨ÃŠÃ¶', NULL);
INSERT INTO `internal_resources` VALUES ('DOSOMETHING', 'MND', 'Ã‡Ã«Ã‘Â¡Ã”Ã±Ã„ÃºÃ’ÂªÂ½Ã¸ÃÃÂµÃ„Â¶Â¯Ã—Ã·. Ã„ÃºÂ¿Ã‰Â²Ã¥ÃˆÃ«ÃÃ‚ÃŒÃµÃ„Â¿, Â±Ã Â¼Â­ÃŒÃµÃ„Â¿, Ã‰Â¾Â³Ã½ÃŒÃµÃ„Â¿Â¼Â°Â¸Ã„Â±Ã¤ÃŒÃµÃ„Â¿Ã‹Â³ÃÃ².', NULL);
INSERT INTO `internal_resources` VALUES ('EDIT', 'MND', 'Â±Ã Â¼Â­', NULL);
INSERT INTO `internal_resources` VALUES ('UP', 'MND', 'Ã‰Ã', NULL);
INSERT INTO `internal_resources` VALUES ('DOWN', 'MND', 'ÃÃ‚', NULL);
INSERT INTO `internal_resources` VALUES ('CONTAINERNAME', 'MND', 'Ã„Â£Â°Ã¥', NULL);
INSERT INTO `internal_resources` VALUES ('SELECTOBJECT', 'MND', 'Ã‡Ã«Ã‘Â¡Ã”Ã±Ã’Â»Â¸Ã¶Ã€Ã ÃÃÂ²Â¢Ã–Â¸Â¶Â¨Ã’Â»Â¸Ã¶ÃŽÂ»Ã–ÃƒÃ“Ã«ÃƒÃ»Â³Ã†Ã’Ã”Â±Ã£Â´Â´Â½Â¨Ã’Â»Â¸Ã¶ÃÃ‚Ã„Â¿Â±Ãª.<br>Â¶Ã”Ã“ÃšÃŽÂ»Ã–ÃƒÂ£Â¬Â°Â´Ã„ÃºÂµÃ„ÃÃ¨Ã’ÂªÂ£Â¬ÃŠÂ¹Ã“Ãƒ 0 Â½Â«Â²Ã¥Ã”ÃšÂ¿ÂªÃÂ·Â£Â¬999 Â½Â«Â²Ã¥Ã”ÃšÃ„Â©ÃŽÂ²Â£Â¬Ã’Ã”Â¼Â°Ã†Ã¤Ã‹Ã¼ÃŽÂ»Ã–Ãƒ.', NULL);
INSERT INTO `internal_resources` VALUES ('POSITION', 'MND', 'ÃŽÂ»Ã–Ãƒ', NULL);
INSERT INTO `internal_resources` VALUES ('DELETE', 'MND', 'Ã‰Â¾Â³Ã½', NULL);
INSERT INTO `internal_resources` VALUES ('TYPE', 'MND', 'Ã€Ã ÃÃ', NULL);
INSERT INTO `internal_resources` VALUES ('KEYWORDS', 'MND', 'Â¹Ã˜Â¼Ã¼Ã—Ã–', NULL);
INSERT INTO `internal_resources` VALUES ('METATEMPLATE', 'MND', 'Â¸Â½Â¼Ã“ÂµÃ„META-KeyÃ„Â£Â°Ã¥', NULL);
INSERT INTO `internal_resources` VALUES ('SELECT_VARIATION', 'MND', 'Ã‘Â¡Ã”Ã±Â±Ã¤ÃÂ¿', NULL);
INSERT INTO `internal_resources` VALUES ('ACTIVE_VARIATION', 'MND', 'Â¼Â¤Â»Ã®ÂµÃ„Â±Ã¤ÃÂ¿:', NULL);
INSERT INTO `internal_resources` VALUES ('NO_VARIATIONS', 'MND', 'Ã„Â¿Ã‡Â°Ã•Ã¢Â¸Ã¶ÃƒÂ»Ã“ÃÂ¶Â¨Ã’Ã¥Â±Ã¤ÃÂ¿!<br> Ã‡Ã«Ã•Ã’Ã’Â»ÃŽÂ»Â¿ÂªÂ·Â¢Ã•ÃŸÂ¼Ã¬Â²Ã©Ã‹Ã¹Ã‘Â¡ÂµÃ„ÃŒÃµÃ„Â¿ÂµÃ„Ã…Ã¤Ã–Ãƒ!', NULL);
INSERT INTO `internal_resources` VALUES ('ED_CONTENT', 'MND', 'Â±Ã Â¼Â­Ã„ÃšÃˆÃ', NULL);
INSERT INTO `internal_resources` VALUES ('ED_META', 'MND', 'Â±Ã Â¼Â­METAÃŠÃ½Â¾Ã', NULL);
INSERT INTO `internal_resources` VALUES ('ED_DISPATCHER', 'MND', 'ÃŠÂ¹Ã“ÃƒÃ•Ã¢Â¸Ã¶Â°Â´Ã…Â¥Ã”ÃšÂ±Ã Â¼Â­METAÃŠÃ½Â¾ÃÃ“Ã«Â±Ã Â¼Â­Ã„ÃšÃˆÃÃ–Â®Â¼Ã¤Ã‡ÃÂ»Â».', NULL);
INSERT INTO `internal_resources` VALUES ('PREVIEW', 'MND', 'Ã”Â¤Ã€Ã€', NULL);
INSERT INTO `internal_resources` VALUES ('CHOOSEFILE', 'MND', 'Ã‘Â¡Ã”Ã±Ã’Â»Â¸Ã¶ÃŽÃ„Â¼Ã¾', NULL);
INSERT INTO `internal_resources` VALUES ('CONFIGURED', 'MND', 'Ã’Ã‘Ã—Â¼Â±Â¸ÂºÃƒÃŠÂ¹Ã“Ãƒ.', NULL);
INSERT INTO `internal_resources` VALUES ('NOTCONFIGURED', 'MND', 'ÃŽÂ´Ã…Ã¤Ã–Ãƒ.', NULL);
INSERT INTO `internal_resources` VALUES ('CONFIG', 'MND', 'Ã…Ã¤Ã–Ãƒ', NULL);
INSERT INTO `internal_resources` VALUES ('SELECT_CI', 'MND', 'Ã‘Â¡Ã”Ã±Ã’Â»Â¸Ã¶Ã„ÃšÃˆÃÃŒÃµÃ„Â¿', NULL);
INSERT INTO `internal_resources` VALUES ('SELECT_CL', 'MND', 'Ã‘Â¡Ã”Ã±Ã’Â»Â¸Ã¶Â´Ã˜Ã€Ã½Â³ÃŒ', NULL);
INSERT INTO `internal_resources` VALUES ('EMPTY', 'MND', '&lt;Â¿Ã•&gt;', NULL);
INSERT INTO `internal_resources` VALUES ('STATUS', 'MND', 'Ã—Â´ÃŒÂ¬:', NULL);
INSERT INTO `internal_resources` VALUES ('UNIQUE', 'MND', 'Ã•Ã¢Â¸Ã¶Ã—Ã–Â¶ÃŽÂ±Ã˜ÃÃ«ÃŠÃ‡ÃŽÂ¨Ã’Â»ÂµÃ„!', NULL);
INSERT INTO `internal_resources` VALUES ('MANDATORY', 'MND', 'Ã•Ã¢Â¸Ã¶Ã—Ã–Â¶ÃŽÂ±Ã˜ÃÃ«ÃŽÂªÂ¿Ã•!', NULL);
INSERT INTO `internal_resources` VALUES ('NOTNUMBER', 'MND', 'Ã„ÃºÂ±Ã˜ÃÃ«ÃŠÃ¤ÃˆÃ«Ã’Â»Â¸Ã¶ÃŠÃ½Ã—Ã–ÂµÂ½Ã•Ã¢Â¸Ã¶Ã—Ã–Â¶ÃŽÃ–Ã!', NULL);
INSERT INTO `internal_resources` VALUES ('WRONGDATE', 'MND', 'Ã„ÃºÃŠÃ¤ÃˆÃ«ÂµÃ„ÃŠÃ½Â¾ÃÂ²Â»Â´Ã¦Ã”Ãš!', NULL);
INSERT INTO `internal_resources` VALUES ('DATEFORMAT', 'MND', 'ÃŠÃ½Â¾ÃÂ¸Ã±ÃŠÂ½Â²Â»Â¶Ã”!', NULL);
INSERT INTO `internal_resources` VALUES ('PWDNOTMATCH', 'MND', 'Ã„ÃºÃŠÃ¤ÃˆÃ«ÂµÃ„ÃƒÃœÃ‚Ã«Â²Â»Â¶Ã”!', NULL);
INSERT INTO `internal_resources` VALUES ('PWDTOOSHORT', 'MND', 'ÃƒÃœÃ‚Ã«Â±Ã˜ÃÃ«Ã–ÃÃ‰Ã™Ã“ÃÃ–Ãº6Â¸Ã¶Ã—Ã–Â·Ã»!', NULL);
INSERT INTO `internal_resources` VALUES ('PROCERROR', 'MND', 'Â´Â¦Ã€Ã­Â±Ã­ÂµÂ¥ÃŠÂ±Â³Ã¶ÃÃ–Â´Ã­ÃŽÃ³. Ã‡Ã«Â¼Ã¬Â²Ã©Â±ÃªÃŽÂªÃ€Â¶Ã‰Â«ÂµÃ„Ã—Ã–Â¶ÃŽÂ²Â¢Ã”Ã„Â¶ÃÃ„Ã‡Ã€Ã¯ÃˆÂ¡ÂµÃƒÂ½Ã¸Ã’Â»Â²Â½ÂµÃ„ÃÃ…ÃÂ¢.', NULL);
INSERT INTO `internal_resources` VALUES ('SAVEERROR', 'MND', 'Â½Â«ÃŠÃ½Â¾ÃÂ´Ã¦ÃˆÃ«ÃŠÃ½Â¾ÃÂ¿Ã¢ÃŠÂ±Â³Ã¶ÃÃ–Â´Ã­ÃŽÃ³. Ã‡Ã«ÃˆÂ·Â¶Â¨ÃŠÃ½Â¾ÃÂ¿Ã¢Ã’Ã‘ÃÂ¬Â½Ã“Â£Â¬Â»Ã²Ã•Ã’Ã„ÃºÂµÃ„Â¹ÃœÃ€Ã­Ã”Â±.', NULL);
INSERT INTO `internal_resources` VALUES ('SAVESUCCESS', 'MND', 'ÃŠÃ½Â¾ÃÂ³Ã‰Â¹Â¦ÃÂ´ÃˆÃ«ÃŠÃ½Â¾ÃÂ¿Ã¢.', NULL);
INSERT INTO `internal_resources` VALUES ('DELETESUCCESS', 'MND', 'ÃÃ‚ÃÃÃŠÃ½Â¾ÃÃ’Ã‘Â±Â»Â´Ã“ÃŠÃ½Â¾ÃÂ¿Ã¢Ã–ÃÂ³Ã‰Â¹Â¦Ã‰Â¾Â³Ã½. ÃÃ–Ã”ÃšÃ‹Ã¼Ã’Ã‘Â¶ÂªÃŠÂ§!', NULL);
INSERT INTO `internal_resources` VALUES ('SELECTONE', 'MND', 'Ã„ÃºÂ±Ã˜ÃÃ«Ã”ÃšÃ•Ã¢Ã€Ã¯Ã—Ã¶Â³Ã¶Ã’Â»Â¸Ã¶Ã‘Â¡Ã”Ã±!', NULL);
INSERT INTO `internal_resources` VALUES ('CREATENEW', 'MND', 'Ã•Ã¢Â¸Ã¶Ã„Â£Â°Ã¥Ã’Ã‘Â´Â´Â½Â¨Ã’Â»Â¸Ã¶ÃÃ‚Â³Ã‰Ã”Â±. Ã‡Ã«Â²ÃŽÂ¼Ã»ÃÃ‚ÃÃÃŠÃ½Â¾Ã.', NULL);
INSERT INTO `internal_resources` VALUES ('PROMPTDELETE', 'MND', 'Ã„ÃºÃŠÃ‡Â·Ã±Ã•Ã¦ÃÃ«Ã‰Â¾Â³Ã½Ã•Ã¢Â¸Ã¶ÃŠÃ½Â¾ÃÂ¼Â¯? Ã•Ã¢Â¸Ã¶Â¶Â¯Ã—Ã·Â²Â»Ã„ÃœÂ·Â´Â»Ãš!', NULL);
INSERT INTO `internal_resources` VALUES ('RESET', 'MND', 'Ã–Ã˜Ã–ÃƒÂ±Ã­ÂµÂ¥', NULL);
INSERT INTO `internal_resources` VALUES ('BACK', 'MND', 'ÃÃ‹Â»Ã˜', NULL);
INSERT INTO `internal_resources` VALUES ('CREATE', 'MND', 'Â´Â´Â½Â¨ÃŒÃµÃ„Â¿', NULL);
INSERT INTO `internal_resources` VALUES ('ERROR', 'MND', 'Ã”ÃšÂ½Ã¸ÃÃÃ‹Ã¹Ã‘Â¡Â²Ã™Ã—Ã·ÃŠÂ±Â³Ã¶Â´Ã­!', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE', 'MND', 'Â¾Â»Â»Â¯ÃŠÃ½Â¾ÃÂ¿Ã¢', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_MES', 'MND', 'Ã‡Ã«Ã‘Â¡Ã”Ã±Ã„ÃºÃÃ«Â¾Â»Â»Â¯ÂµÃ„ÃŠÃ½Â¾ÃÂ¿Ã¢Â²Â¿Â·Ã–.', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_VAR', 'MND', 'Â¾Â»Â»Â¯Â²ÃŽÃŠÃ½', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_CONTENT', 'MND', 'Â¾Â»Â»Â¯Ã„ÃšÃˆÃ', NULL);
INSERT INTO `internal_resources` VALUES ('VAR_SUCCEEDED', 'MND', ' Â³Ã‰Â¹Â¦!', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_FOLDER', 'MND', 'Â¾Â»Â»Â¯ÃŽÃ„Â¼Ã¾Â¼Ã', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_CLUSTER', 'MND', 'Â¾Â»Â»Â¯Â´Ã˜', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_META', 'MND', 'Â¾Â»Â»Â¯Meta', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_CLT', 'MND', 'Â¾Â»Â»Â¯Â´Ã˜Ã„Â£Â°Ã¥', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_PAGES', 'MND', 'Â¾Â»Â»Â¯Ã•Â¾ÂµÃ£Ã’Â³ÃƒÃ¦Ã“Ã«Masters', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_EXPIRED', 'MND', 'Â¾Â»Â»Â¯ÃŠÂ§ÃÂ§ÂµÃ„Ã’Â³ÃƒÃ¦', NULL);
...
INSERT INTO `internal_resources` VALUES ('PO_CRSUCCEEDED', 'IT', 'La creazione della nuova pagina del portale Ã¨ avvenuta con successo!', NULL);
...
INSERT INTO `internal_resources` VALUES ('SP_IPROPERTIES', 'IT', 'PropietÃ  dalla pagina', NULL);
INSERT INTO `internal_resources` VALUES ('SP_PROPERTIES', 'IT', 'ProprietÃ  della pagina del sito', NULL);
...
INSERT INTO `internal_resources` VALUES ('SP_MENUPROPS', 'IT', 'Nome del menÃ¹ e testo di aiuto', NULL);
INSERT INTO `internal_resources` VALUES ('SP_MENUNAME', 'IT', 'Nome nel MenÃ¹', NULL);
INSERT INTO `internal_resources` VALUES ('SP_MENUHELP', 'IT', 'Testo di aiuto per il MenÃ¹', NULL);
...
INSERT INTO `internal_resources` VALUES ('SP_EXPIRE', 'IT', 'FÃ  scadere pagina', NULL);
...
INSERT INTO `internal_resources` VALUES ('CL_PROPERTIES', 'IT', 'ProprietÃ  del gruppo', NULL);
...
INSERT INTO `internal_resources` VALUES ('CLI_DELETEMES', 'IT', 'Vuoi veramente cancellare questa istanza. SarÃ  persa per sempre!', NULL);
INSERT INTO `internal_resources` VALUES ('CLI', 'IT', 'Istanza di gruppo:', NULL);
INSERT INTO `internal_resources` VALUES ('SR_SELECTCI', 'IT', 'Puoi cercare quÃ¬ per ogni content-items . Se vuoi selezionare un content-item, sceglierlo e premere il pulsante di Update ! Se vuoi connettere un nuovo contenuto con questo campo, bisogna prima creare il contenuto nel navigatore di oggetti.', NULL);
INSERT INTO `internal_resources` VALUES ('SR_SELECTCLI', 'IT', 'Selezionare un cluster-template. DopodichÃ¨ puoi selezionare una istanza del template da assegnare.', NULL);
...
INSERT INTO `internal_resources` VALUES ('CLT_PROPERTIES', 'IT', 'ProprietÃ  del Cluster-Template', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_DELETE', 'IT', 'Cancella il Cluster-Template', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_DELMES', 'IT', 'Vuoi candellare il cluster-template. Questo comporterÃ  la perdita di tutti(!) i contenuti creati su e con il cluster-template. Sei sicuro, vuoi proseguire?', NULL);
...
INSERT INTO `internal_resources` VALUES ('PG_INSTALLDESC', 'IT', 'Essere sicuri di aver copiato tutti i necessari file nella cartella. Inserire il percorso corretto per i plugin nel campo sottostante. Il sistema istallerÃ  i the PlugIn automaticamente.', NULL);
INSERT INTO `internal_resources` VALUES ('PG_CHOOSE', 'IT', 'PlugIn: &nbsp; /plugin/', NULL);
INSERT INTO `internal_resources` VALUES ('PG_FILEWRONG', 'IT', 'Il file inserito non Ã¨ stato trovato nel server!', NULL);
INSERT INTO `internal_resources` VALUES ('CLASS_WRONG', 'IT', 'Il file specificato non ha un firma di classe valida!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_INSTALLED', 'IT', 'Il PlugIn Ã¨ stato installato con successo!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_UPGRADED', 'IT', 'Il PlugIn Ã¨ stato aggiornato con successo!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_ALREADYINSTAL', 'IT', 'Il PlugIn Ã¨ giÃ  istallato!', NULL);
...
INSERT INTO `internal_resources` VALUES ('O_PROPERTIES', 'IT', 'ProprietÃ  degli oggetti', NULL);
...
INSERT INTO `internal_resources` VALUES ('R_EDITFOLDER', 'IT', 'Edita le proprietÃ  del contenitore', NULL);
...
INSERT INTO `internal_resources` VALUES ('R_FOLDERNOTEMPTY', 'IT', 'Il contenitore non Ã¨ vuoto. Non Ã¨ possibili cancellarlo! Controllare tutti gli oggetti e gruppi!', NULL);
...
INSERT INTO `internal_resources` VALUES ('MT_PROPERTIES', 'IT', 'Edita la proprietÃ  dei Meta-Contenitori', NULL);
...
INSERT INTO `internal_resources` VALUES ('UP', 'IT', 'SÃ¹', NULL);
INSERT INTO `internal_resources` VALUES ('DOWN', 'IT', 'GiÃ¹', NULL);
...
INSERT INTO `internal_resources` VALUES ('MANDATORY', 'IT', 'Questo campo non puÃ² essere vuoto!', NULL);
...
INSERT INTO `internal_resources` VALUES ('DATEFORMAT', 'IT', 'Il formato della data non Ã¨ corretto!', NULL);
INSERT INTO `internal_resources` VALUES ('PWDNOTMATCH', 'IT', 'La passwords inserita non Ã¨ corretta!', NULL);
INSERT INTO `internal_resources` VALUES ('PWDTOOSHORT', 'IT', 'La password deve essere di almeno 6 caratteri!', NULL);
INSERT INTO `internal_resources` VALUES ('PROCERROR', 'IT', 'Un errore Ã¨ successo mentre si processava il form. Controllare il campo marcato di blu e leggere quÃ¬ per ulteriori informazioni.', NULL);
INSERT INTO `internal_resources` VALUES ('SAVEERROR', 'IT', 'Si Ã¨ verificato un errore mentre si stavano salvando i dati nel database. Assicurarsi che il database sia connesso o contattare il proprio Amministratore.', NULL);
...
INSERT INTO `internal_resources` VALUES ('SELECTONE', 'IT', 'Devi fare una scelta quÃ¬!', NULL);
INSERT INTO `internal_resources` VALUES ('CREATENEW', 'IT', 'Un nuovo membro di questo template Ã¨ stato creato. Guardare i dati elencati sotto.', NULL);
INSERT INTO `internal_resources` VALUES ('PROMPTDELETE', 'IT', 'Vuoi veramente cancellare questo dataset? Questa azione non puÃ² essere ripristinata!', NULL);
...
INSERT INTO `internal_resources` VALUES ('USER_JS', 'PL', 'UÂ¿yj Javascript', NULL);
INSERT INTO `internal_resources` VALUES ('USER_BL', 'PL', 'JÃªzyk systemu zarzÂ±dzania', NULL);
INSERT INTO `internal_resources` VALUES ('PO_BROWSER', 'PL', 'PrzeglÂ±danie Portali', NULL);
INSERT INTO `internal_resources` VALUES ('PO_OWNER', 'PL', 'WÂ³aÂ¶ciciel Strony', NULL);
INSERT INTO `internal_resources` VALUES ('PO_CRSUCCEEDED', 'PL', 'Utworzenie nowej strony portalu powiodÂ³o siÃª!', NULL);
...
INSERT INTO `internal_resources` VALUES ('SP_BROWSE', 'PL', 'PrzeglÂ±danie ukÂ³adu stron', NULL);
...
INSERT INTO `internal_resources` VALUES ('SP_IPROPERTIES', 'PL', 'WÂ³aÂ¶ciwoÂ¶ci strony', NULL);
INSERT INTO `internal_resources` VALUES ('SP_PROPERTIES', 'PL', 'WÂ³aÂ¶ciwoÂ¶ci strony serwisu', NULL);
INSERT INTO `internal_resources` VALUES ('SP_DELMES', 'PL', 'Zamierzasz usunÂ±Ã¦ stronÃª serwisu. ProszÃª zauwaÂ¿yÃ¦, Â¿e takÂ¿e czynna wersja tej strony serwisu zostanie usuniÃªta!', NULL);
INSERT INTO `internal_resources` VALUES ('SP_DELETE', 'PL', 'UsuniÃªcie strony serwisu', NULL);
INSERT INTO `internal_resources` VALUES ('SP_PDELMES', 'PL', 'Zamierzasz usunÂ±Ã¦ stronÃª. ProszÃª zauwaÂ¿yÃ¦, Â¿e takÂ¿e czynna wersja tej strony zostanie usuniÃªta!', NULL);
INSERT INTO `internal_resources` VALUES ('SP_PDELETE', 'PL', 'UsuniÃªcie strony', NULL);
INSERT INTO `internal_resources` VALUES ('SP_CONFIGURE', 'PL', 'Konfiguracja strony', NULL);
INSERT INTO `internal_resources` VALUES ('SP_CONFDESC', 'PL', 'MoÂ¿na poÂ³Â±czyÃ¦ tÂ± stronÃª serwisu z instniejÂ±cym wystaÂ±pieniem klastra lub moÂ¿na utworzyÃ¦ nowÂ± instancjÃª. ProszÃª zadecydowaÃ¦ co zamierzsz zrobiÃ¦.', NULL);
INSERT INTO `internal_resources` VALUES ('SP_LINK', 'PL', 'UtworzyÃ¦ poÂ³Â±czenie do istniejÂ±cego wystÂ±pienia klastra', NULL);
INSERT INTO `internal_resources` VALUES ('SP_CLNEW', 'PL', 'StworzyÃ¦ nowe wystÂ±pienie klastra', NULL);
...
INSERT INTO `internal_resources` VALUES ('SP_LAUNCHDATE', 'PL', 'WaÂ¿ne od', NULL);
INSERT INTO `internal_resources` VALUES ('SP_EXPIREDATE', 'PL', 'UpÂ³ywa od', NULL);
INSERT INTO `internal_resources` VALUES ('SP_LAUNCHDATES', 'PL', 'Konfiguracja czasu pracy', NULL);
INSERT INTO `internal_resources` VALUES ('SP_PREVIEW', 'PL', 'PodglÂ±d strony', NULL);
INSERT INTO `internal_resources` VALUES ('SP_LAUNCH', 'PL', 'Uruchom stronÃª', NULL);
INSERT INTO `internal_resources` VALUES ('SP_EXPIRE', 'PL', 'Przedawnij stronÃª', NULL);
INSERT INTO `internal_resources` VALUES ('NOSPTITLE', 'PL', 'NaleÂ¿y zdefiniowaÃ¦ nazwÃª w menu przed uruchomieniem strony!', NULL);
...
INSERT INTO `internal_resources` VALUES ('SPM_VARIATIONS', 'PL', 'WyÂ¶wietlane wersje', NULL);
...
INSERT INTO `internal_resources` VALUES ('SPM_PATH', 'PL', 'Â¦cieÂ¿ka do wzorca', NULL);
INSERT INTO `internal_resources` VALUES ('CL_BROWSE', 'PL', 'PrzeglÂ±danie klastrÃ³w', NULL);
INSERT INTO `internal_resources` VALUES ('CL_NEW', 'PL', 'Nowe wystÂ±pienie', NULL);
INSERT INTO `internal_resources` VALUES ('CL_PROPERTIES', 'PL', 'WÂ³aÂ¶ciwoÂ¶ci klastra', NULL);
INSERT INTO `internal_resources` VALUES ('CL_DEL', 'PL', 'UsuÃ± wystÂ±pienie', NULL);
INSERT INTO `internal_resources` VALUES ('CL_DELMES', 'PL', 'Czy na pewno chcesz usunÂ±Ã¦ to wystÂ±pienie klastra? Wszystkie dane zawartoÂ¶ci zostanÂ± stracone!', NULL);
INSERT INTO `internal_resources` VALUES ('CL_EDIT', 'PL', 'Edycja wystÂ±pienia klastra', NULL);
INSERT INTO `internal_resources` VALUES ('CL_CREATEINSTANC', 'PL', 'UtÃ³rzenie nowego wystÂ±pienia', NULL);
INSERT INTO `internal_resources` VALUES ('CL_CREATEINSMES', 'PL', 'Nadal zostajÂ± gniazda do utworzenia dodatkowych wystÂ±pieÃ± dla thych pÃ³l zawartoÂ¶ci. JeÂ¿eli chcesz utworzyÃ¦ dodatkowe wystÂ±pienie, wprowadÂ¼ tytuÂ³ w polu tekstowym poniÂ¿ej i naciÂ¶nij przycisk utwÃ³rz.', NULL);
INSERT INTO `internal_resources` VALUES ('CL_NOTITLE', 'PL', 'Nie zostaÂ³ jeszcze zdefiniowany tytuÂ³', NULL);
INSERT INTO `internal_resources` VALUES ('TITLE', 'PL', 'TytuÂ³', NULL);
INSERT INTO `internal_resources` VALUES ('CLI_EDIT', 'PL', 'Edycja czÂ³onka klastra', NULL);
INSERT INTO `internal_resources` VALUES ('CLI_DELETE', 'PL', 'UsuÃ± czÂ³onka klastra', NULL);
INSERT INTO `internal_resources` VALUES ('CLI_DELETEMES', 'PL', 'Czy na pewno chcesz usunÂ±Ã¦ to wystÂ±pienie? Zostanie stracone na zawsze!', NULL);
INSERT INTO `internal_resources` VALUES ('CLI_DELETED', 'PL', 'WystÂ±pienie zostaÂ³o usuniÃªte!', NULL);
INSERT INTO `internal_resources` VALUES ('CLI_NOTDELETED', 'PL', 'To wystÂ±pienie nie moÂ¿e zostaÃ¦ usuniÃªte!', NULL);
INSERT INTO `internal_resources` VALUES ('CLI', 'PL', 'WystÂ±pienie klastra:', NULL);
INSERT INTO `internal_resources` VALUES ('SR_SELECTCI', 'PL', 'Tutaj moÂ¿na wyszukiwaÃ¦ dowolne elementy zawartoÂ¶ci. JeÂ¿eli chcemy wybraÃ¦ element zawartoÂ¶ci, naleÂ¿y nacisnÂ±Ã¦ przycisk Aktualizuj! JeÂ¿eli chcemy podÂ³Â±czyÃ¦ siÃª do nowej zawartoÂ¶ci za pomocÂ± tego pola - stwÃ³rz wczeÂ¶niej zawartoÂ¶Ã¦ w PrzeglÂ±darce obiektÃ³w.', NULL);
INSERT INTO `internal_resources` VALUES ('SR_SELECTCLI', 'PL', 'ProszÃª wybraÃ¦ szablon klastra. NastÃªpnie moÂ¿na wybraÃ¦ wystÂ±pienie szablonu w celu dalszego uÂ¿ycia.', NULL);
INSERT INTO `internal_resources` VALUES ('FOLDER', 'PL', 'Folder', NULL);
INSERT INTO `internal_resources` VALUES ('CONTENTTYPE', 'PL', 'Rodzaj zawartoÂ¶ci', NULL);
INSERT INTO `internal_resources` VALUES ('CONTENTITEM', 'PL', 'Element zawartoÂ¶ci', NULL);
INSERT INTO `internal_resources` VALUES ('SEARCH', 'PL', 'PoczÂ±tek wyszukiwania', NULL);
INSERT INTO `internal_resources` VALUES ('SEARCHIN', 'PL', 'Szukaj', NULL);
INSERT INTO `internal_resources` VALUES ('SEARCHRESULTS', 'PL', 'Wyniki wyszukiwania, proszÃª wybraÃ¦', NULL);
INSERT INTO `internal_resources` VALUES ('SELECTEDOBJECT', 'PL', 'Aktualnie wybrany element zawartoÂ¶ci', NULL);
INSERT INTO `internal_resources` VALUES ('SELECTEDINSTANCE', 'PL', 'Wybrane wystÂ±pienie klastra', NULL);
INSERT INTO `internal_resources` VALUES ('M_META', 'PL', 'Szablony Meta', NULL);
INSERT INTO `internal_resources` VALUES ('M_BROWSER', 'PL', 'Przegladarka obiektÃ³w', NULL);
INSERT INTO `internal_resources` VALUES ('M_INSTALLPLUGIN', 'PL', 'Dodatki', NULL);
INSERT INTO `internal_resources` VALUES ('M_ES', 'PL', 'PrzeglÂ±darka serwisu', NULL);
INSERT INTO `internal_resources` VALUES ('M_SPM', 'PL', 'Wzorzec stron serwisu', NULL);
INSERT INTO `internal_resources` VALUES ('M_PRTMAN', 'PL', 'ZarzÂ±dzanie portalem', NULL);
INSERT INTO `internal_resources` VALUES ('M_MYPRT', 'PL', 'Moje portale', NULL);
INSERT INTO `internal_resources` VALUES ('M_MYPROFILE', 'PL', 'MÃ³j profil', NULL);
INSERT INTO `internal_resources` VALUES ('M_LOGOUT', 'PL', 'Wyloguj', NULL);
INSERT INTO `internal_resources` VALUES ('M_CLB', 'PL', 'PrzeglÂ±darka klastra', NULL);
INSERT INTO `internal_resources` VALUES ('M_CLTB', 'PL', 'PrzeglÂ±darka szablonÃ³w klastra', NULL);
INSERT INTO `internal_resources` VALUES ('M_UMAN', 'PL', 'ZarzÂ±dzanie uÂ¿ytkownikami', NULL);
INSERT INTO `internal_resources` VALUES ('M_VAR', 'PL', 'Odmiany', NULL);
INSERT INTO `internal_resources` VALUES ('M_PURGE', 'PL', 'UsuniÃªcie bazy danych', NULL);
INSERT INTO `internal_resources` VALUES ('M_PGN', 'PL', 'Kontrola dodatkÃ³w', NULL);
...
INSERT INTO `internal_resources` VALUES ('CLT_BROWSE', 'PL', 'PrzeglÂ±d. szabl.klas.', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_NAME', 'PL', 'Nazwa szabl.klas.', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_PROPERTIES', 'PL', 'WÂ³aÂ¶ciwoÂ¶ci szabl.klas.', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_DELETE', 'PL', 'UsuniÃªcie szabl.klas.', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_DELMES', 'PL', 'Zamierzasz usunÂ±Ã¦ szablon klastra. Spowoduje to usuniÃªciÃª wszystkich(!) zawartoÂ¶ci stworzonych przy uÂ¿yciu szablonu klastra. Czy na pewno chcesz kontynuowaÃ¦?', NULL);
INSERT INTO `internal_resources` VALUES ('CLTI_DELETE', 'PL', 'Czy na pewno chesz usunÂ±Ã¦ ten element? Wszystkie wystÂ±pienia tego elementu takÂ¿e zostanÂ± usuniÃªte!', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_SCHEME', 'PL', 'Edycja schematu szablonu klastra', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_MINCARD', 'PL', 'WystÂ±pienia', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_MAXCARD', 'PL', '-', NULL);
INSERT INTO `internal_resources` VALUES ('LINKED', 'PL', 'PoÂ³Â±czone z', NULL);
INSERT INTO `internal_resources` VALUES ('PG_INSTALLDESC', 'PL', 'Prosze siÃª upewniÃ¦, Â¿e zostaÂ³y skopiowane wszystkie niezbÃªdne pliki do katalogu przed kontynuacjÂ±. WprowadÂ¼ poprawnÂ± Â¶cieÂ¿kÃª do dodatku w poniÂ¿szym polu. System zainstaluje dodatek automatycznie.', NULL);
INSERT INTO `internal_resources` VALUES ('PG_CHOOSE', 'PL', 'Dodatek: &nbsp; /plugin/', NULL);
INSERT INTO `internal_resources` VALUES ('PG_FILEWRONG', 'PL', 'Nazwa pliku, ktÃ³ra zostaÂ³a wprowadzona nie mogÂ³a zostaÃ¦ znaleziona na serwerze!', NULL);
INSERT INTO `internal_resources` VALUES ('CLASS_WRONG', 'PL', 'Plik, ktÃ³ry zostaÂ³ wprowadzony nie zawiera poprawnej sygnatury!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_INSTALLED', 'PL', 'Dodatek zostaÂ³ poprawnie zainstalowany!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_UPGRADED', 'PL', 'Dodatek zostaÂ³ porawnie zaktualizowany!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_ERROR', 'PL', 'WystÂ±piÂ³ bÂ³Â±d podczas instalacji dodatku!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_ALREADYINSTAL', 'PL', 'Dodatek juÂ¿ zostaÂ³ zainstalowany!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_NEWERINSTALLE', 'PL', 'JuÂ¿ jest zainstalowana nowsza wersja dodatku!', NULL);
...
INSERT INTO `internal_resources` VALUES ('PG_UNINSTALLMES', 'PL', 'Zamierzasz odinstalowaÃ¦ moduÂ³. Odinstalowanie moduÂ³u nie tylko usuwa rodzaj zawartoÂ¶ci ale takÂ¿e usuwa kaÂ¿dy obiekt tego typu przechowywany w bazie danych. Odinstalowanie definitywnie(!) usunie wszystkie dane dla tego moduÂ³u!', NULL);
INSERT INTO `internal_resources` VALUES ('PG_UNINSTALLDELE', 'PL', 'Odinstaluj moduÂ³,<br> UsuniÃªcie wszystkie zaleÂ¿ne zawartoÂ¶ci.', NULL);
...
INSERT INTO `internal_resources` VALUES ('O_PROPERTIES', 'PL', 'WÂ³aÂ¶ciwoÂ¶ci obiektu', NULL);
INSERT INTO `internal_resources` VALUES ('O_DELMES', 'PL', 'Zamierzasz usunÂ±Ã¦ obiekt. <b>NaleÂ¿y zauwaÂ¿yÃ¦, Â¿e wszystkie odmiany i meta dane zostanÂ± utracone!</b>', NULL);
INSERT INTO `internal_resources` VALUES ('O_DEL', 'PL', 'UsuÃ± obiekt', NULL);
INSERT INTO `internal_resources` VALUES ('O_EDIT', 'PL', 'Edytuj obiekt', NULL);
INSERT INTO `internal_resources` VALUES ('O_PREVIEW', 'PL', 'PodglÂ±d', NULL);
...
INSERT INTO `internal_resources` VALUES ('O_BROWSE', 'PL', 'PrzeglÂ±d obiektÃ³w', NULL);
...
INSERT INTO `internal_resources` VALUES ('R_EDITFOLDER', 'PL', 'Edycja wÂ³aÂ¶ciwoÂ¶ci folderu', NULL);
INSERT INTO `internal_resources` VALUES ('R_FOLDERNAME', 'PL', 'Nazwa folderu', NULL);
INSERT INTO `internal_resources` VALUES ('R_DELETEFOLDER', 'PL', 'UsuÃ± folder', NULL);
INSERT INTO `internal_resources` VALUES ('R_DELFOLDERMES', 'PL', 'Zamierzasz usunÂ±Ã¦ folder. ProszÃª zaznaczyÃ¦ akcjÃª.', NULL);
INSERT INTO `internal_resources` VALUES ('R_FOLDERNOTEMPTY', 'PL', 'Folder nie jest pusty. Nie moÂ¿na go usunÂ±Ã¦. ProszÃª sprawdziÃ¦ wszystkie obiekty i klastry!', NULL);
INSERT INTO `internal_resources` VALUES ('R_DELFOLDER', 'PL', 'UsuniÃªcie folderu i wszystkich podrzÃªdnych obiektÃ³w', NULL);
INSERT INTO `internal_resources` VALUES ('R_MOVEOBJECTS', 'PL', 'PrzesuniÃªcie wszystkich obiektÃ³w do nadrzÃªdnego wÃªzÂ³a', NULL);
INSERT INTO `internal_resources` VALUES ('R_PARENT', 'PL', 'NadrzÃªdny folder', NULL);
INSERT INTO `internal_resources` VALUES ('METATEMPLATES', 'PL', 'Szablon meta danych', NULL);
INSERT INTO `internal_resources` VALUES ('MT_PROPERTIES', 'PL', 'Edycja wÂ³aÂ¶ciwoÂ¶ci meta szablonu', NULL);
INSERT INTO `internal_resources` VALUES ('MT_SCHEME', 'PL', 'Edycja schematu meta szablonu', NULL);
INSERT INTO `internal_resources` VALUES ('MT_DELETE', 'PL', 'Czy rzeczywiÂ¶cie zamierzasz usunÂ±Ã¦ tÂ± czÃªÂ¶Ã¦ meta szablonu? Wszystkie informacje wprowadzone w dowolne meta pola w systemie CMS poÂ³Â±czone do tej czÃªÂ¶ci zostanÂ± usuniÃªte. Dane zostanÂ± usuniÃªte caÂ³kowicie!', NULL);
...
INSERT INTO `internal_resources` VALUES ('MT_MODULE', 'PL', 'Meta dane specyficzne dla rodzaju zawrtoÂ¶ci', NULL);
INSERT INTO `internal_resources` VALUES ('VARIATIONS', 'PL', 'DostÃªpne odmiany', NULL);
INSERT INTO `internal_resources` VALUES ('V_NAME', 'PL', 'Nazwa', NULL);
INSERT INTO `internal_resources` VALUES ('V_SHORT', 'PL', 'KrÃ³tki znacznik', NULL);
INSERT INTO `internal_resources` VALUES ('V_EDIT', 'PL', 'Edycja odmian', NULL);
INSERT INTO `internal_resources` VALUES ('LOGIN_FAILED', 'PL', 'Wprowadzone dane uÂ¿ytkownika nie mogÂ± zostaÃ¦ potwierdzone! ProszÃª sprÃ³bowaÃ¦ ponownie.', NULL);
INSERT INTO `internal_resources` VALUES ('USER_HEAD', 'PL', 'Profil uÂ¿ytkownika', NULL);
INSERT INTO `internal_resources` VALUES ('USER_LINK', 'PL', 'Profile uÂ¿ytkownikÃ³w', NULL);
INSERT INTO `internal_resources` VALUES ('USER_NAME', 'PL', 'Nazwa uÂ¿ytkownika', NULL);
INSERT INTO `internal_resources` VALUES ('FULL_NAME', 'PL', 'PeÂ³na nazwa', NULL);
INSERT INTO `internal_resources` VALUES ('PASSWORD', 'PL', 'HasÂ³o', NULL);
INSERT INTO `internal_resources` VALUES ('USER_EMAIL', 'PL', 'eMail', NULL);
INSERT INTO `internal_resources` VALUES ('USER_ACTIVE', 'PL', 'Konto wÂ³Â±czone', NULL);
INSERT INTO `internal_resources` VALUES ('USER_FILTERMENU', 'PL', 'Administracja uÂ¿ytkonikami', NULL);
INSERT INTO `internal_resources` VALUES ('USER_SETPERM', 'PL', 'Ustal prawa dostÃªpu uÂ¿ytkownika poniÂ¿ej. W celu usuniÃªcia uÂ¿ytkownika z grupy, po prostu odwoÂ³aj wszytkie grupy przynaleÂ¿ne do niego.', NULL);
INSERT INTO `internal_resources` VALUES ('USER_PERMGRID', 'PL', 'Siatka uprawnieÃ±', NULL);
...
INSERT INTO `internal_resources` VALUES ('GROUP_FILTERMENU', 'PL', 'Adminstracja grupÂ±', NULL);
INSERT INTO `internal_resources` VALUES ('ROLE_LINK', 'PL', 'Profile rÃ³l', NULL);
...
INSERT INTO `internal_resources` VALUES ('USER_PERMISSIONS', 'PL', 'Uprawnienia uÂ¿ytkownika', NULL);
INSERT INTO `internal_resources` VALUES ('UP_INTRO', 'PL', 'ProszÃª zaznaczyÃ¦ grupÃª i role w grupie, ktÃ³re checesz dodaÃ¦ dla uÂ¿ytkownika.', NULL);
INSERT INTO `internal_resources` VALUES ('USER_TO_GROUP', 'PL', 'Dodanie uÂ¿ytkownika do grupy', NULL);
INSERT INTO `internal_resources` VALUES ('ERROR_SEL_GROUP', 'PL', 'NaleÂ¿y wybraÃ¦ grupÃª!', NULL);
INSERT INTO `internal_resources` VALUES ('ERROR_SEL_ROLE', 'PL', 'NaleÂ¿y wybraÃ¦ co najmniej jednÂ± rolÃª!', NULL);
INSERT INTO `internal_resources` VALUES ('USER_PROFILE', 'PL', 'MÃ³j profil', NULL);
INSERT INTO `internal_resources` VALUES ('COMMIT', 'PL', 'PowieÂ¿', NULL);
...
INSERT INTO `internal_resources` VALUES ('DOSOMETHING', 'PL', 'ProszÃª wybraÃ¦ dziaÂ³anie, ktÃ³re chesz wykonaÃ¦. MoÂ¿esz wybraÃ¦ nowe elementy, edytowaÃ¦ elementy, usunÂ±Ã¦ elementy lub zmieniÃ¦ kolejnoÂ¶Ã¦ elementÃ³w.', NULL);
INSERT INTO `internal_resources` VALUES ('EDIT', 'PL', 'Edycja', NULL);
INSERT INTO `internal_resources` VALUES ('UP', 'PL', 'W gÃ³rÃª', NULL);
INSERT INTO `internal_resources` VALUES ('DOWN', 'PL', 'W dÃ³Â³', NULL);
INSERT INTO `internal_resources` VALUES ('CONTAINERNAME', 'PL', 'Szablon', NULL);
INSERT INTO `internal_resources` VALUES ('SELECTOBJECT', 'PL', 'ProszÃª wybraÃ¦ klasÃª oraz okreÂ¶liÃ¦ pozycjÃª i nazwÃª dla tworzonego obiektu.<br> Dla pozycji uÂ¿yj 0 dla okreÂ¶lenia poczÂ±tkowej pozycji, 999 dla okreÂ¶lenie na koÃ±cu poza innymi pozycjami twojego wybory.', NULL);
INSERT INTO `internal_resources` VALUES ('POSITION', 'PL', 'Pozycja', NULL);
INSERT INTO `internal_resources` VALUES ('DELETE', 'PL', 'UsuÃ±', NULL);
INSERT INTO `internal_resources` VALUES ('TYPE', 'PL', 'Typ', NULL);
INSERT INTO `internal_resources` VALUES ('KEYWORDS', 'PL', 'SÂ³owa kluczowe', NULL);
INSERT INTO `internal_resources` VALUES ('METATEMPLATE', 'PL', 'Dodatkowe meta klucze szablonu', NULL);
INSERT INTO `internal_resources` VALUES ('SELECT_VARIATION', 'PL', 'Wybierz odmianÃª', NULL);
INSERT INTO `internal_resources` VALUES ('ACTIVE_VARIATION', 'PL', 'Aktywne odmiany:', NULL);
INSERT INTO `internal_resources` VALUES ('NO_VARIATIONS', 'PL', 'Nie ma obecnie zdefiniowanych odmian tego obiektu!<br>ProszÃª skonsultowaÃ¦ to z programistÂ± w celu sprawdzenia konfiguracji wybranego elementu!', NULL);
INSERT INTO `internal_resources` VALUES ('ED_CONTENT', 'PL', 'Edycja zawartoÂ¶ci', NULL);
INSERT INTO `internal_resources` VALUES ('ED_META', 'PL', 'Edycja meta danych', NULL);
INSERT INTO `internal_resources` VALUES ('ED_DISPATCHER', 'PL', 'UÂ¿yj tego przycisku w celu przeÂ³Â±czenia siÃª pomiÃªdzy edytowaniem meta danych a edycjÂ± zawartoÂ¶ci.', NULL);
INSERT INTO `internal_resources` VALUES ('PREVIEW', 'PL', 'PodglÂ±d', NULL);
INSERT INTO `internal_resources` VALUES ('CHOOSEFILE', 'PL', 'Wybierz plik', NULL);
INSERT INTO `internal_resources` VALUES ('CONFIGURED', 'PL', 'Gotowy do uÂ¿ycia.', NULL);
...
INSERT INTO `internal_resources` VALUES ('SELECT_CI', 'PL', 'Wybierz element zawartoÂ¶ci', NULL);
...
INSERT INTO `internal_resources` VALUES ('UNIQUE', 'PL', 'To pole musi byÃ¦ unikalne!', NULL);
INSERT INTO `internal_resources` VALUES ('MANDATORY', 'PL', 'To pole nie moÂ¿e byÃ¦ puste!', NULL);
INSERT INTO `internal_resources` VALUES ('NOTNUMBER', 'PL', 'NaleÂ¿y wprowadziÃ¦ numer do tego pola!', NULL);
INSERT INTO `internal_resources` VALUES ('WRONGDATE', 'PL', 'Data, ktÃ³ra zostaÂ³a wprowadzone nie istnieje!', NULL);
INSERT INTO `internal_resources` VALUES ('DATEFORMAT', 'PL', 'Format daty jest nieprawidÂ³owy!', NULL);
INSERT INTO `internal_resources` VALUES ('PWDNOTMATCH', 'PL', 'HasÂ³a, ktÃ³re zostaÂ³y wprowadzone nie zgadzajÂ± siÃª!', NULL);
INSERT INTO `internal_resources` VALUES ('PWDTOOSHORT', 'PL', 'HasÂ³o musi zawieraÃ¦ co najmniej 6 znakÃ³w!', NULL);
INSERT INTO `internal_resources` VALUES ('PROCERROR', 'PL', 'WystÂ±piÂ³ bÂ³Â±d podczas przetwarzania danych formularza. ProszÃª sprawdziÃ¦ pola zaznaczone na niebiesko i przeczytaÃ¦ dodatkowe informacje.', NULL);
INSERT INTO `internal_resources` VALUES ('SAVEERROR', 'PL', 'WystÂ±piÂ³ bÂ³Â±d podczas zapisywania danych do bazy danych. ProszÃª sprawdziÃ¦ czy baza danych jest podÂ³Â±czona lub zadzwoniÃ¦ do administratora.', NULL);
INSERT INTO `internal_resources` VALUES ('SAVESUCCESS', 'PL', 'Dane zostaÂ³y poprawnie zapisane do bazy danych.', NULL);
INSERT INTO `internal_resources` VALUES ('DELETESUCCESS', 'PL', 'Dane wypisane poniÂ¿ej zostaÂ³y poprawnie usuniÃªte z bazy danych. ZostaÂ³y caÂ³kowicie usuniÃªte!', NULL);
INSERT INTO `internal_resources` VALUES ('SELECTONE', 'PL', 'Tutaj naleÂ¿y dokonaÃ¦ wyboru!', NULL);
INSERT INTO `internal_resources` VALUES ('CREATENEW', 'PL', 'Nowy czÂ³onek tego szablonu zostaÂ³ utworzony zobacz dane wypisane poniÂ¿ej.', NULL);
INSERT INTO `internal_resources` VALUES ('PROMPTDELETE', 'PL', 'Czy na pewno chcesz usunÂ±Ã¦ ten zestaw danych? Ta akcja nie moÂ¿e zostaÃ¦ cofniÃªta!', NULL);
INSERT INTO `internal_resources` VALUES ('RESET', 'PL', 'WyczyÂ¶Ã¦ formularz', NULL);
INSERT INTO `internal_resources` VALUES ('BACK', 'PL', 'Wstecz', NULL);
INSERT INTO `internal_resources` VALUES ('CREATE', 'PL', 'UtwÃ³rz element', NULL);
INSERT INTO `internal_resources` VALUES ('ERROR', 'PL', 'WystÂ±piÂ³ bÂ³Â±d podczas operacji wykonywania wyboru!', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE', 'PL', 'UsuniÃªcie bazy danych', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_MES', 'PL', 'ProszÃª wybraÃ¦ czÃªsci bazy danych, ktÃ³re zamierzasz usunÂ±Ã¦.', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_VAR', 'PL', 'UsuniÃªcie odmian', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_CONTENT', 'PL', 'UsuniÃªcie zawartoÂ¶ci', NULL);
INSERT INTO `internal_resources` VALUES ('VAR_SUCCEEDED', 'PL', ' powiodÂ³o siÃª!', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_FOLDER', 'PL', 'UsuniÃªcie folderu', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_CLUSTER', 'PL', 'UsuniÃªcie klastra', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_META', 'PL', 'UsuniÃªcie Meta', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_CLT', 'PL', 'UsuniÃªcie szablonÃ³w klastra', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_PAGES', 'PL', 'UsuniÃªcie stron serwisu i wzorcÃ³w', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_EXPIRED', 'PL', 'UsuniÃªcie stron przedawnionych', NULL);
INSERT INTO `internal_resources` VALUES ('HELP_COMPGRP', 'DE', 'Verbund-Gruppen sind Gruppen von Clustern. Cluster-Vorlagen kÃ¶nnen ein eigenes Layout besitzen. Dies ermÃ¶glicht Ihnen, Ihre Homepage aus BlÃ¶cken zusammenzusezten, z.B. News, Umfrage, Bildergalerie - alles auf einer Seite und bei Bedarf.', '');
INSERT INTO `internal_resources` VALUES ('NO_CLUSTERTEMPLATES', 'DE', 'Keine Klassen.', '');
INSERT INTO `internal_resources` VALUES ('HELP_CLT', 'DE', 'Cluster-Vorlagen erlauben Ihnen, die Struktur fÃ¼r Ihre Site festzulegen und den Typ von Inhalten zu bestimmen. AnschlieÃŸend werden Cluster-Vorlagen mit Seiten-Vorlagen verschmolzen, welche die Inhalte in der Web-Seite darstellen.', '');
INSERT INTO `internal_resources` VALUES ('SPM_SELECTTHUMB', 'DE', 'Vorschaubild auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('TT_REFRESH', 'DE', 'Instanzen erneuern aktualisiert zwischengespeicherte Seiten mit den geÃ¤nderten Werten.', '');
INSERT INTO `internal_resources` VALUES ('HELP_PAGETEMP', 'DE', 'In Tabellenkalkulations- und Datenbank-Anwendungen ist eine Vorlage ein leeres Formular, das zeigt, welche Felder an welcher Position und in welcher LÃ¤nge existieren. In N/X sind Vorlage die Grundlage fÃ¼r jede Ausgabe. Eine Vorlage ist ein Formular, in dem alle Zellen definiert wurden, jedoch noch keine Inhalte hinterlegt wurden.', '');
...
INSERT INTO `internal_resources` VALUES ('SEL_ARTICLE', 'DE', 'Artikel auswÃ¤hlen', '');
...
INSERT INTO `internal_resources` VALUES ('CHANNEL_SELECT', 'DE', 'Kanal auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('HELP_OBJBROWSE', 'DE', 'Die Inhalts-Bibliothek enthÃ¤lt alle Inhalte der Site.', '');
...
INSERT INTO `internal_resources` VALUES ('M_CHANNELS', 'DE', 'KanÃ¤le', '');
...
INSERT INTO `internal_resources` VALUES ('VISITS_OVERVIEW', 'DE', 'Besucher-Ãœbersicht', '');
...
INSERT INTO `internal_resources` VALUES ('TRANSLATION', 'DE', 'N/X Ãœbersetzungs-System', '');
INSERT INTO `internal_resources` VALUES ('TOTAL', 'DE', 'Gesamt', '');
INSERT INTO `internal_resources` VALUES ('TOP_SKW', 'DE', 'Top Such-SchlÃ¼sselworte', '');
...
INSERT INTO `internal_resources` VALUES ('TMPL_NAME', 'DE', 'Vorlage auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('TODAY', 'DE', 'Heute', '');
INSERT INTO `internal_resources` VALUES ('TOP', 'DE', 'Daten einschrÃ¤nken', '');
INSERT INTO `internal_resources` VALUES ('TIPP_TEMPLATE_1', 'DE', 'Vorlagen sind die Basis jeder Ausgabe von N/X. Sie mÃ¼ssen zunÃ¤chst eine Klasse  erstellen, die die Struktur und die Art der Inhalte definiert. AnschlieÃŸend kÃ¶nnen Sie die Seiten-Vorlage erstellen, indem Sie eine Klasse mit einer PHP-Datei verbinden.', '');
...
INSERT INTO `internal_resources` VALUES ('STNAME', 'DE', 'WÃ¤hlen Sie einen Namen, um die Seite in der Sitemap zu identifizieren', '');
...
INSERT INTO `internal_resources` VALUES ('SP_RLTREE', 'DE', 'Baum erneut verÃ¶ffentlichen', '');
INSERT INTO `internal_resources` VALUES ('SP_MENUDIRECTTITLE', 'DE', 'Optionale URL auf dem Server fÃ¼r direkten Zugriff angeben', '');
INSERT INTO `internal_resources` VALUES ('SP_MENUDIRECT', 'DE', 'Seiten-URL auf Live-Server', '');
INSERT INTO `internal_resources` VALUES ('SP_MENUDIRECTTIT', 'DE', 'Optionale URL auf dem Server fÃ¼r direkten Zugriff angeben', '');
INSERT INTO `internal_resources` VALUES ('SPM_THUMBNAIL', 'DE', 'Vorschaubild', '');
INSERT INTO `internal_resources` VALUES ('SPM_RLAUNCH', 'DE', 'Seiten erneut verÃ¶ffentlichen', '');
INSERT INTO `internal_resources` VALUES ('SMA_EXT_EDIT', 'DE', 'Bearbeitungs-Fenster Ã¶ffnen. Alle inline bearbeiteten Texte vorher speichern !', '');
INSERT INTO `internal_resources` VALUES ('SHORTEST_PATHS', 'DE', 'KÃ¼rzeste Pfade', '');
INSERT INTO `internal_resources` VALUES ('SET', 'DE', 'Setzen', '');
INSERT INTO `internal_resources` VALUES ('SEL_MEM', 'DE', 'GewÃ¤hlte Mitglieder', '');
INSERT INTO `internal_resources` VALUES ('SELMULTIPLE', 'DE', 'Halten Sie die STRG-Taste gedrÃ¼ckt, um mehrere Elemente auszuwÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('SELECT', 'DE', 'AuswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('SEARCH_CLEAR', 'DE', 'Filter lÃ¶schen', '');
INSERT INTO `internal_resources` VALUES ('SAVE_BACK', 'DE', 'Speichern und ZurÃ¼ck', '');
...
INSERT INTO `internal_resources` VALUES ('PI_OVERVIEW', 'DE', 'Page Impressions Ãœbersicht', '');
...
INSERT INTO `internal_resources` VALUES ('OVERVIEW', 'DE', 'Ãœbersicht', '');
...
INSERT INTO `internal_resources` VALUES ('NUMBER_OF_INSTANCES', 'DE', 'Bitte geben Sie an, wie viele Slots Sie erzeugen mÃ¶chten.', '');
INSERT INTO `internal_resources` VALUES ('NO_CONTENTS', 'DE', 'In diesem Ordner existieren keine Inhalte', '');
INSERT INTO `internal_resources` VALUES ('NO_CLUSTER_SELECTED', 'DE', 'Kein Objekt ausgewÃ¤hlt', '');
...
INSERT INTO `internal_resources` VALUES ('M_TRANSLATION', 'DE', 'Ãœbersetzung', '');
...
INSERT INTO `internal_resources` VALUES ('CL_CREATEINSMES', 'DE', 'Es stehen noch freie Platzhalter zur VerfÃ¼gung. Wenn Sie eine neue Instanz erzeugen mÃ¶chten, geben Sie den Titel in das untenstehende Textfeld ein und klicken Sie auf die Erzeugen.', '');
...
INSERT INTO `internal_resources` VALUES ('CL_DELMES', 'DE', 'MÃ¶chen Sie dieses Objekt wirklich lÃ¶schen? SÃ¤mtlicher Inhalte geht hiermit verloren!', '');
INSERT INTO `internal_resources` VALUES ('CL_DEL', 'DE', 'Objekt lÃ¶schen', '');
...
INSERT INTO `internal_resources` VALUES ('SPM_VARIATIONS', 'DE', 'VerfÃ¼gbare Sprachen', '');
...
INSERT INTO `internal_resources` VALUES ('ACTIVE', 'DE', 'Seite im MenÃ¼ zeigen', '');
INSERT INTO `internal_resources` VALUES ('NOSPTITLE', 'DE', 'Sie mÃ¼ssen einen MenÃ¼namen definieren, bevor Sie die Seite launchen kÃ¶nnen!', '');
INSERT INTO `internal_resources` VALUES ('SP_EXPIRE', 'DE', 'Seite zurÃ¼ckziehen', '');
INSERT INTO `internal_resources` VALUES ('SP_LAUNCH', 'DE', 'VerÃ¶ffentlichen', '');
INSERT INTO `internal_resources` VALUES ('SP_PREVIEW', 'DE', 'Vorschau', '');
INSERT INTO `internal_resources` VALUES ('SP_LAUNCHDATES', 'DE', 'Zeitgesteuertes VerÃ¶ffentlichen', '');
INSERT INTO `internal_resources` VALUES ('SP_EXPIREDATE', 'DE', 'ZurÃ¼ckziehen am', '');
INSERT INTO `internal_resources` VALUES ('SP_LAUNCHDATE', 'DE', 'VerÃ¶ffentlichen ab', '');
INSERT INTO `internal_resources` VALUES ('SP_MENUHELP', 'DE', 'Hilfetext fÃ¼r das MenÃ¼', '');
INSERT INTO `internal_resources` VALUES ('SP_MENUNAME', 'DE', 'Name im MenÃ¼', '');
INSERT INTO `internal_resources` VALUES ('SP_MENUPROPS', 'DE', 'MenÃ¼-Name', '');
...
INSERT INTO `internal_resources` VALUES ('SP_CONFDESC', 'DE', 'Sie kÃ¶nnen diese Seite mit einem Objekt verlinken oder ein neues Objekt fÃ¼r die Seite erzeugen.', '');
INSERT INTO `internal_resources` VALUES ('SP_CONFIGURE', 'DE', 'Seite konfigurieren', '');
INSERT INTO `internal_resources` VALUES ('SP_PDELETE', 'DE', 'Seite lÃ¶schen', '');
INSERT INTO `internal_resources` VALUES ('SP_PDELMES', 'DE', 'Sie sind im Begriff eine Seite zu lÃ¶schen. Bitte beachten Sie, dass auch die verÃ¶ffentliichte Seite gelÃ¶scht wird!', '');
INSERT INTO `internal_resources` VALUES ('SP_DELETE', 'DE', 'Seite lÃ¶schen', '');
INSERT INTO `internal_resources` VALUES ('SP_DELMES', 'DE', 'Sie sind im Begriff eine Seite zu lÃ¶schen. Bitte beachten Sie, dass auch die verÃ¶ffentliichte Seite gelÃ¶scht wird!', '');
...
INSERT INTO `internal_resources` VALUES ('MENU', 'DE', 'MenÃ¼', '');
...
INSERT INTO `internal_resources` VALUES ('LONGEST_PATHS', 'DE', 'LÃ¤ngste Pfade', '');
...
INSERT INTO `internal_resources` VALUES ('LAUNCH', 'DE', 'VerÃ¶ffentlichen', '');
...
INSERT INTO `internal_resources` VALUES ('I_AFTER', 'DE', 'EinfÃ¼gen nach', '');
INSERT INTO `internal_resources` VALUES ('IS_COMPOUND', 'DE', 'Layout-Klasse', '');
INSERT INTO `internal_resources` VALUES ('IS_FILTERED', 'DE', 'Hinweis: MÃ¶glicherweise werden nicht alle DatensÃ¤tze angezeigt, weil ein Filter verwendet wird.', '');
...
INSERT INTO `internal_resources` VALUES ('FOLDER_DELMES', 'DE', 'MÃ¶chen Sie diesen Ordner wirklich lÃ¶schen ?', '');
...
INSERT INTO `internal_resources` VALUES ('DEL_FOLDER', 'DE', 'Ordner lÃ¶schen', '');
...
INSERT INTO `internal_resources` VALUES ('CR_CONTENT', 'DE', 'Inhalt fÃ¼r diese Seite erzeugen?', '');
INSERT INTO `internal_resources` VALUES ('COUNT', 'DE', 'Anzahl', '');
INSERT INTO `internal_resources` VALUES ('CPG_MEMBERS_SELECT', 'DE', 'Mitglieder dieser Layout-Klassen-Gruppe auswÃ¤hlen', '');
...
INSERT INTO `internal_resources` VALUES ('COMB_ALL', 'DE', 'Alles auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('COMB_NONE', 'DE', 'Auswahl lÃ¶schen', '');
...
INSERT INTO `internal_resources` VALUES ('CALENDAR_SELECT', 'DE', 'Kalender auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('CALENDARS_EDIT', 'DE', 'Kalender bearbeiten', '');
INSERT INTO `internal_resources` VALUES ('CALENDARS_TIPP', 'DE', 'Sie kÃ¶nnen hier verschiedene Kalender erstellen. Jeder Kalender hat seine eigenen Termine und Ereignisse.', '');
...
INSERT INTO `internal_resources` VALUES ('BACK_INFO', 'DE', 'Die untenstehende Liste zeigt die auf Ihrem Server verfÃ¼gbaren Sicherungen an. Sie kÃ¶nnen hier einzelne Sicherungen lÃ¶schen. Um eine Sicherung zurÃ¼ck zu spielen, mÃ¼ssen Sie sich manuell auf Ihrem Server einloggen und die Dateien wiederherstellen.', '');
...
INSERT INTO `internal_resources` VALUES ('AVAIL_VARIATIONS', 'DE', 'VerfÃ¼gbare Sprachen', '');
...
INSERT INTO `internal_resources` VALUES ('ACL_TITLE', 'DE', 'Setze Berechtigungen fÃ¼r', '');
INSERT INTO `internal_resources` VALUES ('AFTER', 'DE', 'Nach:', '');
INSERT INTO `internal_resources` VALUES ('ALC_OWNER', 'DE', 'EigentÃ¼mer bestimmen', '');
INSERT INTO `internal_resources` VALUES ('AVAIL_ITEMS', 'DE', 'VerfÃ¼gbare Elemente', '');
INSERT INTO `internal_resources` VALUES ('ACL_INHERIT_NOTE', 'DE', 'Hinweis: Wenn dieses Feld markiert ist, ist keine andere Konfiguration verfÃ¼gbar!', '');
INSERT INTO `internal_resources` VALUES ('ACL_OWNER', 'DE', 'EigentÃ¼mer', '');
INSERT INTO `internal_resources` VALUES ('ACL_GROUPS', 'DE', 'Gruppe auswÃ¤hlen und hinzufÃ¼gen', '');
...
INSERT INTO `internal_resources` VALUES ('PURGE_EXPIRED', 'DE', 'ZurÃ¼ckgezogene Seiten bereinigen', '');
INSERT INTO `internal_resources` VALUES ('ACL_ACCESS', 'DE', 'Rechte in Gruppen berabeiten', '');
INSERT INTO `internal_resources` VALUES ('ACL_GROUPEDIT', 'DE', 'Gruppe fÃ¼r Rollen-Bearbeitung auswÃ¤hlen', '');
...
INSERT INTO `internal_resources` VALUES ('ERROR', 'DE', 'WÃ¤hrend der AusfÃ¼hrung der gewÃ¤hlten Operation ist ein Fehler aufgetreten!', '');
INSERT INTO `internal_resources` VALUES ('PURGE', 'DE', 'Datenbank bereinigen', '');
INSERT INTO `internal_resources` VALUES ('PURGE_MES', 'DE', 'Bitte wÃ¤hlen Sie die Teile der Datenbank, die Sie bereinigen mÃ¶chten.', '');
INSERT INTO `internal_resources` VALUES ('RESET', 'DE', 'Reset', '');
INSERT INTO `internal_resources` VALUES ('BACK', 'DE', 'ZurÃ¼ck', '');
INSERT INTO `internal_resources` VALUES ('CREATE', 'DE', 'Element erstellen', '');
INSERT INTO `internal_resources` VALUES ('SEARCH_LIVE_ACRTICLES', 'DE', 'VerÃ¶ffentlichte Artikel', '');
INSERT INTO `internal_resources` VALUES ('SEASRCH_MISSING_VARIATIONS', 'DE', 'Fehlende Ãœbersetzungen', '');
INSERT INTO `internal_resources` VALUES ('SEL_CH', 'DE', 'Kanal auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('SEL_CLUSTER', 'DE', 'Objekt auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('SEL_EVENT', 'DE', 'Ereignis oder Termin speichern', '');
INSERT INTO `internal_resources` VALUES ('SEL_PTML', 'DE', 'Seiten-Vorlage auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('SEL_VAR', 'DE', 'Sprache auswÃ¤hlen', '');
...
INSERT INTO `internal_resources` VALUES ('SYNC_CLUSTERS_DESCR', 'DE', 'Wenn Sie eine Klasse Ã¤ndern, werden die Objekte nicht automatisch synchronisiert. Sie werden synchronisiert, wenn Sie das nÃ¤chste mal mit ihnen arbeiten. Hier kÃ¶nnen Sie alle manuell synchronisieren.', '');
...
INSERT INTO `internal_resources` VALUES ('TRANS_TEMPL', 'DE', 'Ãœbersetzen von', '');
INSERT INTO `internal_resources` VALUES ('TRANS_THIS', 'DE', 'Ãœbersetzen Sie:', '');
INSERT INTO `internal_resources` VALUES ('UPL_TEXT', 'DE', 'Text-Datei hochladen', '');
INSERT INTO `internal_resources` VALUES ('WZE_ARTICLEIMPORT_SRCTYPE', 'DE', 'Bitte geben Sie den Quellen-Typ an, aus dem Sie die Artikel importieren mÃ¶chten.', '');
INSERT INTO `internal_resources` VALUES ('WZE_ARTICLEIMPORT_TARGET', 'DE', 'Bitte wÃ¤hlen Sie rechts den Ziel-Kanal aus. Alle importierten Artikel werden in diesem Kanal gespeichert.', '');
INSERT INTO `internal_resources` VALUES ('WZT_ARTICLEIMPORT_SRCTYPE', 'DE', 'Quellen-Typ auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('WZT_ARTICLEIMPORT_TARGET', 'DE', 'Ziel-Kanal auswÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('WZT_KEEPCLUSTER', 'DE', 'Bestehende Objekte beibehalten?', '');
INSERT INTO `internal_resources` VALUES ('WZT_KEEPCLUSTER_EXPL', 'DE', 'Sie kÃ¶nnen festlegen, ob Sie die bestehenden Objekte beibehalten mÃ¶chten oder lieber Kopien von jedem Cluster anlegen wollen.<br><br>Beachten Sie: Wenn Sie die bestehenden Objekte beibehalten, teilen Sie sie sich mit der ursprÃ¼nglichen Quelle.', '');
...
INSERT INTO `internal_resources` VALUES ('PG_CHOOSE', 'EN', 'Plugin: Â  /plugin/', '');
...
INSERT INTO `internal_resources` VALUES ('BACK_SP', 'DE', 'ZurÃ¼ck', '');
...
INSERT INTO `internal_resources` VALUES ('CLT_EXCLUSIVE', 'DE', 'Inhalt nur fÃ¼r Entwickler sichtbar', '');
INSERT INTO `internal_resources` VALUES ('CL_SELECT', 'DE', 'Bitte wÃ¤hlen Sie ein Objekt, um es mit der Klasse zu verlinken.', '');
INSERT INTO `internal_resources` VALUES ('CONFIRM_UNSAVED_CHANGES_LINKEDCL', 'DE', 'Achtung: Wenn Sie das verlinkte Objekt Ã¤ndern, gehen alle ungespeicherten Ã„nderungen am aktuellen Objekt verloren. MÃ¶chten sie fortfahren?', '');
INSERT INTO `internal_resources` VALUES ('FONT', 'DE', 'Schriftname', '');
INSERT INTO `internal_resources` VALUES ('FONTSIZE', 'DE', 'SchriftgrÃ¶ÃŸe', '');
INSERT INTO `internal_resources` VALUES ('GR_TEXT', 'DE', 'Graphischer Text', '');
INSERT INTO `internal_resources` VALUES ('HEIGHT', 'DE', 'HÃ¶he', '');
...
INSERT INTO `internal_resources` VALUES ('LOGS_INFO', 'DE', 'Die Liste enthÃ¤lt alle geloggten Ereignisse.', '');
...
INSERT INTO `internal_resources` VALUES ('SPM_LAUCH_SUCCESS', 'DE', 'Die Seiten wurden neu verÃ¶ffentlicht.', '');
...
INSERT INTO `internal_resources` VALUES ('EXPIRE', 'DE', 'ZurÃ¼ckziehen', '');
INSERT INTO `internal_resources` VALUES ('BY_ORDER', 'EN', 'By Position', '');
INSERT INTO `internal_resources` VALUES ('MT_LWS_MESSAGES', 'DE', 'MÃ¶chten Sie wirklich die gesamte Seite verÃ¶ffentlichen?', '');
INSERT INTO `internal_resources` VALUES ('MT_LW_SITE', 'DE', 'Ganze Website verÃ¶ffentlichen', '');
...
INSERT INTO `internal_resources` VALUES ('ACL_GROUPEDIT', 'FR', 'SÃ©lectionner le groupe pour Ã©diter les rÃ´les', NULL);
INSERT INTO `internal_resources` VALUES ('ACL_GROUPS', 'FR', 'SÃ©lectionner le groupe Ã  ajouter', NULL);
INSERT INTO `internal_resources` VALUES ('ACL_GROUPSROLES', 'FR', 'AccÃ¨s Ã©tranger', NULL);
INSERT INTO `internal_resources` VALUES ('ACL_INFO', 'FR', 'AccÃ¨s hÃ©ritÃ© du parent', NULL);
INSERT INTO `internal_resources` VALUES ('ACL_INHERIT', 'FR', 'HÃ©riter des permissions du parent', NULL);
INSERT INTO `internal_resources` VALUES ('ACL_INHERIT_NOTE', 'FR', 'Note : quand la case est cochÃ©e, il n''y a pas d''autre configuration disponible !', NULL);
INSERT INTO `internal_resources` VALUES ('ACL_OWNER', 'FR', 'PropriÃ©taire', NULL);
INSERT INTO `internal_resources` VALUES ('ACL_PARENT', 'FR', 'Permissions hÃ©ritÃ©es de', NULL);
INSERT INTO `internal_resources` VALUES ('ACL_ROLE', 'FR', 'SÃ©lectionner les rÃ´les pour le groupe', NULL);
...
INSERT INTO `internal_resources` VALUES ('AFTER', 'FR', 'AprÃ¨s :', NULL);
INSERT INTO `internal_resources` VALUES ('AGENT_CALLED', 'FR', 'Vous m''avez demandÃ© ?', NULL);
INSERT INTO `internal_resources` VALUES ('AGENT_EXPLAINHOME', 'FR', 'Vous pouvez me trouver en cliquant sur le logo N/X, en haut Ã  droite de la fenÃªtre', NULL);
INSERT INTO `internal_resources` VALUES ('AGENT_GOAWAY', 'FR', 'Cachez-vous et restez Ã©loignÃ© !', NULL);
INSERT INTO `internal_resources` VALUES ('AGENT_GOHOME', 'FR', 'Rentrez chez vous !', NULL);
INSERT INTO `internal_resources` VALUES ('AGENT_LOGOUT', 'FR', 'J''espÃ¨re que vous avez bien travaillÃ© avec N/X. Bonne journÃ©e !', NULL);
...
INSERT INTO `internal_resources` VALUES ('ALC_OWNER', 'FR', 'DÃ©finir le propriÃ©taire', NULL);
...
INSERT INTO `internal_resources` VALUES ('ARTICLE_IS_EXPIRED', 'FR', 'L''article a expirÃ©', NULL);
...
INSERT INTO `internal_resources` VALUES ('AVAIL_ITEMS', 'FR', 'EntrÃ©es disponibles', NULL);
...
INSERT INTO `internal_resources` VALUES ('BACK_TO_CV', 'FR', 'Retour Ã  la vue d''ensemble du cluster', NULL);
INSERT INTO `internal_resources` VALUES ('BACK_TO_OVERVIEW', 'FR', 'Retour Ã  la vue d''ensemble', NULL);
INSERT INTO `internal_resources` VALUES ('BACKUP', 'FR', 'Sauvegarde systÃ¨me', NULL);
INSERT INTO `internal_resources` VALUES ('BAK_FILE', 'FR', 'Fichier de sauvegarde', NULL);
INSERT INTO `internal_resources` VALUES ('BAK_TIPP', 'FR', 'Vous pouvez sauvegarder votre base de donnÃ©es et les dossiers de site www et wwwdev ici. VÃ©rifiez que vous avez bien configurÃ© la sauvegarde dans settings.inc.php !', NULL);
INSERT INTO `internal_resources` VALUES ('BEGIN', 'FR', 'DÃ©marrer', NULL);
...
INSERT INTO `internal_resources` VALUES ('CAL_BTO', 'FR', 'Retour Ã  la vue d''ensemble', NULL);
...
INSERT INTO `internal_resources` VALUES ('CALENDAR_SELECT', 'FR', 'SÃ©lectionner un calendrier', NULL);
INSERT INTO `internal_resources` VALUES ('CALENDARS', 'FR', 'Calendriers', NULL);
INSERT INTO `internal_resources` VALUES ('CALENDARS_CAT_DEFINE', 'FR', 'DÃ©finir les catÃ©gories', NULL);
INSERT INTO `internal_resources` VALUES ('CALENDARS_DEFINE', 'FR', 'DÃ©finir les calendriers', NULL);
INSERT INTO `internal_resources` VALUES ('CALENDARS_EDIT', 'FR', 'Editer le calendrier', NULL);
INSERT INTO `internal_resources` VALUES ('CALENDARS_TIPP', 'FR', 'Vous pouvez crÃ©er plusieurs calendriers ici. Chaque calendrier aura ses propres Ã©vÃ©nements et dates.', NULL);
INSERT INTO `internal_resources` VALUES ('CANCEL', 'FR', 'Annuler', NULL);
INSERT INTO `internal_resources` VALUES ('CAT_NAME', 'FR', 'CatÃ©gorie', NULL);
INSERT INTO `internal_resources` VALUES ('CATEGORY', 'FR', 'CatÃ©gorie', NULL);
...
INSERT INTO `internal_resources` VALUES ('CH_CAT', 'FR', 'DÃ©finir les catÃ©gories', NULL);
INSERT INTO `internal_resources` VALUES ('CH_CAT2', 'FR', 'Canal et catÃ©gorie', NULL);
INSERT INTO `internal_resources` VALUES ('CHANGE_TEMPLATE', 'FR', 'Changer de modÃ¨le', NULL);
...
INSERT INTO `internal_resources` VALUES ('CHANNEL_SELECT', 'FR', 'SÃ©lectionner un canal', NULL);
...
INSERT INTO `internal_resources` VALUES ('CL_CREATEINSMES', 'FR', 'Il reste des emplacements pour crÃ©er d''autres instances de ce champ de contenu. Si vous voulez crÃ©er une autre instance, entrez un titre dans le champ texte ci-dessous et appuyez sur CrÃ©er.', NULL);
INSERT INTO `internal_resources` VALUES ('CL_CREATEINSTANC', 'FR', 'CrÃ©er une nouvelle instance', NULL);
INSERT INTO `internal_resources` VALUES ('CL_DEL', 'FR', 'Supprimer l''instance', NULL);
INSERT INTO `internal_resources` VALUES ('CL_DELMES', 'FR', 'Voulez-vous vraiment supprimer cette instance de cluster ? Toutes les donnÃ©es seront perdues !', NULL);
...
INSERT INTO `internal_resources` VALUES ('CL_NOTITLE', 'FR', 'Aucun titre dÃ©fini', NULL);
INSERT INTO `internal_resources` VALUES ('CL_PROPERTIES', 'FR', 'PropriÃ©tÃ©s du cluster', NULL);
INSERT INTO `internal_resources` VALUES ('CL_SELECT', 'FR', 'SÃ©lectionnez un cluster pour le lier Ã  un modÃ¨le de cluster', NULL);
INSERT INTO `internal_resources` VALUES ('CLASS_WRONG', 'FR', 'Le fichier spÃ©cifiÃ© n''a pas de signature de classe valide !', NULL);
INSERT INTO `internal_resources` VALUES ('CLEAR', 'FR', 'Effacer', NULL);
INSERT INTO `internal_resources` VALUES ('CLEAR_MEDIA', 'FR', 'Supprimer le fichier depuis la base de donnÃ©es', NULL);
...
INSERT INTO `internal_resources` VALUES ('CLI_DELETED', 'FR', 'L''instance a Ã©tÃ© supprimÃ©e.', NULL);
INSERT INTO `internal_resources` VALUES ('CLI_DELETEMES', 'FR', 'Voulez-vous vraiment supprimer cette instance ? Elle sera perdue Ã  jamais !', NULL);
INSERT INTO `internal_resources` VALUES ('CLI_EDIT', 'FR', 'Modifier le membre de cluster', NULL);
INSERT INTO `internal_resources` VALUES ('CLI_NOTDELETED', 'FR', 'Cette instance ne peut pas Ãªtre supprimÃ©e !', NULL);
INSERT INTO `internal_resources` VALUES ('CLK_PATHS', 'FR', 'Chemins des clics', NULL);
INSERT INTO `internal_resources` VALUES ('CLT', 'FR', 'ModÃ¨le de cluster', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_BROWSE', 'FR', 'Voir les modÃ¨les de clusters', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_DELETE', 'FR', 'Supprimer le modÃ¨le de cluster', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_DELMES', 'FR', 'Vous Ãªtes sur le point de supprimer un modÃ¨le de cluster. Cela entraÃ®nera la perte de toutes les donnÃ©es crÃ©Ã©es avec ce modÃ¨le. Voulez-vous vraiment continuer ?', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_EXCLUSIVE', 'FR', 'Contenu dÃ©veloppeur', NULL);
...
INSERT INTO `internal_resources` VALUES ('CLT_NAME', 'FR', 'Nom du modÃ¨le de cluster', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_NEW', 'FR', 'Nouveau modÃ¨le de cluster', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_PROPERTIES', 'FR', 'PropriÃ©tÃ©s du modÃ¨le de cluster', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_SCHEME', 'FR', 'Modifier le schÃ©ma du modÃ¨le de cluster', NULL);
INSERT INTO `internal_resources` VALUES ('CLT_SELECT', 'FR', 'SÃ©lectionner des modÃ¨les de clusters', NULL);
INSERT INTO `internal_resources` VALUES ('CLTI_DELETE', 'FR', 'Voulez-vous vraiment supprimer cette entrÃ©e ? Toutes les instances seront aussi perdues !', NULL);
...
INSERT INTO `internal_resources` VALUES ('CLUSTER_TEMPLATE', 'FR', 'ModÃ¨le de cluster', NULL);
...
INSERT INTO `internal_resources` VALUES ('COMB_ALL', 'FR', 'Tout sÃ©lectionner', NULL);
...
INSERT INTO `internal_resources` VALUES ('CONFIGURED', 'FR', 'PrÃªt Ã  l''utilisation', NULL);
INSERT INTO `internal_resources` VALUES ('CONFIRM_DELETE', 'FR', 'Voulez-vous vraiment supprimer cette entrÃ©e ?', NULL);
INSERT INTO `internal_resources` VALUES ('CONFIRM_UNSAVED_CHANGES', 'FR', 'Note : les modifications non enregistrÃ©es seront perdues si vous continuez. Si vous avez dÃ©jÃ  modifiÃ© quelque chose, vous pouvez annuler et enregistrer votre travail. On continue ? ', NULL);
INSERT INTO `internal_resources` VALUES ('CONTAINERNAME', 'FR', 'ModÃ¨le', NULL);
...
INSERT INTO `internal_resources` VALUES ('CONTENTITEM', 'FR', 'EntrÃ©e de contenu', NULL);
...
INSERT INTO `internal_resources` VALUES ('CP_GROUP', 'FR', 'Groupe composÃ©', NULL);
INSERT INTO `internal_resources` VALUES ('CPG_MEMBERS_SELECT', 'FR', 'SÃ©lectionner des membres de ce groupe de composition', NULL);
INSERT INTO `internal_resources` VALUES ('CR_CONTENT', 'FR', 'CrÃ©er du contenu pour cette page ?', NULL);
INSERT INTO `internal_resources` VALUES ('CREATE', 'FR', 'CrÃ©er un article', NULL);
INSERT INTO `internal_resources` VALUES ('CREATE_ARTICLE', 'FR', 'CrÃ©er un nouvel article dans le canal', NULL);
INSERT INTO `internal_resources` VALUES ('CREATE_INSTANCES', 'FR', 'CrÃ©er des instances', NULL);
INSERT INTO `internal_resources` VALUES ('CREATED', 'FR', 'CrÃ©Ã©', NULL);
INSERT INTO `internal_resources` VALUES ('CREATED_AT', 'FR', 'CrÃ©Ã© le', NULL);
INSERT INTO `internal_resources` VALUES ('CREATENEW', 'FR', 'Un nouveau membre de ce modÃ¨le a Ã©tÃ© crÃ©Ã©. Voir les donnÃ©es ci-dessous', NULL);
...
INSERT INTO `internal_resources` VALUES ('DELETESUCCESS', 'FR', 'Les donnÃ©es ci-dessous ont Ã©tÃ© supprimÃ©es de la base de donnÃ©es. Elles sont maintenant perdues !', NULL);
...
INSERT INTO `internal_resources` VALUES ('DESTROY_EXCLUSIVE_CONTENT', 'FR', 'DÃ©truire le contenu exclusif', NULL);
INSERT INTO `internal_resources` VALUES ('DESTROY_TREE', 'FR', 'DÃ©truire l''arborescence', NULL);
INSERT INTO `internal_resources` VALUES ('DISABLE', 'FR', 'DÃ©sactiver', NULL);
INSERT INTO `internal_resources` VALUES ('DISPLAY', 'FR', 'Afficher', NULL);
INSERT INTO `internal_resources` VALUES ('DOSOMETHING', 'FR', 'SÃ©lectionnez l''action que vous souhaitez. Vous pouvez insÃ©rer des entrÃ©es, les modifier, les supprimer et changer leur ordre.', NULL);
INSERT INTO `internal_resources` VALUES ('DOWN', 'FR', 'Bas', NULL);
INSERT INTO `internal_resources` VALUES ('DWEXT_CONTENTFIE', 'FR', 'GÃ©nÃ©rer les informations du champ de contenu', NULL);
INSERT INTO `internal_resources` VALUES ('DWEXT_CONTENTFIELDINFO', 'FR', 'GÃ©nÃ©rer les informations du champ de contenu', NULL);
INSERT INTO `internal_resources` VALUES ('DWEXT_CONTENTFIELDINFO_MES', 'FR', 'GÃ©nÃ©rer les informations du champ de contenu pour Dreamweaver MX', NULL);
INSERT INTO `internal_resources` VALUES ('ED_CLT', 'FR', 'Modifier le modÃ¨le de cluster', NULL);
...
INSERT INTO `internal_resources` VALUES ('ED_CPGROUPGENERAL', 'FR', 'Modifier le groupe gÃ©nÃ©ral', NULL);
INSERT INTO `internal_resources` VALUES ('ED_DISPATCHER', 'FR', 'Utilisez ce bouton pour basculer entre la modification des mÃ©ta-donnÃ©es et la modification du contenu.', NULL);
INSERT INTO `internal_resources` VALUES ('ED_META', 'FR', 'Modifier les mÃ©ta-donnÃ©es', NULL);
INSERT INTO `internal_resources` VALUES ('ED_PROPERTIES', 'FR', 'Modifier les propriÃ©tÃ©s', NULL);
INSERT INTO `internal_resources` VALUES ('EDIT', 'FR', 'Modifier', NULL);
INSERT INTO `internal_resources` VALUES ('EDIT_ACCESS', 'FR', 'DÃ©finir les accÃ¨s', NULL);
...
INSERT INTO `internal_resources` VALUES ('EDIT_SPM', 'FR', 'Modifier les propriÃ©tÃ©s du modÃ¨le', NULL);
INSERT INTO `internal_resources` VALUES ('EDIT_TEMPLATE', 'FR', 'Modifier le modÃ¨le', NULL);
INSERT INTO `internal_resources` VALUES ('EDITED', 'FR', 'ModifiÃ©', NULL);
...
INSERT INTO `internal_resources` VALUES ('ERROR', 'FR', 'Une erreur est apparue pendant l''opÃ©ration sÃ©lectionnÃ©e !', NULL);
INSERT INTO `internal_resources` VALUES ('ERROR_SEL_GROUP', 'FR', 'Vous devez choisir un groupe !', NULL);
INSERT INTO `internal_resources` VALUES ('ERROR_SEL_ROLE', 'FR', 'Vous devez choisir au moins un rÃ´le !', NULL);
INSERT INTO `internal_resources` VALUES ('EXEC_EXPORT', 'FR', 'Exportation de la ressource en cours', NULL);
INSERT INTO `internal_resources` VALUES ('EXP_REPORT', 'FR', 'Exportation des donnÃ©es suivantes en cours', NULL);
INSERT INTO `internal_resources` VALUES ('EXPIRE', 'FR', 'Expirer', NULL);
INSERT INTO `internal_resources` VALUES ('EXPL_EXEC_EXPORT', 'FR', 'Ce systÃ¨me gÃ©nÃ¨re actuellement un fichier XML d''exportation.<br/><br/>Dans quelques secondes, une fenÃªtre apparaÃ®tra. Cliquez sur Enregistrer pour placer la ressource sur votre disque.', NULL);
INSERT INTO `internal_resources` VALUES ('EXPL_SEL_CH', 'FR', 'Choisissez un canal.', NULL);
INSERT INTO `internal_resources` VALUES ('EXPL_SEL_CLUSTER', 'FR', 'AprÃ¨s avoir choisi un modÃ¨le de cluster, vous pourrez choisir un cluster dans la liste qui apparaÃ®tra.', NULL);
INSERT INTO `internal_resources` VALUES ('EXPL_SEL_SPM', 'FR', 'Choisissez un modÃ¨le de page.', NULL);
INSERT INTO `internal_resources` VALUES ('EXPLORE', 'FR', 'Explorer', NULL);
INSERT INTO `internal_resources` VALUES ('EXPORT_DATA', 'FR', 'Assistant d''exportation du contenu et des modÃ¨les', NULL);
INSERT INTO `internal_resources` VALUES ('FILTER_COLUMN', 'FR', 'â€¦dans', NULL);
INSERT INTO `internal_resources` VALUES ('FILTER_RULE', 'FR', 'Chercherâ€¦', NULL);
...
INSERT INTO `internal_resources` VALUES ('HELP_ACCESS', 'FR', 'Un dispositif existe pour crÃ©er et gÃ©rer des profils d''utilisateur dans N/X.', NULL);
...
INSERT INTO `internal_resources` VALUES ('HELP_CHANNEL', 'FR', 'CatÃ©gories de thÃ¨mes dÃ©finissant le contenu des articles crÃ©Ã©s par N/X (par exemple, News, Personnesâ€¦).', NULL);
INSERT INTO `internal_resources` VALUES ('HELP_CLB', 'FR', 'Un cluster est une collection de champs de contenu dynamiques ou statiques, complÃ©tÃ©s par un dÃ©veloppeur ou un rÃ©dacteur de pages Web. La dÃ©finition de la structure dans N/X est faite avec des clusters de donnÃ©es.', NULL);
INSERT INTO `internal_resources` VALUES ('HELP_CLT', 'FR', 'Le modÃ¨le de cluster est un formulaire qui vous permet de crÃ©er la structure des donnÃ©es pour votre site et de dÃ©finir le type de contenu. Ensuite, le modÃ¨le de cluster est fusionnÃ© avec un modÃ¨le de page qui gÃ¨re le contenu de la page Web.', NULL);
INSERT INTO `internal_resources` VALUES ('HELP_COMPGRP', 'FR', 'Le groupe de composition est un groupe de clusters. Les modÃ¨les de clusters peuvent avoir leur propre disposition. Ceci vous permet de construire votre page Web hors de blocs (par exemple, articles de news, sondage, galerie de photos... le tout sur une page et sur demande).', NULL);
INSERT INTO `internal_resources` VALUES ('HELP_DW', 'FR', 'CrÃ©e un dossier de configuration pour l''extension N/X de Dreamweaver. A l''aide de cette extension, des modÃ¨les peuvent Ãªtre dÃ©veloppÃ©s avec Dreamweaver.', NULL);
INSERT INTO `internal_resources` VALUES ('HELP_METATEMP', 'FR', 'Un modÃ¨le de mÃ©ta-donnÃ©e est utilisÃ© pour dÃ©finir quels champs de mÃ©ta-donnÃ©es seront placÃ©s dans une nouvelle page. Quand vous crÃ©ez un nouveau champ de mÃ©ta-donnÃ©e dans le modÃ¨le, chaque nouvelle page basÃ©e sur ce modÃ¨le contiendra ce champ.', NULL);
INSERT INTO `internal_resources` VALUES ('HELP_OBJBROWSE', 'FR', 'La bibliothÃ¨que de contenu contient tous les Ã©lÃ©ments de contenu du site', NULL);
INSERT INTO `internal_resources` VALUES ('HELP_PAGETEMP', 'FR', 'Dans les tableurs et les applications de base de donnÃ©es, un modÃ¨le est un formulaire vide qui montre quels champs existent, leur emplacement et leur longueur. Dans N/X, les modÃ¨les sont Ã  la base de son fonctionnement. Un modÃ¨le est un formulaire dans lequel toutes les cellules ont Ã©tÃ© dÃ©finies mais aucune donnÃ©e n''a encore Ã©tÃ© saisie.', NULL);
INSERT INTO `internal_resources` VALUES ('HELP_PGN', 'FR', 'Les extensions vous permettent d''Ã©tendre les fonctions de N/X. Typiquement, des extensions sont employÃ©es pour crÃ©er de nouveaux types d''objets, en plus des deux types d''objets standards Text et Image.', NULL);
INSERT INTO `internal_resources` VALUES ('HELP_PURGE', 'FR', 'Supprime les informations inutiles de la base de donnÃ©es.', NULL);
INSERT INTO `internal_resources` VALUES ('HELP_ROLLOUT', 'FR', 'Rollout est un dispositif de N/X qui permet de crÃ©er des copies d''une section de votre page Web et de les rÃ©utiliser avec ou sans l''ancien contenu.', NULL);
INSERT INTO `internal_resources` VALUES ('HELP_SP', 'FR', 'Le plan du site est utilisÃ© pour modifier la structure et les pages du site.', NULL);
INSERT INTO `internal_resources` VALUES ('HELP_SYNCCL', 'FR', 'Dispositif utilisÃ© pour synchroniser les clusters aprÃ¨s avoir modifiÃ© ou changÃ© un modÃ¨le de cluster.', NULL);
INSERT INTO `internal_resources` VALUES ('HELP_VARIATION', 'FR', 'Un contenu peut avoir plusieurs variations. Ces variations peuvent Ãªtre des langues diffÃ©rentes ou des profils de contenu diffÃ©rents.', NULL);
...
INSERT INTO `internal_resources` VALUES ('I_AFTER', 'FR', 'InsÃ©rer aprÃ¨s', NULL);
INSERT INTO `internal_resources` VALUES ('IMPORT_DATA', 'FR', 'Importer des donnÃ©es N/X-XML', NULL);
...
INSERT INTO `internal_resources` VALUES ('INDIV_CONFIG', 'FR', 'Configuration individuelle pour cette entrÃ©e', NULL);
INSERT INTO `internal_resources` VALUES ('INSNAME', 'FR', '<Nom du cluster>', NULL);
INSERT INTO `internal_resources` VALUES ('INSTANCE_CREATED', 'FR', 'Une nouvelle instance de cette entrÃ©e a Ã©tÃ© crÃ©Ã©e.', NULL);
INSERT INTO `internal_resources` VALUES ('INSTANCES_CREATED', 'FR', 'De nouvelles instances de cette entrÃ©e ont Ã©tÃ© crÃ©Ã©es.', NULL);
INSERT INTO `internal_resources` VALUES ('IS_COMPOUND', 'FR', 'ModÃ¨le de cluster de composition', NULL);
...
INSERT INTO `internal_resources` VALUES ('KEYWORDS', 'FR', 'Mots-clÃ©s', NULL);
INSERT INTO `internal_resources` VALUES ('LAST_LAUNCHED_AT', 'FR', 'Dernier lancement Ã ', NULL);
INSERT INTO `internal_resources` VALUES ('LAST_MOD_AT', 'FR', 'DerniÃ¨re modification Ã ', NULL);
INSERT INTO `internal_resources` VALUES ('LASTMONTH', 'FR', 'Mois dernier', NULL);
INSERT INTO `internal_resources` VALUES ('LASTWEEK', 'FR', 'Semaine derniÃ¨re', NULL);
INSERT INTO `internal_resources` VALUES ('LASTYEAR', 'FR', 'AnnÃ©e derniÃ¨re', NULL);
...
INSERT INTO `internal_resources` VALUES ('LIBRARY', 'FR', 'BibliothÃ¨que de contenu', NULL);
INSERT INTO `internal_resources` VALUES ('LINKED', 'FR', 'LiÃ© Ã ', NULL);
...
INSERT INTO `internal_resources` VALUES ('LOGFILE', 'FR', 'Voir les logs systÃ¨me', NULL);
INSERT INTO `internal_resources` VALUES ('LOGGED_AS', 'FR', 'Utilisateur connectÃ©', NULL);
INSERT INTO `internal_resources` VALUES ('LOGIN_FAILED', 'FR', 'L''identifiant saisi ne peut pas Ãªtre vÃ©rifiÃ© ! Essayez de nouveau.', NULL);
INSERT INTO `internal_resources` VALUES ('LOGS', 'FR', 'Analyse du fichier de logs', NULL);
INSERT INTO `internal_resources` VALUES ('LOGS_INFO', 'FR', 'La liste ci-dessous montre les logs rÃ©alisÃ©s pendant que N/X fonctionne.', NULL);
INSERT INTO `internal_resources` VALUES ('LONGEST_PATHS', 'FR', 'Chemins les plus longs', NULL);
INSERT INTO `internal_resources` VALUES ('M_ACCESS', 'FR', 'AccÃ¨s', NULL);
...
INSERT INTO `internal_resources` VALUES ('M_CLT', 'FR', 'ModÃ¨les de clusters', NULL);
INSERT INTO `internal_resources` VALUES ('M_CLTB', 'FR', 'Navigateur de modÃ¨les de clusters', NULL);
INSERT INTO `internal_resources` VALUES ('M_CLUSTERS', 'FR', 'Clusters', NULL);
INSERT INTO `internal_resources` VALUES ('M_COMBOBJ', 'FR', 'Contenus combinÃ©s (cluster)', NULL);
...
INSERT INTO `internal_resources` VALUES ('M_LIB', 'FR', 'BibliothÃ¨que', NULL);
INSERT INTO `internal_resources` VALUES ('M_LOGOUT', 'FR', 'Se dÃ©connecter', NULL);
INSERT INTO `internal_resources` VALUES ('M_MAINTENANCE', 'FR', 'Maintenance', NULL);
INSERT INTO `internal_resources` VALUES ('M_META', 'FR', 'ModÃ¨les de mÃ©ta', NULL);
...
INSERT INTO `internal_resources` VALUES ('M_PGN', 'FR', 'ContrÃ´le des extensions', NULL);
INSERT INTO `internal_resources` VALUES ('M_PRTMAN', 'FR', 'Gestionnaire de portail', NULL);
INSERT INTO `internal_resources` VALUES ('M_PTEMP', 'FR', 'ModÃ¨les de pages', NULL);
INSERT INTO `internal_resources` VALUES ('M_PURGE', 'FR', 'Nettoyer le base de donnÃ©es', NULL);
...
INSERT INTO `internal_resources` VALUES ('M_SPM', 'FR', 'Page de site maÃ®tre', NULL);
INSERT INTO `internal_resources` VALUES ('M_TEMP', 'FR', 'ModÃ¨les', NULL);
...
INSERT INTO `internal_resources` VALUES ('MANDATORY', 'FR', 'Ce champ ne peut pas Ãªtre vide !', NULL);
INSERT INTO `internal_resources` VALUES ('MAXIMUM', 'FR', 'Maximum', NULL);
INSERT INTO `internal_resources` VALUES ('MAXIMUMAT', 'FR', 'Maximum Ã ', NULL);
INSERT INTO `internal_resources` VALUES ('MEDIAN', 'FR', 'MÃ©dian', NULL);
INSERT INTO `internal_resources` VALUES ('MENU', 'FR', 'Menu', NULL);
INSERT INTO `internal_resources` VALUES ('MESSAGE', 'FR', 'Message', NULL);
INSERT INTO `internal_resources` VALUES ('METATEMPLATE', 'FR', 'ModÃ¨le de mÃ©ta-clÃ© additionnel', NULL);
INSERT INTO `internal_resources` VALUES ('METATEMPLATES', 'FR', 'ModÃ¨les de mÃ©ta-donnÃ©es', NULL);
...
INSERT INTO `internal_resources` VALUES ('MINIMUMAT', 'FR', 'Minimum Ã ', NULL);
INSERT INTO `internal_resources` VALUES ('MT_ADDITIONAL', 'FR', 'MÃ©ta-donnÃ©es additionnelles', NULL);
INSERT INTO `internal_resources` VALUES ('MT_BASE', 'FR', 'MÃ©ta-donnÃ©es basiques', NULL);
INSERT INTO `internal_resources` VALUES ('MT_DELETE', 'FR', 'Voulez-vous vraiment supprimer cette partie du modÃ¨le de mÃ©ta ? Toute les informations Ã©crites dans n''importe quelle mÃ©ta-donnÃ©e liÃ©e Ã  la prÃ©sente partie seront supprimÃ©es. Les donnÃ©es vont Ãªtre perdues Ã  jamais ! ', NULL);
...
INSERT INTO `internal_resources` VALUES ('MT_GENERATE_DTA', 'FR', 'GÃ©nÃ©rer les types de donnÃ©es', NULL);
INSERT INTO `internal_resources` VALUES ('MT_GENERATE_DTA_', 'FR', 'gÃ©nÃ¨re les types de donnÃ©es', NULL);
INSERT INTO `internal_resources` VALUES ('MT_GENERATE_DTA_MES', 'FR', 'gÃ©nÃ¨re les types de donnÃ©es', NULL);
INSERT INTO `internal_resources` VALUES ('MT_GENERATE_DTA_SUCCEEDED', 'FR', '<br><br>Les types de donnÃ©es ont Ã©tÃ© gÃ©nÃ©rÃ©s avec succÃ¨s et le fichier Ã©crit.<br>', NULL);
INSERT INTO `internal_resources` VALUES ('MT_LW_SITE', 'FR', 'Lancer le site entier', NULL);
INSERT INTO `internal_resources` VALUES ('MT_MODULE', 'FR', 'MÃ©ta-donnÃ©e de type de contenu spÃ©cifique', NULL);
INSERT INTO `internal_resources` VALUES ('MT_PROPERTIES', 'FR', 'Modifier les propriÃ©tÃ©s du modÃ¨le de mÃ©ta', NULL);
INSERT INTO `internal_resources` VALUES ('MT_SCHEME', 'FR', 'Modifier le schÃ©ma du modÃ¨le de mÃ©ta', NULL);
INSERT INTO `internal_resources` VALUES ('MT_SPIDER', 'FR', 'DÃ©marrer le spider', NULL);
...
INSERT INTO `internal_resources` VALUES ('NEW', 'FR', 'CrÃ©er un nouveau', NULL);
...
INSERT INTO `internal_resources` VALUES ('NEW_FOLDER', 'FR', 'CrÃ©er un dossier', NULL);
...
INSERT INTO `internal_resources` VALUES ('NO_CLUSTER_SELECTED', 'FR', 'Aucun cluster sÃ©lectionnÃ©.', NULL);
INSERT INTO `internal_resources` VALUES ('NO_CLUSTERTEMPLATES', 'FR', 'Il n''y a aucun modÃ¨le de cluster.', NULL);
INSERT INTO `internal_resources` VALUES ('NO_CONTENT', 'FR', 'Aucun contenu dÃ©jÃ  saisi.', NULL);
INSERT INTO `internal_resources` VALUES ('NO_CONTENTS', 'FR', 'Aucun contenu disponible dans ce dossier.', NULL);
INSERT INTO `internal_resources` VALUES ('NO_OBJ', 'FR', 'Aucun objet sÃ©lectionnÃ©.', NULL);
INSERT INTO `internal_resources` VALUES ('NO_VARIATIONS', 'FR', 'Il n''y a actuellement aucune variation dÃ©finie pour cet objet<br>Demandez Ã  un dÃ©veloppeur de vÃ©rifier la configuration de l''entrÃ©e sÃ©lectionnÃ©e.', NULL);
INSERT INTO `internal_resources` VALUES ('NODE_ACCESS', 'FR', 'DÃ©finir les accÃ¨s pour la racine du site', NULL);
INSERT INTO `internal_resources` VALUES ('NOSPTITLE', 'FR', 'Vous devez dÃ©finir le nom dans le menu avant de pouvoir lancer la page !', NULL);
INSERT INTO `internal_resources` VALUES ('NOT_SELECTED', 'FR', 'Aucune entrÃ©e encore sÃ©lectionnÃ©e.', NULL);
INSERT INTO `internal_resources` VALUES ('NOT_SPECIFIED', 'FR', 'N''importe quel type', NULL);
INSERT INTO `internal_resources` VALUES ('NOTCONFIGURED', 'FR', 'Pas encore configurÃ©.', NULL);
...
INSERT INTO `internal_resources` VALUES ('NUMBER_OF_INSTANCES', 'FR', 'SpÃ©cifiez combien d''instances vous voulez crÃ©er.', NULL);
INSERT INTO `internal_resources` VALUES ('O_ALT', 'FR', 'LibellÃ© ALT', NULL);
...
INSERT INTO `internal_resources` VALUES ('O_DBLINK_EXTERNALDB', 'FR', 'Base de donnÃ©es externe', NULL);
...
INSERT INTO `internal_resources` VALUES ('O_DELMES', 'FR', 'Vous Ãªtes sur le point de supprimer un objet.<b>Notez que toutes les variations et toutes les mÃ©ta-donnÃ©es seront perdues !</b>', NULL);
...
INSERT INTO `internal_resources` VALUES ('O_PREVIEW', 'FR', 'PrÃ©visualisation de', NULL);
INSERT INTO `internal_resources` VALUES ('O_PROPERTIES', 'FR', 'PropriÃ©tÃ©s de l''objet', NULL);
...
INSERT INTO `internal_resources` VALUES ('OBJLAUNCH_SUCCESS', 'FR', 'L''objet a Ã©tÃ© lancÃ© avec succÃ¨s.', NULL);
...
INSERT INTO `internal_resources` VALUES ('PAGE_TEMPLATE', 'FR', 'ModÃ¨le de page', NULL);
...
INSERT INTO `internal_resources` VALUES ('PG_ALREADYINSTAL', 'FR', 'L''extension est dÃ©jÃ  installÃ©e !', NULL);
...
INSERT INTO `internal_resources` VALUES ('PG_FILEWRONG', 'FR', 'Le nom de fichier entrÃ© ne peut pas Ãªtre trouvÃ© sur le serveur !', NULL);
INSERT INTO `internal_resources` VALUES ('PG_INSTALL', 'FR', 'Installer une extension', NULL);
INSERT INTO `internal_resources` VALUES ('PG_INSTALLDESC', 'FR', 'VÃ©rifiez que vous avez copiÃ© tous les fichiers nÃ©cessaires dans le dossier avant de procÃ©der. InsÃ©rez le chemin correct de l''extension dans le champ ci-dessous. Le systÃ¨me pourra alors installer l''extension automatiquement.', NULL);
INSERT INTO `internal_resources` VALUES ('PG_INSTALLED', 'FR', 'L''extension a Ã©tÃ© installÃ©e avec succÃ¨s !', NULL);
INSERT INTO `internal_resources` VALUES ('PG_NEWERINSTALLE', 'FR', 'Il y a une version plus rÃ©cente de cette extension installÃ©e !', NULL);
INSERT INTO `internal_resources` VALUES ('PG_TITLE', 'FR', 'Extensions', NULL);
INSERT INTO `internal_resources` VALUES ('PG_UNINSTALL', 'FR', 'DÃ©sinstaller une extension', NULL);
INSERT INTO `internal_resources` VALUES ('PG_UNINSTALLDELE', 'FR', 'DÃ©sinstaller un module, <br> supprimer les contenus correspondants.', NULL);
INSERT INTO `internal_resources` VALUES ('PG_UNINSTALLMES', 'FR', 'Vous Ãªtes sur le point de dÃ©sinstaller un module.<b>La dÃ©sinstallation d''un module ne supprime pas seulement le type de contenu mais aussi chaque objet unique de ce type stockÃ© dans la base de donnÃ©es. La dÃ©sinstallation supprimera dÃ©finitivement toutes les donnÃ©es de ce module ! ', NULL);
INSERT INTO `internal_resources` VALUES ('PG_UPGRADED', 'FR', 'L''extension a Ã©tÃ© mise Ã  jour avec succÃ¨s !', NULL);
INSERT INTO `internal_resources` VALUES ('PGNTXT_SMA', 'FR', 'Enregistrer tous les textes modifiÃ©s sur cette page', NULL);
INSERT INTO `internal_resources` VALUES ('PI', 'FR', 'Pages demandÃ©es', NULL);
INSERT INTO `internal_resources` VALUES ('PI_OVERVIEW', 'FR', 'Vue d''ensemble des pages demandÃ©es', NULL);
INSERT INTO `internal_resources` VALUES ('PO_BROWSER', 'FR', 'Navigateur de portail', NULL);
INSERT INTO `internal_resources` VALUES ('PO_CRSUCCEEDED', 'FR', 'La crÃ©ation d''un nouveau portail a abouti !', NULL);
...
INSERT INTO `internal_resources` VALUES ('PO_OWNER', 'FR', 'PropriÃ©taire de la page', NULL);
...
INSERT INTO `internal_resources` VALUES ('PREDEF_TIME', 'FR', 'Fuseau horaire prÃ©dÃ©fini', NULL);
INSERT INTO `internal_resources` VALUES ('PREV_AVAIL', 'FR', 'Vous avez sÃ©lectionnÃ© un objet. Une prÃ©visualisation sera disponible aprÃ¨s enregistrement.', NULL);
INSERT INTO `internal_resources` VALUES ('PREVIEW', 'FR', 'PrÃ©visualisation', NULL);
INSERT INTO `internal_resources` VALUES ('PRINT', 'FR', 'Imprimer', NULL);
INSERT INTO `internal_resources` VALUES ('PROCERROR', 'FR', 'Une erreur s''est produite pendant le traitement du formulaire. Regardez les champs marquÃ©s et lisez les commentaires pour plus d''information.', NULL);
INSERT INTO `internal_resources` VALUES ('PROMPTDELETE', 'FR', 'Voulez-vous vraiment supprimer ce jeu de donnÃ©es ? Cette action ne peut pas Ãªtre annulÃ©e !', NULL);
INSERT INTO `internal_resources` VALUES ('PROPERTIES', 'FR', 'PropriÃ©tÃ©s', NULL);
INSERT INTO `internal_resources` VALUES ('PTEMPL', 'FR', 'ModÃ¨le de page', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE', 'FR', 'Nettoyer la base de donnÃ©es', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_CLT', 'FR', 'Nettoyer les modÃ¨les de clusters', NULL);
...
INSERT INTO `internal_resources` VALUES ('PURGE_EXPIRED', 'FR', 'Nettoyer les pages expirÃ©es', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_FOLDER', 'FR', 'Nettoyer les dossiers', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_MES', 'FR', 'SÃ©lectionnez les parties de la base de donnÃ©es que vous voulez nettoyer.', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_META', 'FR', 'Nettoyer les mÃ©ta-donnÃ©es', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_PAGES', 'FR', 'Nettoyer les pages du site et les maÃ®tres', NULL);
INSERT INTO `internal_resources` VALUES ('PURGE_VAR', 'FR', 'Nettoyer les variations', NULL);
INSERT INTO `internal_resources` VALUES ('PWDNOTMATCH', 'FR', 'Les mots de passe entrÃ©s ne correspondent pas !', NULL);
INSERT INTO `internal_resources` VALUES ('PWDTOOSHORT', 'FR', 'Le mot de passe doit Ãªtre d''au moins 6 caractÃ¨res !', NULL);
...
INSERT INTO `internal_resources` VALUES ('R_DELFOLDERMES', 'FR', 'Vous Ãªtes sur le point de supprimer un dossier. SÃ©lectionnez une action.', NULL);
INSERT INTO `internal_resources` VALUES ('R_EDITFOLDER', 'FR', 'Modifier les propriÃ©tÃ©s du dossier', NULL);
INSERT INTO `internal_resources` VALUES ('R_FOLDERNAME', 'FR', 'Nom du dossier', NULL);
INSERT INTO `internal_resources` VALUES ('R_FOLDERNOTEMPTY', 'FR', 'Le dossier n''est pas vide. Vous ne pouvez donc pas le supprimer ! VÃ©rifier tous les objets et tous les clusters !', NULL);
INSERT INTO `internal_resources` VALUES ('R_HOME', 'FR', 'DÃ©marrer', NULL);
INSERT INTO `internal_resources` VALUES ('R_MOVEOBJECTS', 'FR', 'DÃ©placer tous les objets vers le nÅ“ud parent', NULL);
...
INSERT INTO `internal_resources` VALUES ('RATERES', 'FR', 'RÃ©sultats des taux', NULL);
INSERT INTO `internal_resources` VALUES ('RB_CACHE', 'FR', 'Reconstruire le cache', NULL);
INSERT INTO `internal_resources` VALUES ('READY_TO_USE', 'FR', 'PrÃªt Ã  l''utilisation.', NULL);
INSERT INTO `internal_resources` VALUES ('REFERER', 'FR', 'RÃ©fÃ©rent', NULL);
INSERT INTO `internal_resources` VALUES ('REMAIN_POS', 'FR', 'Ne pas changer la position', NULL);
INSERT INTO `internal_resources` VALUES ('RESET', 'FR', 'Remettre Ã  zÃ©ro le formulaire', NULL);
INSERT INTO `internal_resources` VALUES ('RESET_FORM', 'FR', 'Remettre Ã  zÃ©ro le formulaire', NULL);
INSERT INTO `internal_resources` VALUES ('RESET_LOGS', 'FR', 'Remettre Ã  zÃ©ro les logs', NULL);
INSERT INTO `internal_resources` VALUES ('RET_VIS', 'FR', 'Visiteurs de renvoi', NULL);
INSERT INTO `internal_resources` VALUES ('RL_PERM', 'FR', 'Permissions des rÃ´les', NULL);
INSERT INTO `internal_resources` VALUES ('ROLE_DESCRIPTION', 'FR', 'Description', NULL);
INSERT INTO `internal_resources` VALUES ('ROLE_FILTERMENU', 'FR', 'Administration des rÃ´les', NULL);
INSERT INTO `internal_resources` VALUES ('ROLE_GENERAL', 'FR', 'Modifier les donnÃ©es gÃ©nÃ©rales du rÃ´le', NULL);
INSERT INTO `internal_resources` VALUES ('ROLE_HEAD', 'FR', 'Profil du rÃ´le', NULL);
INSERT INTO `internal_resources` VALUES ('ROLE_LINK', 'FR', 'Profils du rÃ´le', NULL);
INSERT INTO `internal_resources` VALUES ('ROLE_NAME', 'FR', 'Nom du rÃ´le', NULL);
INSERT INTO `internal_resources` VALUES ('ROLE_PERMISSION', 'FR', 'Modifier les permissions du rÃ´le', NULL);
...
INSERT INTO `internal_resources` VALUES ('SAVEERROR', 'FR', 'Une erreur s''est produite pendant l''enregistrement des donnÃ©es dans la base de donnÃ©es. VÃ©rifiez que la base de donnÃ©es est connectÃ©e ou appelez votre administrateur.', NULL);
INSERT INTO `internal_resources` VALUES ('SAVESUCCESS', 'FR', 'Les donnÃ©es ont Ã©tÃ© Ã©crites dans la base de donnÃ©es avec succÃ¨s.', NULL);
INSERT INTO `internal_resources` VALUES ('SEARCH', 'FR', 'DÃ©marrer la recherche', NULL);
INSERT INTO `internal_resources` VALUES ('SEARCH_CLEAR', 'FR', 'Remettre Ã  zÃ©ro le filtre', NULL);
INSERT INTO `internal_resources` VALUES ('SEARCH_EXPIRED_ARTICLES', 'FR', 'Articles expirÃ©s', NULL);
...
INSERT INTO `internal_resources` VALUES ('SEARCHRESULTS', 'FR', 'RÃ©sultat de la recherche, veuillez faire votre choix', NULL);
INSERT INTO `internal_resources` VALUES ('SEASRCH_MISSING_VARIATIONS', 'FR', 'Variations manquantes', NULL);
INSERT INTO `internal_resources` VALUES ('SEL_ARTICLE', 'FR', 'SÃ©lectionner un article', NULL);
INSERT INTO `internal_resources` VALUES ('SEL_CH', 'FR', 'SÃ©lectionner un canal', NULL);
INSERT INTO `internal_resources` VALUES ('SEL_CHANNEL_CAT', 'FR', 'SÃ©lectionner un canal et une catÃ©gorie', NULL);
INSERT INTO `internal_resources` VALUES ('SEL_CLUSTER', 'FR', 'SÃ©lectionner un cluster', NULL);
INSERT INTO `internal_resources` VALUES ('SEL_EVENT', 'FR', 'SÃ©lectionner un Ã©vÃ©nement ou un rendez-vous', NULL);
INSERT INTO `internal_resources` VALUES ('SEL_FILE', 'FR', 'SÃ©lectionner un fichier', NULL);
INSERT INTO `internal_resources` VALUES ('SEL_MEM', 'FR', 'SÃ©lectionner des membres', NULL);
INSERT INTO `internal_resources` VALUES ('SEL_PTML', 'FR', 'SÃ©lectionner un modÃ¨le de page', NULL);
INSERT INTO `internal_resources` VALUES ('SEL_VAR', 'FR', 'SÃ©lectionner une variation', NULL);
INSERT INTO `internal_resources` VALUES ('SELECT', 'FR', 'SÃ©lectionner', NULL);
INSERT INTO `internal_resources` VALUES ('SELECT_CI', 'FR', 'SÃ©lectionner une entrÃ©e de contenu', NULL);
INSERT INTO `internal_resources` VALUES ('SELECT_CL', 'FR', 'SÃ©lectionner une instance de cluster', NULL);
INSERT INTO `internal_resources` VALUES ('SELECT_VARIATION', 'FR', 'SÃ©lectionner une variation', NULL);
INSERT INTO `internal_resources` VALUES ('SELECTEDINSTANCE', 'FR', 'Instance de cluster sÃ©lectionnÃ©e', NULL);
INSERT INTO `internal_resources` VALUES ('SELECTEDOBJECT', 'FR', 'EntrÃ©e de contenu actuellement sÃ©lectionnÃ©e', NULL);
INSERT INTO `internal_resources` VALUES ('SELECTOBJECT', 'FR', 'SÃ©lectionnez une classe et spÃ©cifiez une position et un nom pour crÃ©er un nouvel objet.<br>Pour la position, utilisez 0 pour l''insÃ©rer au dÃ©but, 999 pour l''insÃ©rer Ã  la fin ou n''importe quel autre position de votre choix.', NULL);
INSERT INTO `internal_resources` VALUES ('SELECTONE', 'FR', 'Vous devez faire un choix ici !', NULL);
INSERT INTO `internal_resources` VALUES ('SELMULTIPLE', 'FR', 'Maintenez la touche CTRL enfoncÃ©e pour sÃ©lectionner plusieurs entrÃ©es.', NULL);
INSERT INTO `internal_resources` VALUES ('SET', 'FR', 'DÃ©finir', NULL);
...
INSERT INTO `internal_resources` VALUES ('SHOW_ADVANCED_SEARCH', 'FR', 'Afficher les options de recherche avancÃ©es', NULL);
...
INSERT INTO `internal_resources` VALUES ('SMA_EXT_EDIT', 'FR', 'Ouvrir une fenÃªtre d''Ã©dition. Enregistrer d''abord tous les textes Ã©ditÃ©s avant !', NULL);
INSERT INTO `internal_resources` VALUES ('SP_BROWSE', 'FR', 'Plan du site', NULL);
INSERT INTO `internal_resources` VALUES ('SP_CLNEW', 'FR', 'CrÃ©er une nouvelle instance de cluster', NULL);
INSERT INTO `internal_resources` VALUES ('SP_CONFDESC', 'FR', 'Vous pouvez lier cette page du site Ã  une instance existante du cluster ou crÃ©er une nouvelle instance. DÃ©cidez ce que vous souhaitez faire.', NULL);
...
INSERT INTO `internal_resources` VALUES ('SP_DELMES', 'FR', 'Vous Ãªtes sur le point de supprimer une page du site. Notez que toutes les instances vivantes de cette page seront Ã©galement supprimÃ©es !', NULL);
...
INSERT INTO `internal_resources` VALUES ('SP_EXPIREDATE', 'FR', 'ExpirÃ© depuis', NULL);
INSERT INTO `internal_resources` VALUES ('SP_IPROPERTIES', 'FR', 'PropriÃ©tÃ©s de la page', NULL);
...
INSERT INTO `internal_resources` VALUES ('SP_MENUDIRECTTIT', 'FR', 'DÃ©finir le chemin optionnel sur le serveur pour un accÃ¨s direct', NULL);
INSERT INTO `internal_resources` VALUES ('SP_MENUDIRECTTITLE', 'FR', 'DÃ©finir le chemin optionnel sur le serveur pour un accÃ¨s direct', NULL);
...
INSERT INTO `internal_resources` VALUES ('SP_PDELMES', 'FR', 'Vous Ãªtes sur le point de supprimer une page. Notez que toutes les instances vivantes de cette page seront Ã©galement supprimÃ©es !', NULL);
INSERT INTO `internal_resources` VALUES ('SP_PREVIEW', 'FR', 'PrÃ©visualisation de la page', NULL);
INSERT INTO `internal_resources` VALUES ('SP_PROPERTIES', 'FR', 'PropriÃ©tÃ©s de la page', NULL);
INSERT INTO `internal_resources` VALUES ('SP_RLTREE', 'FR', 'RafraÃ®chir l''arborescence', NULL);
INSERT INTO `internal_resources` VALUES ('SPM', 'FR', 'Page de site maÃ®tre', NULL);
INSERT INTO `internal_resources` VALUES ('SPM_CLUSTER', 'FR', 'ModÃ¨le de cluster', NULL);
INSERT INTO `internal_resources` VALUES ('SPM_EDIT', 'FR', 'Modifier la page de site maÃ®tre', NULL);
INSERT INTO `internal_resources` VALUES ('SPM_LAUCH_SUCCESS', 'FR', 'Les pages dÃ©finies sur le maÃ®tre ont Ã©tÃ© relancÃ©es avec succÃ¨s.<br>', NULL);
INSERT INTO `internal_resources` VALUES ('SPM_META', 'FR', 'ModÃ¨le de mÃ©ta-clÃ©', NULL);
INSERT INTO `internal_resources` VALUES ('SPM_PATH', 'FR', 'Chemin du modÃ¨le', NULL);
INSERT INTO `internal_resources` VALUES ('SPM_RLAUNCH', 'FR', 'RafraÃ®chir les instances', NULL);
INSERT INTO `internal_resources` VALUES ('SPM_SELECTTHUMB', 'FR', 'SÃ©lectionner une vignette', NULL);
...
INSERT INTO `internal_resources` VALUES ('SR_SELECTCI', 'FR', 'Vous pouvez chercher n''importe quelle entrÃ©e de contenu ici. Si vous voulez sÃ©lectionner une entrÃ©e de contenu, choisissez-la et appuyez sur le bouton Mettre Ã  jour. Si vous voulez relier un nouveau contenu Ã  ce champ, crÃ©ez d''abord le contenu dans le navigateur d''objet. ', NULL);
INSERT INTO `internal_resources` VALUES ('SR_SELECTCLI', 'FR', 'SÃ©lectionnez un modÃ¨le de cluster. Ensuite, vous pourrez sÃ©lectionner une instance de ce modÃ¨le pour l''utiliser.', NULL);
INSERT INTO `internal_resources` VALUES ('START_BAK', 'FR', 'DÃ©marrer la sauvegarde', NULL);
INSERT INTO `internal_resources` VALUES ('STARTDATE', 'FR', 'Date de dÃ©marrage', NULL);
INSERT INTO `internal_resources` VALUES ('STARTTIME', 'FR', 'Heure de dÃ©marrage', NULL);
...
INSERT INTO `internal_resources` VALUES ('STNAME', 'FR', 'SÃ©lectionner un nom pour identifier cette page dans le plan du site', NULL);
INSERT INTO `internal_resources` VALUES ('SYNC_CLUSTERS', 'FR', 'Synchroniser les clusters', NULL);
INSERT INTO `internal_resources` VALUES ('SYNC_CLUSTERS_DESCR', 'FR', 'Quand vous modifiez un modÃ¨le de cluster, les clusters ne sont pas automatiquement synchronisÃ©s. Ils sont synchronisÃ©s quand vous travaillez avec la fois suivante. Vous pouvez tous les synchroniser.', NULL);
INSERT INTO `internal_resources` VALUES ('TEMPLATE', 'FR', 'ModÃ¨le', NULL);
...
INSERT INTO `internal_resources` VALUES ('THISYEAR', 'FR', 'Cette annÃ©e', NULL);
INSERT INTO `internal_resources` VALUES ('TIME_BETW_VISITS', 'FR', 'Moyenne de temps entre les visites', NULL);
INSERT INTO `internal_resources` VALUES ('TIPP_TEMPLATE_1', 'FR', 'Les modÃ¨les sont Ã  la base du fonctionnement de N/X. Vous aurez besoin de crÃ©er un modÃ¨le de cluster en premier qui dÃ©finira la structure et le type de contenu. Par la suite, vous pourrez crÃ©er les modÃ¨les de pages ici en fusionnant un modÃ¨le de cluster et un fichier PHP.<br><br>', NULL);
INSERT INTO `internal_resources` VALUES ('TITLE', 'FR', 'Titre', NULL);
INSERT INTO `internal_resources` VALUES ('TMPL_NAME', 'FR', 'SÃ©lectionner un modÃ¨le', NULL);
INSERT INTO `internal_resources` VALUES ('TODAY', 'FR', 'Aujourd''hui', NULL);
INSERT INTO `internal_resources` VALUES ('TOP', 'FR', 'Principales donnÃ©es', NULL);
INSERT INTO `internal_resources` VALUES ('TOP_BROWSER', 'FR', 'Principaux navigateurs', NULL);
INSERT INTO `internal_resources` VALUES ('TOP_ENTRYPAGES', 'FR', 'Principales pages d''entrÃ©es', NULL);
...
INSERT INTO `internal_resources` VALUES ('TOP_HOSTS', 'FR', 'Principaux hÃ©bergeurs', NULL);
INSERT INTO `internal_resources` VALUES ('TOP_OS', 'FR', 'Principaux systÃ¨mes d''exploitation', NULL);
...
INSERT INTO `internal_resources` VALUES ('TOP_REFERER', 'FR', 'Principaux rÃ©fÃ©rents', NULL);
INSERT INTO `internal_resources` VALUES ('TOP_SI', 'FR', 'Principaux moteurs de recherche', NULL);
INSERT INTO `internal_resources` VALUES ('TOP_SKW', 'FR', 'Principaux mots-clÃ©s de recherche', NULL);
...
INSERT INTO `internal_resources` VALUES ('TRANSLATION', 'FR', 'SystÃ¨me de traduction N/X', NULL);
INSERT INTO `internal_resources` VALUES ('TT_REFRESH', 'FR', 'RafraÃ®chir les instances met Ã  jour les pages en cache dont le modÃ¨le a Ã©tÃ© modifiÃ©.', NULL);
INSERT INTO `internal_resources` VALUES ('TT_RSTCI', 'FR', 'Dans N/X, chaque page a un cluster. En appuyant sur RedÃ©finir l''instance du cluster, vous pouvez assigner un nouveau cluster Ã  la page et supprimer l''ancien.', NULL);
INSERT INTO `internal_resources` VALUES ('TYPE', 'FR', 'Type', NULL);
INSERT INTO `internal_resources` VALUES ('UNIQUE', 'FR', 'Ce champ doit Ãªtre unique !', NULL);
INSERT INTO `internal_resources` VALUES ('UP', 'FR', 'Haut', NULL);
INSERT INTO `internal_resources` VALUES ('UP_INTRO', 'FR', 'SÃ©lectionnez le groupe et ses rÃ´les Ã  affecter Ã  l''utilisateur.', NULL);
...
INSERT INTO `internal_resources` VALUES ('USER_ACTIVE', 'FR', 'Compte activÃ©', NULL);
...
INSERT INTO `internal_resources` VALUES ('USER_GENERAL', 'FR', 'Modifier les donnÃ©es gÃ©nÃ©rales de l''utilisateur', NULL);
...
INSERT INTO `internal_resources` VALUES ('USER_SETPERM', 'FR', 'DÃ©finir les permissions de l''utilisateur ci-dessous. Pour enlever un utilisateur d''un groupe, retirez tous les groupes depuis celui-ci.', NULL);
...
INSERT INTO `internal_resources` VALUES ('VAR_SUCCEEDED', 'FR', 'rÃ©ussi !', NULL);
INSERT INTO `internal_resources` VALUES ('VARIATIONS', 'FR', 'Variations disponibles', NULL);
INSERT INTO `internal_resources` VALUES ('VIS_FIRST', 'FR', 'Visiteurs pour la premiÃ¨re fois', NULL);
...
INSERT INTO `internal_resources` VALUES ('VIS_RET', 'FR', 'Visiteurs pÃ©riodiques', NULL);
...
INSERT INTO `internal_resources` VALUES ('WZ_ARTICLEIMPORT_TITLE', 'FR', 'Cet assistant est utilisÃ© pour importer des donnÃ©es d''articles depuis diffÃ©rentes sources vers un canal. Vous pouvez importer depuis des multiples existantes ou d''autres canaux. Vous devez vous assurer que les modÃ¨les correspondants sont compatibles. ', NULL);
INSERT INTO `internal_resources` VALUES ('WZ_EXPORT_TITLE', 'FR', 'Cet assistant est utilisÃ© pour Ã©changer des clusters, des modÃ¨les de clusters et des modÃ¨les de pages entre votre installation N/X et d''autres installations. L''assistant produit un fichier XML que vous pouvez stocker sur votre disque dur local et Ã©changer avec d''autres utilisateurs de N/X.', NULL);
INSERT INTO `internal_resources` VALUES ('WZ_IMPORT_TITLE', 'FR', 'Cet assistant est utilisÃ© pour importer vers N/X des donnÃ©es qui ont Ã©tÃ© prÃ©alablement exportÃ©es avec une autre installation de N/X. Vous devez supprimer une ressource avant de l''importer une deuxiÃ¨me fois.', NULL);
INSERT INTO `internal_resources` VALUES ('WZE_ARTICLEIMPORT_SRCTYPE', 'FR', 'SÃ©lectionnez depuis quel type de source vous voulez importer les articles.', NULL);
INSERT INTO `internal_resources` VALUES ('WZE_ARTICLEIMPORT_TARGET', 'FR', 'A droite, vous devez choisir le canal cible. Tous les articles importÃ©s seront stockÃ©s dans ce canal.', NULL);
INSERT INTO `internal_resources` VALUES ('WZE_EXPORT_TYPE', 'FR', 'A droite, vous devez choisir le type de donnÃ©es que vous voulez exporter. Les clusters stockent le contenu. Quand vous exportez des clusters, les modÃ¨les sont Ã©galement automatiquement exportÃ©s. Les modÃ¨les de clusters dÃ©finissent la structure pour crÃ©er des clusters. Des modÃ¨les de pages dÃ©finissent la mise en page que les clusters vont utiliser en fonction de leur contenu.', NULL);
INSERT INTO `internal_resources` VALUES ('WZE_IMPORT_FILE', 'FR', 'Choisissez un fichier N/X-XML sur votre disque pour le charger dans le systÃ¨me.<br./><br./>Le systÃ¨me le contrÃ´lera et montrera l''information d''Ã©tat sur la prochaine page.', NULL);
INSERT INTO `internal_resources` VALUES ('WZE_IMPORT_VAL', 'FR', 'Le systÃ¨me a vÃ©rifiÃ© l''exactitude du fichier XML chargÃ©. Lisez le rapport Ã  gauche pour plus de dÃ©tails.', NULL);
INSERT INTO `internal_resources` VALUES ('WZE_IMPORTING', 'FR', 'Le systÃ¨me a tentÃ© d''importer les donnÃ©es. Lisez l''Ã©tat Ã  droite.', NULL);
INSERT INTO `internal_resources` VALUES ('WZT_ARTICLEIMPORT_SRCTYPE', 'FR', 'SÃ©lectionner le type de source', NULL);
INSERT INTO `internal_resources` VALUES ('WZT_ARTICLEIMPORT_TARGET', 'FR', 'SÃ©lectionner le canal cible', NULL);
INSERT INTO `internal_resources` VALUES ('WZT_DESCR', 'FR', 'Ajouter une description', NULL);
INSERT INTO `internal_resources` VALUES ('WZT_DESCR_EXPL', 'FR', 'Vous devriez ajouter une courte description aux donnÃ©es exportÃ©es.</br.></br.>Celui qui importera les donnÃ©es comprendra plus facilement ce qu''il a exportÃ©.', NULL);
INSERT INTO `internal_resources` VALUES ('WZT_EXPORT_TYPE', 'FR', 'SÃ©lectionner un type Ã  exporter', NULL);
INSERT INTO `internal_resources` VALUES ('WZT_IMPORT_FILE', 'FR', 'SÃ©lectionner un fichier N/X-XML ', NULL);
INSERT INTO `internal_resources` VALUES ('WZT_IMPORT_VAL', 'FR', 'Sommaire du XML chargÃ©', NULL);
INSERT INTO `internal_resources` VALUES ('WZT_IMPORTING', 'FR', 'DonnÃ©es en cours d''importation', NULL);
INSERT INTO `internal_resources` VALUES ('WZT_KEEPCLUSTER', 'FR', 'Garder les clusters existants ?', NULL);
INSERT INTO `internal_resources` VALUES ('WZT_KEEPCLUSTER_EXPL', 'FR', 'Vous pouvez indiquer si vous voulez garder les clusters existants ou crÃ©er des copies de chaque cluster.<br.><br.>Garder Ã  l''esprit que si vous gardez les clusters originaux vous les partagez avec la source originale.', NULL);
INSERT INTO `internal_resources` VALUES ('WZT_SEL_EXP_RES', 'FR', 'SÃ©lectionner une ressource Ã  exporter', NULL);
...
INSERT INTO `internal_resources` VALUES ('BAK_TIPP', 'DE', 'Sie kÃ¶nnen ihre www, wwwdev-Verzeichnisse sowie die Datenbank hier sichern. Bitte stellen Sie vorab sicher, dass die Sicherung korrekt konfiguriert wurde.', '');
...
INSERT INTO `internal_resources` VALUES ('CCONLAUNCH', 'DE', 'Cache beim verÃ¶ffentlichen Leeren', '');
INSERT INTO `internal_resources` VALUES ('CCONLAUNCH_LBL', 'DE', 'kommaseparierte Seiten-IDs', '');
INSERT INTO `internal_resources` VALUES ('CHANGE', 'DE', 'Ã„ndern', '');
INSERT INTO `internal_resources` VALUES ('CHANGE_TEMPLATE', 'DE', 'AusgewÃ¤hlte Seitenvorlage', '');
INSERT INTO `internal_resources` VALUES ('CHNLAUNCHED', 'DE', 'Der Kanal wurde erfolgreich verÃ¶ffentlicht.', '');
...
INSERT INTO `internal_resources` VALUES ('DEL_TREE', 'DE', 'Baum lÃ¶schen', '');
INSERT INTO `internal_resources` VALUES ('DEST_FOLDER', 'DE', 'Zielordner', '');
INSERT INTO `internal_resources` VALUES ('EXP_TREE', 'DE', 'Baum zurÃ¼ckziehen', '');
INSERT INTO `internal_resources` VALUES ('FILE_ALREADY_UPLOADED', 'DE', 'Die Datei wurde bereits hochgeladen. Sie kÃ¶nnen fortfahren, indem sie auf Weiter klicken.', '');
...
INSERT INTO `internal_resources` VALUES ('MEDIA_SUPPORTED', 'DE', 'Das Media-Plugin unterstÃ¼tzt folgende Dateitypen:Macromedia Flash Films (.swf), Windows Media (.avi), Real Player (.rm), Apple Quicktime (.mov), MP3 over Windows Media (.mp3), PDF (.pdf)', '');
...
INSERT INTO `internal_resources` VALUES ('MT_LWC', 'DE', 'Alle Artikel verÃ¶ffentlichen', '');
INSERT INTO `internal_resources` VALUES ('MT_RB_CACHE_MES', 'DE', 'Cache aller verÃ¶ffentlichten Seiten neu aufbauen.', '');
INSERT INTO `internal_resources` VALUES ('MUST_UPLOAD', 'DE', 'Sie mÃ¼ssen eine Datei hochladen', '');
...
INSERT INTO `internal_resources` VALUES ('NUMB_IMPORTED', 'DE', 'Importierte DatensÃ¤tze:', '');
INSERT INTO `internal_resources` VALUES ('NUM_FILES', 'DE', 'Anzahl von gefundenen Dateien im Archiv:', '');
INSERT INTO `internal_resources` VALUES ('O_DELMES2', 'DE', 'MÃ¶chten Sie diesen inhalt wirklich lÃ¶schen? Er kÃ¶nnte immer noch von einigen Objekten genutzt werden.', '');
...
INSERT INTO `internal_resources` VALUES ('SEL_IMP_FOLDER', 'DE', 'Importverzeichnis auswÃ¤hlen', '');
...
INSERT INTO `internal_resources` VALUES ('UNINSTCONF', 'DE', 'Das Deinstallieren eines Plugins kann ihre Website zerstÃ¶ren. MÃ¶chten Sie wirklich fortfahren?', '');
...
INSERT INTO `internal_resources` VALUES ('WZE_ARCHIVE_FILE', 'DE', 'Bitte wÃ¤hlen Sie das zu importierende ZIP-Archiv. Verwenden Sie keine Verzeichnisse innerhalb von Archiven!', '');
INSERT INTO `internal_resources` VALUES ('WZE_ARCH_CHECK', 'DE', 'Bitte kontrollieren Sie die ArchivprÃ¼fung.', '');
INSERT INTO `internal_resources` VALUES ('WZE_DEST_FOLDER', 'DE', 'Bitte wÃ¤hlen Sie den Zielordner fÃ¼r die Bilder.', '');
INSERT INTO `internal_resources` VALUES ('WZT_ACH_CHECK', 'DE', 'Archiv Ã¼berprÃ¼fen', '');
INSERT INTO `internal_resources` VALUES ('WZT_ARCHIVE_FILE', 'DE', 'Archiv wÃ¤hlen', '');
INSERT INTO `internal_resources` VALUES ('WZT_DEST_FOLDER', 'DE', 'WÃ¤hlen Sie einen Zielordner', '');
...
INSERT INTO `internal_resources` VALUES ('BACK_TO_CHANNELS', 'DE', 'ZurÃ¼ck zur ArtikelÃ¼bersicht', '');
...
INSERT INTO `internal_resources` VALUES ('DEL_BACKUP', 'DE', 'Backupdatei lÃ¶schen?', '');
INSERT INTO `internal_resources` VALUES ('DEL_BACKUP_MES', 'DE', 'MÃ¶chten Sie die Backupdatei wirklich lÃ¶schen?', '');
INSERT INTO `internal_resources` VALUES ('DEST_NODE', 'DE', 'Zielknoten:', '');
INSERT INTO `internal_resources` VALUES ('LATEST', 'DE', 'zuletzt geÃ¤nderte zuerst', '');
...
INSERT INTO `internal_resources` VALUES ('OLDEST', 'DE', 'die Ã¤ltesten zuerst', '');
INSERT INTO `internal_resources` VALUES ('RANDOM', 'DE', 'ZufÃ¤llig', '');
INSERT INTO `internal_resources` VALUES ('REFRESH_PAGES', 'DE', 'Die Seiten, die auf dieser Vorlage basieren wurden erfolgreich neu verÃ¶ffentlicht.', '');
...
INSERT INTO `internal_resources` VALUES ('ROLL2', 'DE', 'Sie kÃ¶nnen die Namen der Objekte jetzt verÃ¤ndern. Dies ist wichtig, da N/X keine zwei Objekte mit dem selben Namen verwalten kann. Wenn Sie die Namen nicht Ã¤ndern, wird N/X dies automatisch fÃ¼r Sie Ã¼bernehmen.', '');
...
INSERT INTO `internal_resources` VALUES ('SEARCHREPLACEVALID', 'DE', 'Sie mÃ¼ssen einen Such- und einen Ersetzungstext eingeben.', '');
...
INSERT INTO `internal_resources` VALUES ('THEREISQUESTION', 'DE', 'Aktion bestÃ¤tigen', '');
INSERT INTO `internal_resources` VALUES ('WEBSITEPRV', 'DE', 'Entwicklungswebsite', '');
INSERT INTO `internal_resources` VALUES ('WZ_IMP_SELCL', 'DE', 'Bitte wÃ¤hlen Sie den Knoten in den Sie importieren mÃ¶chten.', '');
...
INSERT INTO `sequences` VALUES ('GUID', 101228);
...
INSERT INTO `temp_vars` VALUES ('menu', '1', '2x1');
...
INSERT INTO `user_session` VALUES ('1', '2006-08-15 21:33:30', 'c8d993f2ed3c252ae94db1effedd2f52', '127.0.0.1');
