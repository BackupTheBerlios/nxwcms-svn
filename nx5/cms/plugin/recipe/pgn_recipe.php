	...
	class pgnRecipe extends Plugin {
		...
		function registration() {
			...
			if ($auth->checkPermission("ADMINISTRATOR")) {
				...
				$sql2 = "CREATE TABLE `pgn_recipes_tags` (`TAG_ID` BIGINT NOT NULL ,`TAG` CHAR( 32 ) NOT NULL ,PRIMARY KEY ( `TAG_ID` ) ,INDEX ( `TAG` ) ) TYPE = MYISAM ;";
				$sql3 = "SQL-Befehl:CREATE TABLE `pgn_recipes_tag_relation` (`REL_ID` BIGINT NOT NULL ,`TAG_ID` BIGINT NOT NULL ,`REC_ID` BIGINT NOT NULL ,PRIMARY KEY ( `REL_ID` ) ,INDEX ( `TAG_ID` , `REC_ID` ) ) TYPE = MYISAM ;";
