<?php
  ...
  include("logic/menudef.inc.php");		
	...
	$filter = new Filter("mailinglists", "MAILINGLIST_ID");
	...
	$deleteHandler->addDBAction("Delete from mailinglists Where MAILINGLIST_ID = <oid>");
	
	//$form = new StdEDForm($lang->get("edit_newsletter", "Edit newsletter"));
	//$cond = $form->setPK("mailinglists", "MAILINGLIST_ID");
