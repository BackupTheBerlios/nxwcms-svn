...
<?php
   ...
   print '<p class="blue"><b>'
          ...
          .'<a href="update.php?sid=$sid&site_id='.$site_id.'&amp;unlock=1">'.phpdigMsg('unlock').'</a>'
          ."</p>\n";
}
if (is_array($list_exclude)) {
    ...
    foreach ($list_exclude as $this_exclude) {
         ...
         print "<a href='update.php?sid=$sid&site_id=$site_id&ex_id=$ex_id' target='_self'><img src='no.gif' width='10' height='10' border='0' align='middle' alt='".phpdigMsg('delete')."'></a>&nbsp;<font COLOR='red'>$ex_path</font><br/>\n";
    }
}
?>
...
for ($n = 0; $n<$num; $n++) {
    ...
    if (!$locked) {
        if ($path_name) {
           print "<a href='update.php?sid=$sid&path=".urlencode($path_name)."&amp;sid=$sid&site_id=$site_id&amp;deny=1&amp;sup=1#$aname2' target='_self' ><img src='deny.gif' width='10' height='10' border='0' align='middle' alt='".phpdigMsg('exclude')."' /></a>&nbsp;\n";
        }
        else {
           print "<img src='fill.gif' width='10' height='10' border='0' align='middle' alt='' />&nbsp;\n";
        }
        print "<a href='update.php?sid=$sid&site_id=$site_id&amp;path=".urlencode($path_name)."&amp;sup=1#$aname2' target='_self'><img src='no.gif' width='10' height='10' border='0' align='middle' alt='".phpdigMsg('delete')."' /></a>&nbsp;\n";
        print "<a href='update.php?sid=$sid&path=".urlencode($path_name)."&amp;site_id=$site_id&amp;exp=1' target='contentset'><img src='yes.gif' width='10' height='10' border='0' align='middle' alt='".phpdigMsg('reindex')."' /></a>&nbsp;\n";
    }
    if ($path_name == "") {
          $path_name_aff = "<i><b style='color:red;'>".phpdigMsg('root')."</b></i>";
    }
    print '<code>'.$path_name_aff."</code>&nbsp;<a href='files.php?sid=$sid&path=".urlencode($path_name)."&amp;site_id=$site_id' target='files' ><img src='details.gif' width='10' height='10' border='0' align='middle' alt='".phpdigMsg('files')."' /></a><br />\n";
}
?>
</p>
