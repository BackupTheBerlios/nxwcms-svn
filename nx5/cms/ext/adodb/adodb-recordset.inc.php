<?php
	...
	class ADORecordSet {
		 ...
		 *
		 */
		function ADORecordSet($queryID) { $this->_queryID = $queryID; }
		...
		*/
		function NextRecordSet() { return false; }
		 ...
		 * @return an array indexed by the rows (0-based) from the recordset
		 */
		function GetRows($nRows = -1) { return $this->GetArray($nRows); }
		...
		*/
		function Free() { return $this->Close(); }

		/**
		* PEAR DB compat, number of rows
		*/
		function NumRows() { return $this->_numOfRows; }

		/**
		* PEAR DB compat, number of cols
		*/
		function NumCols() { return $this->_numOfFields; }
		...
		*/
		 ...
		 */
		function Fields($colname) { return $this->fields[$colname]; }
...
*/
		function MaxRecordCount() { return ($this->_maxRecordCount) ? $this->_maxRecordCount : $this->RecordCount(); }
...
*/
		function FieldTypesArray() {
			...
			for ($i = 0, $max = $this->_numOfFields; $i < $max; $i++)$arr[] = $this->FetchField($i);
...
*/
		function &FetchObj() { return FetchObject(false); }
...
*/
		function &FetchNextObj() { return $this->FetchNextObject(false); }
