  ...
  class TabBar {
  	...
  	function drawTab($position, &$out) {
  	  if ($position == $this->selectedMenu) {
  	    ...
  	    $out.= '<div class="activeTabText" id="'.$this->id.$position.'text">&nbsp;&nbsp;<a href="#" onclick="' . $this->getHref($position) . '">';
  	    ...
  	    $out.= '<div class="inactiveTabText" id="'.$this->id.$position.'text">&nbsp;&nbsp;<a href="#" onclick="' . $this->getHref($position) . '">';
  	    $out.=$this->menucontainer[$position][0];
  	    $out.= '</a>&nbsp;&nbsp;</div>';
  	    $out.= '</td>';  	    
  	  }  	  
